...
- ☐ Create the four accounts (`CHANNEL-PLAN.md` — ~25 minutes, copy-paste)
- ☐ Pin video 01 (The Woman Who Touched His Cloak) on each platform after posting it

## The board — 44 approved videos
...
| 28 | The Hidden Treasure | Matthew 13 | 1:39 | ✅ 2026-08-06 | ☐ | ☐ | ☐ | ☐ |
| 29 | The Pearl of Great Price | Matthew 13 | 1:56 | ✅ 2026-08-06 | ☐ | ☐ | ☐ | ☐ |
| 30 | The Net | Matthew 13 | 2:35 | ✅ 2026-08-06 | ☐ | ☐ | ☐ | ☐ |
...
## Approved before, but the cut changed — NOT postable yet

These were approved once, then rebuilt. The new cut sits on your reviewer waiting
for your yes. The moment you approve one, run `python3 social/refresh-postable.py`
and it joins the board above with captions made for it.

| # | Story | Status |
|---|-------|--------|
| 87 | Boy in the Temple | new cut is on the reviewer waiting for your yes |
| 93 | Barabbas Goes Free | new cut is on the reviewer waiting for your yes |
| 94 | Father Forgive Them | new cut is on the reviewer waiting for your yes |
| 95 | Thief on the Cross | new cut is on the reviewer waiting for your yes |
| 98 | Mary her Name | new cut is on the reviewer waiting for your yes |
| 121 | Salt and Light | new cut is on the reviewer waiting for your yes |
| 151 | If Any of You Lack Wisdom | new cut is on the reviewer waiting for your yes |
| 170 | The Sacrament, Worthily | new cut is on the reviewer waiting for your yes |

## How this board stays honest

- A video appears here ONLY after `refresh-postable.py` byte-verifies it against
  the cut Cameron approved. Files to post always come from `social/exports/`.
- New approvals: rerun the script, add the caption entry in `POST-QUEUE.md`, add
  the row here. Same voice, same laws.
- If a posted video later gets re-cut, the posted copy was approved at post time
  and stays up unless Cameron says otherwise — note it in the row's Story cell.
