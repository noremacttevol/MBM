...
Peter Restored (John 21:1-17). STILLS-ONLY (Law E) + Jesus face-never (#18).
Nano Banana 2, 9:16, x2, 2K download. Hand-painted 2D storybook style (NOT the
stale master-plan photorealistic block). The Lord is shown only from behind,
hand-only, or at a distance — his face turned away, never shown. Passes
`jesus_face_gate.py`.

**CHARACTER LOCKS (keep consistent across all 7 stills):**
- **Peter** — a big, broad-shouldered fisherman, dark hair and dark beard, a
  rough undyed rust-brown tunic. His face IS shown (he is the emotional center).
- **The Lord** — THE JESUS LOOK STANDARD: ONE plain undyed off-white/cream wool
  robe, LONG dark hair past the shoulders, warm Middle-Eastern; shown only from behind,
  back-of-head, or hand-only, his face turned away and never shown. No halo, no glow.
- **The charcoal fire** — the emotional key: the SAME kind of low charcoal fire
  in Shot 1 (the denial) and Shot 4/7 (the shore). Let the fire do the remembering.
...
two hands and passes it around the circle, the first act of his new work. At the
head of the circle, seen only from behind, the risen Lord sits in his cream wool
robe with his back to us and long dark hair, quietly sharing the meal. Nets and a
few silver fish rest on the sand. One single continuous scene painted edge to edge.
