...
Output: genesis-18_abraham-pleads-for-sodom.mp4, 1080x1920 H.264 30fps, <30MB.
"""
import os
import subprocess
import textwrap
...
S1 = "s1-the-three-visitors.jpeg"
S2 = "s2-abrahams-welcome.jpeg"
S3 = "s3-bread-and-rest.jpeg"
S4 = "s4-looking-toward-the-plain.jpeg"
S5 = "s5-abraham-stands-before-the-presence.jpeg"
S6 = "s6-the-bold-question.jpeg"
S7 = "s7-the-bargaining.jpeg"
S8 = "s8-for-ten-i-will-spare.jpeg"
S9 = "s9-abraham-goes-home.jpeg"
S10 = "s10-the-God-who-listens.jpeg"
...
BEATS = [
    ...
    ("n3", S3, "in"),
    ("n4", S4, "in"),
    ("jv26", S5, "in"),         # if I find fifty... I will spare — sacred silence 1
    ("n5", S6, "in"),
    ("n6", S7, "in"),
    ("jv32", S8, "in"),         # I will not destroy it for ten's sake — sacred silence 2
    ("n7", S9, "in"),
    ("n8", S10, "in"),
]
...
def main():
    ...
    print(f"sacred silence 1 (spare for fifty): jv26 at {start_of['jv26']:.1f}s", flush=True)
    print(f"sacred silence 2 (for ten): jv32 at {start_of['jv32']:.1f}s", flush=True)
    ...
    OUT = "genesis-18_abraham-pleads-for-sodom.mp4"
    A_KBPS = 96
    MUX = 20
