#!/usr/bin/env python3
"""Assemble MEMBER Verse Video #181 — When the Morning Stars Sang Together
(Job 38:4-7).
...
CONTENT-CARE: clean — awe and joy at creation, no fear. Jesus does not
appear (Job; God answers from creation). No divine figure — cosmic light only.

ONE SACRED SILENCE: s1 — Job 38:7 (the morning stars sang, the centerpiece),
scripture voice, cream italic. n3 (the stars broke into song) gets the draft's
extended hold. n1 recorded in two halves so the seven beats fill the seven
stills; stills matched to beats semantically.
...
paths in segs/. Output: job-38_morning-stars-sang.mp4,
...
ST4 = "s4-foundations-laid-in-joy.jpeg"
ST5 = "s5-the-sons-of-god-shouted.jpeg"
ST6 = "s6-the-morning-star.jpeg"
ST7 = "s7-pleased-with-what-he-made.jpeg"
...
BEATS = [
    ("n0", ST1, "in"),           # back to the first morning
    ("n1a", ST2, "in"),          # before there were people — the earth forming
    ("n1b", ST4, "in"),          # foundations laid in joy
    ("n2", ST6, "in"),           # something astonishing in the sky — the morning star
    ("s1", ST3, "in"),           # SACRED SILENCE — Job 38:7, the stars sing
    ("n3", ST5, "in"),           # the stars broke into song — the sons of God shouted
    ("n4", ST7, "in"),           # the same God listens today — pleased with what he made
]

LEAD = 0.28
GAP = 0.80
KJV_GAP = 1.70
# Per-beat gap override: n3 = the draft's sacred-silence beat after the verse.
HOLD = {"n3": 1.60}
CARD_HOLD = 6.5
...
def main():
    ...
    print(f"sacred silence: s1 (Job 38:7) at {start_of['s1']:.1f}s", flush=True)
    ...
    OUT = "job-38_morning-stars-sang.mp4"
    A_KBPS = 96
    MUX = 20
