#!/usr/bin/env python3
"""Assemble Story Video #65 — "Help thou mine unbelief" (Mark 9:14-29).
...
Output: mark-9_help-mine-unbelief.mp4, 1080x1920 H.264 30fps, <25MB.
"""
import os
import subprocess
import textwrap
...
S1 = "s1-down-to-the-argument.jpeg"
S2 = "s2-the-father-pleads.jpeg"
S3 = "s3-all-things-possible.jpeg"
S4 = "s4-lord-i-believe.jpeg"
S5 = "s5-i-charge-thee.jpeg"
S6 = "s6-lifted-up.jpeg"
...
def main():
    ...
    OUT = "mark-9_help-mine-unbelief.mp4"
    A_KBPS, MUX = 96, 20
