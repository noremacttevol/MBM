#!/usr/bin/env python3
"""Generate #153's 8 stills via flow_driver.py (Nano Banana 2, 9:16, $0).
No Christ/Jesus figure anywhere (heaven shown only as light), so NO --ref.
...
FILENAMES = [
    "s1-at-the-temple.jpeg", "s2-repent-and-turn.jpeg", "s3-cool-refreshing.jpeg",
    "s4-be-blotted-out.jpeg", "s5-heaven-holds-the-promise.jpeg",
    "s6-the-prophets-foretold.jpeg", "s7-restitution-of-all-things.jpeg",
    "s8-the-restoring-hope.jpeg",
]
...
print("ALL 153 STILLS GENERATED")
