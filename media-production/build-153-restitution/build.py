...
S1 = "s1-at-the-temple.jpeg"
S2 = "s2-repent-and-turn.jpeg"
S3 = "s3-cool-refreshing.jpeg"
S4 = "s4-be-blotted-out.jpeg"
S5 = "s5-heaven-holds-the-promise.jpeg"
S6 = "s6-the-prophets-foretold.jpeg"
S7 = "s7-restitution-of-all-things.jpeg"
S8 = "s8-the-restoring-hope.jpeg"
...
GL_POINTER = "Learn more — Gospel Library: Restoration"

BEATS = [
    ("n1", S1, "in"),
    ("n2", S2, "in"),
    ("n3", S3, "in"),
    ("kv19", S4, "in"),                      # SACRED SILENCE 1 — repent, times of refreshing (Acts 3:19)
    ("n4", S4, "out"),
    ("n5", S5, "in"),
    ("n6", S6, "in"),
    ("kv21", S7, "in"),                      # SACRED SILENCE 2 — restitution of all things (Acts 3:21, named)
    ("n7", S7, "out"),
    ("n8", S8, "in"),
]
...
def main():
    ...
    print(f"sacred silence 1 (repent/refreshing, Acts 3:19): kv19 at {start_of['kv19']:.1f}s",
          flush=True)
    print(f"sacred silence 2 (restitution of all things, Acts 3:21): kv21 at {start_of['kv21']:.1f}s",
          flush=True)
    ...
    p1_end = start_of["kv19"] + spoken["kv19"]
    p2_end = start_of["kv21"] + spoken["kv21"]
    beds = [
        (0.0, start_of["kv19"] - 1.2, "b"),
        (p1_end + 1.0, start_of["kv21"] - 1.0, "a"),
    ...
    OUT = "acts-3_restitution-of-all-things.mp4"
    A_KBPS, MUX = 96, 20
