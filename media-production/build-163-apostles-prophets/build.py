...
S1 = "s1-once-strangers.jpeg"
S2 = "s2-brought-near.jpeg"
S3 = "s3-household-of-god.jpeg"
S4 = "s4-fellowcitizens.jpeg"
S5 = "s5-the-foundation.jpeg"
S6 = "s6-the-cornerstone.jpeg"
S7 = "s7-built-together.jpeg"
S8 = "s8-you-belong.jpeg"
...
GL_POINTER = "Learn more — Gospel Library: Church Organization"

BEATS = [
    ("n1", S1, "in"),
    ("n2", S2, "in"),
    ("n3", S3, "in"),
    ("kv19", S4, "in"),                      # SACRED SILENCE 1 — no more strangers, household of God (Eph 2:19)
    ("n4", S4, "out"),
    ("n5", S5, "in"),
    ("n6", S6, "in"),
    ("kv20", S7, "in"),                      # SACRED SILENCE 2 — built on apostles and prophets (Eph 2:20, named)
    ("n7", S7, "out"),
    ("n8", S8, "in"),
]
...
def main():
    ...
    print(f"sacred silence 1 (household of God, Eph 2:19): kv19 at {start_of['kv19']:.1f}s",
          flush=True)
    print(f"sacred silence 2 (apostles and prophets, Eph 2:20): kv20 at {start_of['kv20']:.1f}s",
          flush=True)
    ...
    p2_end = start_of["kv20"] + spoken["kv20"]
    beds = [
        (0.0, start_of["kv19"] - 1.2, "b"),
        (p1_end + 1.0, start_of["kv20"] - 1.0, "a"),
    ...
    OUT = "ephesians-2_apostles-and-prophets.mp4"
    A_KBPS, MUX = 96, 20
