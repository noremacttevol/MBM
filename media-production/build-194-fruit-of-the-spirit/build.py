#!/usr/bin/env python3
"""Assemble MEMBER Verse Video #194 — The Fruit of the Spirit
(Galatians 5:22-23).
...
CONTENT-CARE: clean. Jesus does not appear (epistle teaching).

ONE SACRED SILENCE: s1 — Gal 5:22-23 (the full fruit list, the centerpiece),
scripture voice, cream italic, on the love still. n1b (peace) gets the
draft's extended hold. n1 recorded in two halves so the fruit stills line
up with what's being named per the CAPTION LAW.
...
paths in segs/. Output: galatians-5_fruit-of-the-spirit.mp4,
...
ST1 = "s1-the-harvest-of-character.jpeg"
ST2 = "s2-love.jpeg"
ST3 = "s3-joy.jpeg"
ST4 = "s4-peace.jpeg"
ST5 = "s5-longsuffering.jpeg"
ST6 = "s6-temperance.jpeg"
ST7 = "s7-let-it-ripen.jpeg"
...
BEATS = [
    ("n0", ST1, "in"),           # the harvest of character
    ("s1", ST2, "in"),           # SACRED SILENCE — Gal 5:22-23, the full list (love)
    ("n1a", ST3, "in"),          # first love, then joy
    ("n1b", ST4, "in"),          # then peace — extended quiet hold
    ("n2", ST5, "in"),           # longsuffering, gentleness, goodness, faith
    ("n3", ST6, "in"),           # meekness, temperance
    ("n4", ST7, "in"),           # no law forbids — let it ripen
]

LEAD = 0.28
GAP = 0.65
KJV_GAP = 1.60
# Per-beat gap overrides: n1b = the draft's sacred-silence beat (peace);
# n4 = a longer breath before the card.
HOLD = {"n1b": 1.60, "n4": 1.90}
CARD_HOLD = 5.0
...
def main():
    ...
    print(f"sacred silence: s1 (Gal 5:22-23) at {start_of['s1']:.1f}s", flush=True)
    ...
    OUT = "galatians-5_fruit-of-the-spirit.mp4"
    A_KBPS = 96
    MUX = 20
