...
SEGMENTS = [
    ...
    ("n2c", NARRATOR, "He wanted to keep the moment. Build something, stay a while. Mark adds, kindly, that Peter did not know what to say, because they were so afraid."),
