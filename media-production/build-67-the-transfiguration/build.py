#!/usr/bin/env python3
"""Assemble Story Video #67 — The Transfiguration (Mark 9 / Matt 17 / Luke 9).
...
FACE-SHOWN Jesus (master-locked). Narrator en-US-AndrewNeural; Peter's line
(j1) and the Father's voice (j2, "This is my beloved Son: hear him") are both
carried by the SCRIPTURE voice (en-US-ChristopherNeural, build-169 precedent —
the Father is NEVER a separate voice and NEVER depicted; s7 is light/cloud
only). The transfiguration glory-light on Jesus (s2) is scriptural, not a
banned halo. cream-italic KJV, sacred holds. CONTENT-CARE: awe, no gore.

Warm mountain frames: caption box black@0.60 (brightest-frame, #40).

Output: mark-9_the-transfiguration.mp4, 1080x1920 H.264 30fps, <25MB.
"""
import os
import subprocess
import textwrap
...
S1 = "s1-up-the-mountain.jpeg"
S2 = "s2-transfigured.jpeg"
S3 = "s3-moses-and-elijah.jpeg"
S4 = "s4-the-disciples-fall-back.jpeg"
S5 = "s5-peter-speaks.jpeg"
S6 = "s6-the-bright-cloud.jpeg"
S7 = "s7-this-is-my-beloved-son.jpeg"
...
CARD_TEXT = ("For one moment they saw who he really is — and heaven said, "
             "hear him. That invitation still stands.")
_OLD_CARD = ("He left a simple meal to remember him by. Come to his table — "
             "he is still the host.")

BEATS = [
    ("n0", S1, "in"),      # up a high mountain (up the mountain)
    ("n1", S2, "in"),      # he changed, shining white (transfigured)
    ("n2a", S3, "in"),     # Moses and Elijah appeared (moses and elijah)
    ("n2b", S4, "in"),     # Peter overwhelmed (the disciples fall back)
    ("j1", S5, "in"),      # Peter: Master, it is good... three tabernacles (peter speaks)
    ("n3", S6, "in"),      # a bright cloud, and a voice (the bright cloud)
    ("j2", S7, "in"),      # the Father: This is my beloved Son: hear him (beloved son)
    ("n4", S8, "out"),     # it was over, Jesus alone, do not be afraid (jesus only)
]
...
def main():
    ...
    OUT = "mark-9_the-transfiguration.mp4"
    A_KBPS, MUX = 96, 20
