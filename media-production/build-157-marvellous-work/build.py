...
S1 = "s1-isaiah-prophesies.jpeg"
S2 = "s2-the-sealed-book.jpeg"
S3 = "s3-the-learned-cannot.jpeg"
S4 = "s4-the-unlearned.jpeg"
S5 = "s5-hearts-far-off.jpeg"
S6 = "s6-wisdom-runs-dry.jpeg"
S7 = "s7-a-marvellous-work.jpeg"
S8 = "s8-the-wonder-received.jpeg"
...
BEATS = [
    ...
    ("n2", S2, "in"),
    ("n3", S3, "in"),
    ("kv11", S4, "in"),                      # SACRED SILENCE 1 — the sealed book (Isa 29:11)
    ("n4", S4, "out"),
    ("n5", S5, "in"),
    ("n6", S6, "in"),
    ("kv14", S7, "in"),                      # SACRED SILENCE 2 — a marvellous work and a wonder (Isa 29:14, named)
    ("n7", S7, "out"),
    ("n8", S8, "in"),
]
...
def main():
    ...
    print(f"sacred silence 1 (the sealed book, Isa 29:11): kv11 at {start_of['kv11']:.1f}s",
          flush=True)
    print(f"sacred silence 2 (a marvellous work, Isa 29:14): kv14 at {start_of['kv14']:.1f}s",
          flush=True)
    ...
    p2_end = start_of["kv14"] + spoken["kv14"]
    beds = [
        (0.0, start_of["kv11"] - 1.2, "b"),
        (p1_end + 1.0, start_of["kv14"] - 1.0, "a"),
