...
SEGMENTS = [
    ...
    ("n2", NARRATOR, 'So he used it. He pulled in all the air his body would hold and shouted: Catch that title. The crowd called him Jesus of Nazareth — the man from up north. Son of David was something else entirely: it was the name reserved for the promised King, the Messiah. Everyone with working eyes saw a traveling teacher. The blind man was the one who saw who was actually walking past.'),
