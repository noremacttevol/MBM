...
BEATS = [
    ("n0", [(S1, "in")], None),
    ("n1", [(S2, "in")], None),
    ("n2", [(S3, "in"), (S4, "in"), (S5, "in")], 1.5),  # pouring hush ([SILENCE])
    ("n3", [(S6, "in")], None),
    ("n4", [(S7, "in")], None),
    ("n5", [(S3, "out")], None),
    ("j1", [(S7, "out")], None),   # to Simon — sacred pause after
    ("j2", [(S8, "in")], None),    # "Thy sins are forgiven." [SILENCE]
    ("n6", [(S1, "out")], None),
    ("j3", [(S8, "out")], 0.4),    # flows into the silent hush
    ("HUSH", [(S9, "in")], 1.6),   # the empty jar, the open door — breath, no words
]
