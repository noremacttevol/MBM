...
SEGMENTS = [
    ...
    ("n3", NARRATOR, "Here are my brothers. He wasn't pushing his family away. He was opening the circle — telling a room full of nobodies they could belong to him like blood."),
