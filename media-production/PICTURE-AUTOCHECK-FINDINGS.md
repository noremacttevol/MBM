...
| build-53-peters-mother-in-law | 53 | All 6 disciple shots (s1,s2,s4,s6,s7,s8) repainted with the locked cast — John fixed to the clean-shaven youth, Peter to dark-curled blue-grey. Ready for #4. ✅ |
