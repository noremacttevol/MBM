...
against the intended script. Any segment whose transcription drifts is flagged
BEFORE assembly. Run after every make_narration.py run and fix flagged segments.
"""
import re
import sys
...
EQUIV = {
    ...
    "hideth": "hideth", "buyeth": "buyeth", "goeth": "goeth", "hath": "hath",
    "unto": "unto", "thereof": "thereof",
