#!/usr/bin/env python3
"""Assemble Story Video #28 — Hidden Treasure (Matthew 13:44).
...
SEGMENTS = [
    ("s1a","still","s1.jpeg",6.908,"in",
     "Jesus told a short story\nabout a man and a field.","n"),
    ("s1b","still","s1.jpeg",5.688,"out",
     "He was a hired man, digging\nin a field that wasn't his own.","n"),
    ("s2","still","s2.jpeg",6.672,"in",
     "One day his spade struck\nsomething buried in the ground.","n"),
    ("s3","still","s3.jpeg",10.200,"in",
     "He brushed off the dirt —\nand found a hidden treasure,\nworth more than he'd ever seen.","n"),
    ("s4a","still","s4.jpeg",7.332,"out",
     "His heart raced. He covered it\nback over and told no one.","n"),
    ("s4b","still","s4.jpeg",8.000,"in",
     "“Again, the kingdom of heaven is\nlike unto treasure hid in a field;\nthe which when a man hath found,\nhe hideth,","kjv"),
    ("s5a","still","s5.jpeg",8.348,"in",
     "and for joy thereof goeth and\nselleth all that he hath,\nand buyeth that field.”","kjv"),
    ("s5b","still","s5.jpeg",5.496,"out",
     "He went and sold\neverything he owned.","n"),
    ("s5c","still","s5.jpeg",6.864,"in",
     "His house, his tools —\nall of it, gladly.","n"),
    ("s6a","still","s6.jpeg",5.712,"in",
     "With every coin he had,\nhe bought that field.","n"),
    ("s6b","still","s6.jpeg",8.688,"out",
     "He knew what lay beneath it —\nworth more than all he owned.","n"),
    ("s7a","still","s7.jpeg",4.824,"in",
     "That, Jesus said, is what\nGod's kingdom is like.","n"),
    ("s7b","still","s7.jpeg",12.072,"out",
     "It can look like an ordinary field.\nBut once you see the treasure —\nonce you see who Jesus is —\nnothing else compares.","n"),
    ("s7c","still","s7.jpeg",9.512,"in",
     "You don't give it up sadly.\nYou give it for joy — you've found\nthe one thing worth everything.","n"),
    ("card","card",None,10.200,None,
     "The man sold all he had —\nand called it the best trade\nof his life.\n\n"
     "If you have found the treasure,\nwhat is he worth to you?","close"),
]
...
AUDIO = [
    ...
    ("audio/n8.mp3",  71.220),
    ("audio/n9.mp3",  79.908),
    ("audio/n10.mp3", 84.732),
    ("audio/n11.mp3", 96.804),
    ("audio/card.mp3",106.316),
]
...
def main():
    ...
    OUT="matthew-13_hidden-treasure.mp4"
