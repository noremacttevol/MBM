...
Output: genesis-22_the-ram-in-the-thicket.mp4, 1080x1920 H.264 30fps, <30MB.
"""
import os
import subprocess
import textwrap
...
S1 = "s1-they-set-out.jpeg"
S2 = "s2-the-long-walk.jpeg"
S3 = "s3-up-the-mountain-together.jpeg"
S4 = "s4-the-boys-question.jpeg"
S5 = "s5-building-the-altar.jpeg"
S6 = "s6-the-voice-from-heaven.jpeg"
S7 = "s7-the-ram-in-the-thicket.jpeg"
S8 = "s8-the-embrace.jpeg"
S9 = "s9-god-provided.jpeg"
S10 = "s10-the-lord-will-provide.jpeg"
...
BEATS = [
    ...
    ("n4", S4, "in"),
    ("n5", S5, "in"),
    ("jv12", S6, "in"),         # Lay not thine hand upon the lad — sacred silence 1
    ("n6", S7, "in"),           # God never wanted the child; the ram provided
    ("n7", S8, "in"),           # the embrace
    ("jv17", S9, "in"),         # in blessing I will bless thee — sacred silence 2
    ("n8", S10, "in"),          # the Lord will provide; the true Lamb foreshadowed
]
...
def build_still(seg_id, src, dur, zdir, spoken_end, cap_text, kjv, first):
    ...
    # #115 stills carry a painted storybook border; crop the outer ~6% to remove it.
...
def main():
    ...
    print(f"sacred silence 1 (lay not thine hand): jv12 at {start_of['jv12']:.1f}s", flush=True)
    print(f"sacred silence 2 (I will bless thee): jv17 at {start_of['jv17']:.1f}s", flush=True)
    ...
    p1_end = start_of["jv12"] + spoken["jv12"]
    p2_end = start_of["jv17"] + spoken["jv17"]
    beds = [
        (0.0, start_of["jv12"] - 1.2, "b"),
        (p1_end + 1.0, start_of["jv17"] - 1.0, "a"),
        (p2_end + 1.0, card_start - 0.8, "a"),
    ]
    print(f"music: bed out at {start_of['jv12'] - 1.2:.1f}s, silent through jv12 "
          f"(ends {p1_end:.1f}s); returns; silent again through jv17 "
    ...
    OUT = "genesis-22_the-ram-in-the-thicket.mp4"
    A_KBPS = 96
    MUX = 20
