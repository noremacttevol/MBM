...
Output: hebrews-1_god-spake-by-prophets.mp4, 1080x1920 H.264 30fps, <30MB.
"""
import os
import subprocess
import textwrap
...
S1 = "s1-a-voice-to-the-ancients.jpeg"
S2 = "s2-the-burning-bush.jpeg"
S3 = "s3-the-prophet-of-fire.jpeg"
S4 = "s4-the-scroll-by-lamplight.jpeg"
S5 = "s5-the-word-in-the-square.jpeg"
S6 = "s6-many-voices-many-ways.jpeg"
S7 = "s7-in-these-last-days-the-son.jpeg"
S8 = "s8-the-express-image.jpeg"
S9 = "s9-upholding-all-things.jpeg"
S10 = "s10-gods-final-word.jpeg"
...
BEATS = [
    ("n1", S1, "in"),
    ("jv1", S2, "in"),          # sundry times, divers manners — sacred silence 1
    ("n2", S3, "in"),
    ("n3", S4, "in"),
    ("n4", S5, "in"),
    ("n5", S6, "in"),
    ("jv2", S7, "in"),          # spoken unto us by his Son — sacred silence 2
    ("n6", S8, "in"),
    ("jv3", S9, "in"),          # express image / upholding all things
    ("n7", S10, "in"),
]
...
def main():
    ...
    print(f"sacred silence 1 (divers manners): jv1 at {start_of['jv1']:.1f}s", flush=True)
    print(f"sacred silence 2 (by his Son): jv2 at {start_of['jv2']:.1f}s", flush=True)
    ...
    p1_end = start_of["jv1"] + spoken["jv1"]
    p2_end = start_of["jv2"] + spoken["jv2"]
    beds = [
        (0.0, start_of["jv1"] - 1.2, "b"),
        (p1_end + 1.0, start_of["jv2"] - 1.0, "a"),
        (p2_end + 1.0, card_start - 0.8, "a"),
    ]
    print(f"music: bed out at {start_of['jv1'] - 1.2:.1f}s, silent through jv1 "
          f"(ends {p1_end:.1f}s); returns; silent again through jv2 "
    ...
    OUT = "hebrews-1_god-spake-by-prophets.mp4"
    A_KBPS = 96
    MUX = 20
