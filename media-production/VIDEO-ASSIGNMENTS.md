...
| 09 | Rich Young Ruler | mark-10_rich-ruler | CLAIMED — 2026-07-11 — Elli's Windows laptop (Cameron directly reassigned 9+10 to this box, overriding Machine C's #6–#10 claim). Machine C's redo was audit-only/incomplete. Reworking: 1 Jesus still (s7 walk-away) regenerated fully-behind (old s7 leaked a profile cheek/eye); 2 clips (s1-run, s6-walk) → stills; stills-only #18 rebuild on Windows. |
| 10 | Woman at the Well | john-4_well | CLAIMED — 2026-07-11 — Elli's Windows laptop (Cameron directly reassigned 9+10). Was DONE-approved V3 but built with 2 Veo clips → Law E rework: strip clips, rebuild stills-only from existing anchor stills. #18 re-audit PASS — all 4 Jesus beats (s2/s5/s6) already show him only from behind / over-the-shoulder, no face/glow. No new pictures needed. |
