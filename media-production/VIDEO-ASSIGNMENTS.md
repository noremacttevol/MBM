...
| 8 | 44 | The Two Debtors | luke-7_two-debtors | **CLAIMED — 2026-07-14 — Computer B (Elli's Windows laptop, operator Leighton)** — Cameron's batch order (B=44). Building stills-only via Chrome+Google Flow (old faithful path). |
