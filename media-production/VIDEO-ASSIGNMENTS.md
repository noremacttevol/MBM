...
| 4 | 24 | The Sower | matthew-13_sower | **CLAIMED — 2026-07-12 — Machine C (Cameron Lovett MS)** — building fresh, STILLS-ONLY (Law E). Parable Jesus tells from the boat; Jesus only the bookend storyteller from behind, the sower + soils shown. Hand-painted 2D storybook. |
