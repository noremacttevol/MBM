...
| 20 | Good Samaritan | luke-10_samaritan | **CLAIMED — 2026-07-12 — Machine C (Cameron Lovett MS)** — reassigned here by Cameron (the other machine was moved to #21). Building fresh, STILLS-ONLY (Law E) + Jesus face-never (#18 / face-gate PASS), hand-painted 2D storybook style. Parable: all characters shown fully; Jesus is the narrating voice only, no Jesus figure on screen. From production pack `20-samaritan-production-pack.md`. |
