...
| 08 | Lost Coin | luke-15_lost-coin | CLAIMED — 2026-07-11 — Elli's Windows laptop. Finishing the stills-only redo: generating the 4 missing stills (count, lamp, sweep, found — parable, no Jesus figure, face gate trivial), fixing narrator voice off the banned Multilingual model, then Windows stills-only build + verbatim captions. |
