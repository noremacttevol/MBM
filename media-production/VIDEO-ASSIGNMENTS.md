...
| 07 | Peter walks on water | matthew-14_peter-water | REWORK BUILT — 2026-07-11 — Elli's Windows laptop — awaiting Cameron's verdict. Cameron's 3 picture fixes done & verified in the cut: (1) s5 walk (v5) — Peter from BEHIND going toward a distant Jesus (face not shown, Lord too far to show a face); (2) new s7-sink-alone still for the sinking beat so the hand-grab (s7-sink-v5) lands only at "And Jesus caught him," not during the sinking; (3) s9 walk-back (v3) — disciples now in the boat. Windows stills-only rebuild. matthew-14_peter-walks-on-water.mp4 (20.0MB, 4:16). build_win.py. **FIX 2026-07-13 (Machine A): s3-figure-on-water regenerated — the distant figure had been a solid BLACK silhouette/void that read as ominous/wrong (Cameron: "looks like we are worshiping satan"). Now a real tan Middle-Eastern man in a cream robe, softly moonlit and readable as a person, face just soft with distance (matches s5). Rebuilt on Linux via build_linux.py (made ffmpeg path portable). New file 19.1MB, 4:16.** |
...
| 11 | Calming the Storm | mark-4_calming-the-storm | **BUILT — awaiting Cameron — 2026-07-13 — Machine A (Dev)** (the REDO QUEUE below was never done until now). FULL REDO, now STILLS-ONLY (Law E — both Veo motion clips dropped, incl. the hooded-Jesus calm clip). All five Jesus shots (s4 asleep, s5 waking, s6 rebuke, s7 great-calm, s8 turned-to-them) regenerated to ONE locked look — tan man, LONG dark wavy shoulder-length hair, ONE cream wool robe — staged from behind/side (no hood, no void, no glow) with the disciples carrying the frames. Fixes all four rejects: (1) hair now consistent LONG; (2) one cream robe; (3) all from behind, no face portrait; (4) s7 now clearly IN the boat among the disciples (was on the water outside it). Wrote a proper PROMPTS.md (face-gate PASS) + a clean stills-only build.py; old Windows build kept as build_win.py.bak. KJV j0/j1/j2 cream-italic, "Peace, be still" in true silence. Ear-check 14/14; only silences >2.5s are the j1 hush + card tail. mark-4_calming-the-storm.mp4 (19.0MB, 4:30). |
...
| 16 | Mary and Martha | luke-10_mary-martha | **BUILT — awaiting Cameron — 2026-07-12 — Machine A (Dev)** (Cameron's order "do 16 and 36"). STILLS-ONLY (Law E), face-never (Law B): Jesus shown ONLY from behind (s1 door, s3/s4 head-of-room, s6 back-to-camera in foreground) — face never in frame, verified on the render. 6 painted stills (arrival → Martha serving → Mary at his feet → worn thin → her name said gently (tight on Martha, no Jesus) → two sisters listening). Verbatim captions; KJV j1 (10:41-42 "Martha, Martha… one thing is needful… Mary hath chosen that good part") cream-italic; music silent on "Martha, Martha." Ear-check 14/14; only silences >2.5s are the peak hush + card tail. luke-10_mary-and-martha.mp4 (20.0MB, 3:06). build.py. |
...
| 20 | Good Samaritan | luke-10_samaritan | **APPROVED by Cameron 2026-07-12** ✅ ("beautiful i approve") — Machine C (Cameron Lovett MS). Fresh stills-only build. 8 hand-painted 2K stills, verbatim captions (#15 pattern), Jesus KJV j1 (Luke 10:36 "which of these three was neighbour") + j2 (10:37 "Go, and do thou likewise") explained plainly, music silent on the "moved with compassion" peak. Parable: the Samaritan/priest/Levite/traveler/innkeeper all shown; Jesus only the bookend storyteller (s1, s7, s8) from behind — all three verified face-safe on the 2K (s8 needed one Flow in-place edit to turn a leaked three-quarter head fully to the back). luke-10_samaritan.mp4 (21.5MB, 3:22). build.py (Linux, bin/ffmpeg). |
...
| 5 | 28 | Hidden Treasure | matthew-13_hidden-treasure | **BUILT — awaiting Cameron — 2026-07-12 — Elli's Windows laptop** (Cameron's direct order "start #28"). STILLS-ONLY (Law E) + face-gate PASS (#18 — parable, NO Jesus figure at all). 7 painted stills (laborer finds buried treasure → hides it → sells all → buys the field → joy), verbatim captions, KJV j1 (13:44) italic-cream split over two beats; bed silent under j1. Ear-check all-pass. Laborer (dusty-tan tunic) + landowner (ochre robe) wardrobe locked. matthew-13_hidden-treasure.mp4 (20.9MB, 1:57). build.py. |
| 6 | 34 | The Rich Fool | luke-12_rich-fool | UNCLAIMED |
| 7 | 38 | The Persistent Widow | luke-18_persistent-widow | **CLAIMED — 2026-07-12 — Machine C (Cameron's direct order 'do 38'; off-list)** — building (stills-only, face-gate PASS) |
...
| 4 | 23 | Workers in the Vineyard | matthew-20_vineyard-workers | **BUILT — awaiting Cameron — 2026-07-12 — Machine A (Dev)** (Cameron's direct order "go on to 23"; overrides the Machine B list claim, same pattern as #21/#22). STILLS-ONLY (Law E), parable with NO Jesus figure on screen (his narrating voice + KJV only — face-gate PASS). 8 fresh painted stills (s1-dawn-hire … s8-vineyard-dusk), verbatim captions, KJV j1 (Matt 20:13-15, incl. "Is thine eye evil, because I am good?") + j2 (20:16). Ear-check 17/17; the money question hushes to reverent quiet, no other dead air. matthew-20_vineyard-workers.mp4 (21.1MB, 3:23). |
| 5 | 32 | The Talents | matthew-25_talents | **BUILT — awaiting Cameron — 2026-07-12 — Machine C (Cameron Lovett MS)** (Cameron's direct order "do 32"; off-list). STILLS-ONLY (Law E). Parable (Matt 25:14-30) — NO Jesus figure (the master is a parable nobleman shown fully; Jesus is the narrating voice + KJV only, face-gate PASS). 7 painted stills (entrusting → 5-bag trades → 2-bag works → 1-bag buries at night → return/reckoning → "well done" embrace → buried bag returned in sorrow), verbatim captions, KJV j1 (25:21) + j2 (25:24-25) cream-italic, silence on the "well done" peak. Milk framing: the third servant buried the gift because he believed a LIE about the master's heart; God is not that hard man. matthew-25_talents.mp4 (20.9MB, 2:45). build.py. |
| 6 | 35 | The Great Banquet | luke-14_great-banquet | **BUILT — awaiting Cameron — 2026-07-12 — Machine C (Cameron Lovett MS)** (Cameron's direct order "35 is next"; off-list). STILLS-ONLY (Law E). Parable (Luke 14:15-24) — NO Jesus figure (the host is a parable nobleman shown fully; Jesus is the narrating voice + KJV only, face-gate PASS). 7 painted stills (feast ready → servant sent → the excuses → servant returns → sent to the streets → welcoming the poor → the table full & host with arms wide), verbatim captions, KJV j1 (14:21) + j2 (14:23) cream-italic, silence on the "house filled" peak. Milk framing: when the invited make excuses, the host opens the doors WIDER to the poor/maimed/blind — God's answer to rejection is MORE invitation, and there is still room for you. luke-14_great-banquet.mp4 (20.9MB, 2:35). build.py. |
| 7 | 39 | The Pharisee and the Publican | luke-18_pharisee-and-publican | UNCLAIMED |
| 8 | 44 | The Two Debtors | luke-7_two-debtors | **BUILT — awaiting Cameron — 2026-07-14 — Computer B (Elli's Windows laptop, operator Leighton).** Old-faithful path: all 8 stills generated in Google Flow (Nano Banana 2, 9:16), downloaded at 2K, $0. STILLS-ONLY (Law E) + face-gate PASS — Jesus is at the table but staged ONLY from behind / over-shoulder (s1,s3,s4,s7) / distant (s8), face never shown (verified on the render); the parable (s5,s6 creditor + two debtors) has NO Jesus figure. 8 painted stills, verbatim captions, 5 KJV lines cream-italic, two sacred silences (Luke 7:42 "he frankly forgave them both" verdict; 7:47 "for she loved much" payoff). No-dead-air 1.88s worst. Milk: forgiven much → loves much. luke-7_two-debtors.mp4 (20.1MB, 4:18). build.py. |
...
| 3 | 21 | The Lost Sheep | luke-15_lost-sheep | **BUILT — awaiting Cameron — 2026-07-12 — Machine A (Dev).** STILLS-ONLY (Law E), hand-painted 2D storybook. Jesus kept FULLY OFF-SCREEN (his narrating voice + KJV only — face-gate PASS, trivial). 7 stills (s1-gathering … s7-rejoicing — Machine C art generated on the shared prep; the two chats both landed on #21, Cameron split it: Machine C pushed the finished art + moved to #20, Machine A owns/finished #21). Verbatim captions; KJV j1–j4 (Luke 15:4/5/6/7) cream-italic. **Cameron fix 2026-07-12:** narrator reworded so it clearly says "ninety-nine" (was muddying "…nine and…" into "90 and 9"); Jesus keeps EXACT KJV "the ninety and nine" (Two-Voice Law). Rebuilt reproducibly from build.py: ear-check 15/15, silence clean (only the finding-pause + card tail). luke-15_lost-sheep.mp4 (20.2MB, 2:47). Folder reconciled (orphan 9-still draft removed). |
| 4 | 24 | The Sower | matthew-13_sower | **BUILT — awaiting Cameron — 2026-07-12 — Machine C (Cameron Lovett MS).** STILLS-ONLY (Law E). Parable from the boat: sower + 4 soils shown; Jesus only bookend storyteller (s1, s7) from behind — both verified face-safe on the 2K (each needed one Flow in-place head-turn edit after the upscale leaked a cheek/beard three-quarter). 7 stills, verbatim captions, KJV Matt 13:3/13:9/13:23 explained plainly, silence on the good-ground peak. matthew-13_sower.mp4 (21.3MB, 2:56). |
| — | 27 | The Leaven | matthew-13_leaven | **BUILT — awaiting Cameron — 2026-07-12 — Machine C (Cameron Lovett MS)** (Cameron's direct order "go to 27"; off-list). STILLS-ONLY (Law E). One-verse parable (Matt 13:33) — NO Jesus figure at all (his narrating voice + KJV only, face-gate PASS trivial). 7 painted stills (woman takes leaven → three measures of meal → hides it in / kneads → covered & waiting at dusk → risen dough → baked loaves → bread carried to a table of many), verbatim captions, KJV j1 (13:33) cream-italic, music silent on the risen-dough peak. Milk framing: God works quietly, hidden, from the inside, until the whole is changed. matthew-13_leaven.mp4 (20.5MB, 2:05). build.py. |
| — | 29 | The Pearl of Great Price | matthew-13_pearl-of-great-price | **BUILT — awaiting Cameron — 2026-07-12 — Machine A (Dev)** (Cameron's direct order "go to 29"; off-list). STILLS-ONLY (Law E), NO Jesus figure on screen (voice + KJV only — face-gate PASS). 6 fresh painted stills (s1-merchant … s6-pearl-radiant). Verbatim captions; KJV j1 (13:45) + j2 (13:46) cream-italic. Closing "Jesus is good" turn: to him YOU are the pearl he sold all to buy. Ear-check 13/13; hush after j2, no other dead air. **FIX 2026-07-13 (Machine A): s2-searching regenerated — merchant's left hand was missing; both hands now shown, rebuilt.** matthew-13_pearl-of-great-price.mp4 (20.0MB, 2:32). |
| — | 30 | The Net (Dragnet) | matthew-13_the-net | **BUILT — awaiting Cameron — 2026-07-12 — Machine A (Dev)** (Cameron's direct order "now do 30"; off-list). STILLS-ONLY (Law E), NO Jesus figure on screen (voice + KJV only — face-gate PASS). 6 fresh painted stills (s1-cast … s6-shore-close). Verbatim captions; KJV j1 (13:47-48) + j2 (13:49) cream-italic. Milk framing: the net gathers "of every kind" (grace cast wide, comes first); the sorting is God's alone at the end, not ours (furnace kept off-screen); closes on grace ("cast for you"). Ear-check 14/14; hush after j2, no other dead air. matthew-13_the-net.mp4 (20.6MB, 3:02). |
| — | 25 | Wheat and Tares | matthew-13_wheat-and-tares | **BUILT — awaiting Cameron — 2026-07-12 — Machine A (Dev)** (Cameron's direct order "go to 25"; off-list, same pattern as #21/#23). STILLS-ONLY (Law E), NO Jesus figure on screen (his narrating voice + KJV only — face-gate PASS). 8 fresh painted stills (s1-sowing … s8-shine). Verbatim captions; KJV j1 (13:29-30 "Let both grow together until the harvest") + j2 (13:43 "the righteous shine forth as the sun") cream-italic. Milk framing (patience is mercy; furnace kept gentle). Ear-check 17/17; hush on the heart line, no other dead air. matthew-13_wheat-and-tares.mp4 (20.7MB, 3:16). |
| 5 | 33 | The Sheep and the Goats | matthew-25_sheep-and-goats | **BUILT — awaiting Cameron — 2026-07-12 — Machine A (Dev)** (Cameron's direct order "33 is next"). STILLS-ONLY (Law E), the King (Jesus / Son of man) kept FULLY OFF-SCREEN (voice + KJV only — face-gate PASS); shepherd (from behind) + the acts of mercy shown. 7 fresh painted 2K stills (s1-separate … s7-hands-close). NOTE: s6 first rendered a kneeling helper that read too much like a Christ-figure, so it was regenerated as an ordinary woman in a headscarf — no ambiguity with the off-screen King. Verbatim captions; KJV j1 (25:34-36) + j2 (25:40 "ye have done it unto me") cream-italic; hush on j2. Milk framing: he hides in the needy; simple kindness to the least IS kindness to him; the punishment side kept gentle. Ear-check 12/12; only silences >2.5s are the j2 hush + card tail. matthew-25_sheep-and-goats.mp4 (19.9MB, 3:02). build.py. |
| — | 36 | The Shrewd Steward | luke-16_shrewd-steward | **BUILT — awaiting Cameron — 2026-07-12 — Machine A (Dev)** (Cameron's direct order "do 16 and 36"; off-list, built alongside #16). STILLS-ONLY (Law E), NO Lord figure on screen (his narrating voice + KJV only — face-gate PASS). Parable (Luke 16:1-13): the rich owner, the steward, and the debtors shown fully. 8 painted 2K stills (s1-accused → s2-worried → s3-called-in → s4-oil-bill → s5-wheat-bill → s6-commended → s7-welcomed → s8-two-masters). Verbatim captions; KJV j1 (16:8 "the lord commended… wiser than the children of light") + j2 (16:9 "Make to yourselves friends of the mammon of unrighteousness… everlasting habitations") cream-italic, full-silence hush on j2. Milk framing: he praises the steward's URGENCY, not his cheating — be that urgent about eternal things; "ye cannot serve God and mammon" is rescue, not a rule; he is not after your money, he is after you. Ear-check 13/13; only silences >2.5s are the j2 hush + card tail. luke-16_shrewd-steward.mp4 (20.1MB, 3:10). build.py. |
