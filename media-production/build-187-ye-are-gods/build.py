#!/usr/bin/env python3
"""Assemble MEMBER Verse Video #187 — "Ye Are Gods; Children of the Most
High" (Psalm 82:6 / John 10:34).
...
CONTENT-CARE: confrontation without violence, accusers composed. FACE LAW
v3: Jesus face-shown, master-locked; only he wears cream.

ONE SACRED SILENCE: j1 — Psalm 82:6, the verse Jesus stands on in John
10:34, Jesus voice, cream italic, on the glowing-psalm still. n2 (their
silence) gets the draft's extended hold. n3 is recorded in two halves
(n3a/n3b) landing on s5 steady-truth and s7 the-court-at-peace (the open
scripture = "their own book"); s6 crowd-parts is a transition beat with no
narration line and is left unused rather than creating dead air.
...
paths in segs/. Output: john-10_ye-are-gods.mp4,
...
ST1 = "s1-circled.jpeg"
ST2 = "s2-reaching-for-their-book.jpeg"
ST3 = "s3-the-psalm-itself.jpeg"
ST4 = "s4-no-answer.jpeg"
ST5 = "s5-steady-truth.jpeg"
ST7 = "s7-the-court-at-peace.jpeg"

TEXT = {s[0]: s[4] for s in make_narration.SEGMENTS}
KJV = {"j1"}

# MEMBER shelf: one-line Gospel Library pointer under the closing invitation.
GL_POINTER = "Learn more — Gospel Library: Divine Potential"

BEATS = [
    ("n0", ST1, "in"),           # the leaders circle him
    ("n1", ST2, "in"),           # he reaches for their own book
    ("j1", ST3, "in"),           # SACRED SILENCE — Ps 82:6, the psalm itself
    ("n2", ST4, "in"),           # no answer — extended quiet hold
    ("n3a", ST5, "in"),          # steady truth
    ("n3b", ST7, "in"),          # their own book — the court at peace
]

LEAD = 0.28
# GAP widened from 0.65 for this short script (6 beats): breathing room keeps
# the runtime over the 60s floor without any gap breaking the 2.5s dead-air law.
GAP = 1.00
KJV_GAP = 1.60
# Per-beat gap overrides: n2 = the draft's sacred-silence beat (their
...
def main():
    ...
    print(f"sacred silence: j1 (Ps 82:6) at {start_of['j1']:.1f}s", flush=True)
