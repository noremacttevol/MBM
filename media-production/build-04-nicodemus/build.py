...
to the master ref, continuity locks on Nicodemus + the night chamber. Caption-v2 (wide
bottom, chunked). Two-voice: narrator en-US-AndrewNeural, KJV en-US-ChristopherNeural.
KJV lines (j1 John 3:3, j2 John 3:8, j3 John 3:16-17) render cream-italic; the music dies
to true silence around j3 (For God so loved the world). Closing card is an invitation.

Output: john-3_nicodemus.mp4, 1080x1920 H.264 30fps, <25MB.
"""
import os
import subprocess
import textwrap
...
S1 = "s1-chamber.jpeg"
S2 = "s2-night-street.jpeg"
S3 = "s3-threshold.jpeg"
S4 = "s4-born-again.jpeg"
S5 = "s5-womb-question.jpeg"
S6 = "s6-wind.jpeg"
S7 = "s7-face.jpeg"
S8 = "s8-for-god-so-loved.jpeg"
...
PEAK = "j3"   # "For God so loved the world" — sacred silence
CARD_TEXT = ("He never shamed the fear, or the night. Whatever draws you "
             "toward him — you can bring it in the dark. The courage grows "
             "on its own.")
