#!/usr/bin/env python3
"""Assemble Video #55 — The Withered Hand (Mark 3:1-6).
...
generation). He appears in s1-s7 and s9; s8 (the leaders gone out to plot) has no divine
figure. Captions are VERBATIM spoken text from make_narration.SEGMENTS; his two KJV lines
(jv4 the question, jv5 the healing word) render in cream italic and are the two sacred
silences.

CARE FLAGS: ARC. The plot to destroy him (s8) is shown only as men conspiring — no
violence. Jesus's anger/grief (s5) is righteous and controlled. The withered hand is shown
gently, never gruesome. Hope-beat is the restored hand (s7).
...
Output: mark-3_withered-hand.mp4 (SCRIPTURE-NAME LAW), 1080x1920 H.264 30fps, <30MB.
"""
import os
import shutil
import subprocess
...
S1 = "s1-the-withered-hand.jpeg"
S2 = "s2-they-watched-him.jpeg"
S3 = "s3-stand-forth.jpeg"
S4 = "s4-is-it-lawful.jpeg"
S5 = "s5-hardness-of-heart.jpeg"
S6 = "s6-stretch-forth-thine-hand.jpeg"
S7 = "s7-restored-whole.jpeg"
S8 = "s8-they-plotted.jpeg"
S9 = "s9-mercy-over-rule.jpeg"
...
BEATS = [
    ...
    ("n2", S2, "in"),
    ("n3", S3, "in"),
    ("jv4", S4, "in"),                          # IS IT LAWFUL... — full silence 1
    ("n4", S5, "in"),
    ("jv5", S6, "in"),                          # STRETCH FORTH THINE HAND — full silence 2
    ("n5", S7, "in"),
    ("n6", S8, "in"),
    ("n7", S9, "in"),
]
...
def main():
    ...
    print(f"sacred silence 1 (is it lawful): jv4 at {start_of['jv4']:.1f}s", flush=True)
    print(f"sacred silence 2 (stretch forth): jv5 at {start_of['jv5']:.1f}s", flush=True)
