#!/usr/bin/env python3
"""Assemble Story Video #167 — I have chosen you, and ordained you (John 15:16).
MEMBER shelf verse-video → Gospel Library topic: Callings.
...
Face-never (the #1 Law): the risen Lord / God is never rendered anywhere — the one who
calls, chooses and ordains is shown only as warm light from heaven (never a dove, never a
figure); the called ones are ordinary people (gate PASS — no divine proper noun in any shot).

TWO SACRED SILENCES (the music bed dies to true silence for both) — the one verse split:
  kv16a  John 15:16a  "...I have chosen you, and ordained you," — the calling
  kv16b  John 15:16b  "...bring forth fruit... ask of the Father in my name" — purpose + promise
A warm bed carries it in, dies before the choosing verse, returns, dies again before
the fruit verse, then returns for the invitation.
...
Output: john-15_chosen-and-ordained.mp4, 1080x1920 H.264 30fps, <30MB.
"""
...
S1 = "s1-ordinary-lives.jpeg"
S2 = "s2-chosen.jpeg"
S3 = "s3-ordained.jpeg"
S4 = "s4-sent-to-go.jpeg"
S5 = "s5-bring-forth-fruit.jpeg"
S6 = "s6-fruit-that-remains.jpeg"
S7 = "s7-ask-and-receive.jpeg"
S8 = "s8-called-by-name.jpeg"
...
GL_POINTER = "Learn more — Gospel Library: Callings"

BEATS = [
    ("n1", S1, "in"),
    ("kv16a", S2, "in"),                     # SACRED SILENCE 1 — I have chosen you, and ordained you (John 15:16a, named)
    ("n2", S3, "in"),
    ("n3", S4, "in"),
    ("n4", S5, "in"),
    ("kv16b", S6, "in"),                     # SACRED SILENCE 2 — bring forth fruit that remains, ask the Father (John 15:16b)
    ("n5", S7, "in"),
    ("n6", S7, "out"),
    ("n7", S8, "in"),
]
...
def main():
    ...
    print(f"sacred silence 1 (chosen and ordained, John 15:16a): kv16a at {start_of['kv16a']:.1f}s",
          flush=True)
    print(f"sacred silence 2 (fruit that remains, John 15:16b): kv16b at {start_of['kv16b']:.1f}s",
          flush=True)
    ...
    p1_end = start_of["kv16a"] + spoken["kv16a"]
    p2_end = start_of["kv16b"] + spoken["kv16b"]
    beds = [
        (0.0, start_of["kv16a"] - 1.2, "b"),
        (p1_end + 1.0, start_of["kv16b"] - 1.0, "a"),
    ...
    OUT = "john-15_chosen-and-ordained.mp4"
    A_KBPS, MUX = 96, 20
