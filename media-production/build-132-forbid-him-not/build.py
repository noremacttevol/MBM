...
BEATS = [
    ("n0", ST1, "in"),     # John's complaint
    ("n1", ST4, "in"),     # defensive loyalty
    ("n2", ST5, "in"),     # the correction begins
    ("j1", ST6, "in"),     # KJV Mark 9:39-40 — the open hand [SILENCE]
    ("n3a", ST8, "in"),    # a cup of water
    ("n3b", ST7, "in"),    # not a team — about Him (the wide circle)
    ("n4", ST9, "in"),     # John understands
]
