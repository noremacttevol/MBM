#!/usr/bin/env python3
"""Assemble Story Video #100 — The Ascension (Acts 1:6-11).
...
CONTENT-CARE: clean — hope and commission, no fear. FACE LAW v3: Jesus is
face-shown as he ascends (master-locked, only he wears cream); the two men in
white are angels, faces fine. Audit that Jesus matches the master ref.

ONE SACRED SILENCE: j1 — Acts 1:8 (ye shall be witnesses, the centerpiece),
Jesus voice, cream italic. n1 gets the draft's extended hold before the
ascent. n2 recorded in halves so the lift and the cloud land on their own
stills per the CAPTION LAW.
...
paths in segs/. Output: acts-1_the-ascension.mp4,
...
ST1 = "s1-the-last-moments.jpeg"
ST2 = "s2-the-commission.jpeg"
ST3 = "s3-being-sent.jpeg"
ST4 = "s4-lifted-up.jpeg"
ST5 = "s5-the-cloud-received-him.jpeg"
ST6 = "s6-staring-into-the-sky.jpeg"
ST7 = "s7-the-promise-of-return.jpeg"
ST8 = "s8-he-will-come-again.jpeg"

TEXT = {s[0]: s[4] for s in make_narration.SEGMENTS}
KJV = {"j1"}

# MEMBER shelf: one-line Gospel Library pointer under the closing invitation.
GL_POINTER = "Learn more — Gospel Library: Second Coming"

BEATS = [
    ("n0", ST1, "in"),           # the last moments
    ("j1", ST2, "in"),           # SACRED SILENCE — Acts 1:8, the commission
    ("n1", ST3, "in"),           # handing them the mission — being sent; extended hold
    ("n2a", ST4, "in"),          # he was lifted up
    ("n2b", ST5, "in"),          # a cloud received him
    ("n3", ST6, "in"),           # two figures in white — staring into the sky
    ("n4", ST7, "in"),           # this same Jesus will come back — the promise
    ("n5", ST8, "in"),           # a mission, a promise — he will come again
]

LEAD = 0.28
GAP = 0.65
KJV_GAP = 1.60
# Per-beat gap override: n1 = the draft's sacred-silence beat before the ascent.
HOLD = {"n1": 1.60}
CARD_HOLD = 5.0
...
def main():
    ...
    print(f"sacred silence: j1 (Acts 1:8) at {start_of['j1']:.1f}s", flush=True)
