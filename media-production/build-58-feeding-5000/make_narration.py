...
SEGMENTS = [
    ...
    ("n2b", NARRATOR, "Where are we going to buy bread for these people to eat? He was not worried. John tells us plainly that he already knew exactly what he was going to do — he asked to see what Philip would say."),
    ...
    ("n7b", NARRATOR, "This really is the Prophet who was promised, they said — the one who was to come into the world. He had taken almost nothing, given thanks for it, and fed them all."),
