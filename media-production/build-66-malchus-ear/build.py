#!/usr/bin/env python3
"""Assemble Story Video #66 — Malchus's Ear (Luke 22:47-51 / Matt 26).
...
Output: luke-22_malchus-ear.mp4, 1080x1920 H.264 30fps, <25MB.
"""
import os
import subprocess
import textwrap
...
S1 = "s1-torches-in-the-garden.jpeg"
S2 = "s2-the-moment-after.jpeg"
S3 = "s3-suffer-ye-thus-far.jpeg"
S4 = "s4-he-touched-his-ear.jpeg"
S5 = "s5-made-whole.jpeg"
S6 = "s6-mercy-in-the-torchlight.jpeg"
S7 = "s7-the-healed-enemy.jpeg"

TEXT = {s[0]: s[4] for s in make_narration.SEGMENTS}
KJV = {"j1", "j2"}
CARD_TEXT = ("He healed the man sent to seize him. There is no enemy too "
             "far for his mercy — including the one you're afraid is in you.")
...
def caption_layers(seg_id, dur, spoken_end, text, kjv):
    ...
    for i, c in enumerate(chunks):
        ...
        filters.append(
            ...
            f"box=1:boxcolor=black@0.62:boxborderw=22,"
...
def main():
    ...
    print(f"total runtime: {total:.1f}s ({total/60:.2f} min); "
          f"silences at j1 {j1_start:.1f}s / j2 {j2_start:.1f}s; "
