...
S1 = "s1-the-high-priest.jpeg"
S2 = "s2-compassed-with-infirmity.jpeg"
S3 = "s3-no-man-taketh-it.jpeg"
S4 = "s4-called-of-god.jpeg"
S5 = "s5-laying-on-of-hands.jpeg"
S6 = "s6-the-anointing.jpeg"
S7 = "s7-so-also-christ.jpeg"
S8 = "s8-called-still.jpeg"
...
GL_POINTER = "Learn more — Gospel Library: Priesthood"
...
BEATS = [
    ...
    ("n2", S2, "in"),
    ("n3", S3, "in"),
    ("kv4", S4, "in"),                       # SACRED SILENCE 1 — the named verse (card)
    ("n4", S4, "out"),
    ("n5", S5, "in"),
    ("n6", S6, "in"),
    ("kv5", S7, "in"),                       # SACRED SILENCE 2 — even Christ was called
    ("n7", S7, "out"),
    ("n8", S8, "in"),
]
...
def main():
    ...
    print(f"sacred silence 1 (the named verse): kv4 at {start_of['kv4']:.1f}s",
          flush=True)
    print(f"sacred silence 2 (even Christ was called): kv5 at {start_of['kv5']:.1f}s",
          flush=True)
    ...
    p1_end = start_of["kv4"] + spoken["kv4"]
    p2_end = start_of["kv5"] + spoken["kv5"]
    beds = [
        (0.0, start_of["kv4"] - 1.2, "b"),
    ...
    OUT = "hebrews-5_called-of-god.mp4"
    A_KBPS, MUX = 96, 20
