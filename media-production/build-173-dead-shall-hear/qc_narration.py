...
EQUIV extended for video #40: this script leans on the number "three" (three loaves)
and on rare KJV words ("importunity", "exalteth"-class verbs, "thee", "thy") that the
small model mangles — hence the medium.en tie-break below.
"""
import re
import sys
...
EQUIV = {
    ...
    "1st": "first", "10th": "tenth", "11": "eleven",
    "000": "thousand", "5000": "five thousand",
    "here": "hear",   # perfect homophone /hir/ — STT spelling, not an audio defect (build-173)
}
...
def main():
    ...
    # mishears rare biblical words ("importunity", "needeth", "hallowed") that
