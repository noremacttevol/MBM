#!/usr/bin/env python3
"""Assemble Video #123 — The Golden Rule (Matthew 7:12, with Luke 6:38).
...
KJV <=3, long segments split into synced chunks. Copied from the build-122 template.
...
TWO SACRED SILENCES (music bed dies to true silence for each, separately):
  jvA   Matt 7:12   "Therefore all things whatsoever ye would that men should do to you..."
  jvB   Luke 6:38   "Give, and it shall be given unto you; good measure, pressed down..."
No-Dead-Air is unaffected: the narrator never stops, only the music does.

Output: matthew-7_golden-rule.mp4, 1080x1920 H.264 30fps, <30MB.
"""
import os
import subprocess
import textwrap
...
S1 = "s1-the-crowd-listening.jpeg"
S2 = "s2-two-travelers-as-equals.jpeg"
S3 = "s3-the-longing-at-the-gate.jpeg"
S4 = "s4-bread-to-the-stranger.jpeg"
S5 = "s5-water-on-the-road.jpeg"
S6 = "s6-the-mercy-given.jpeg"
S7 = "s7-lifting-the-fallen.jpeg"
S8 = "s8-good-measure-returned.jpeg"
S9 = "s9-the-shared-table.jpeg"
S10 = "s10-neighbors-at-peace.jpeg"
...
BEATS = [
    ("n1", S1, "in"),
    ("jvA", S2, "in"),          # Matt 7:12 the rule — sacred silence 1
    ("n2", S3, "in"),
    ("n3", S4, "in"),
    ("n4", S5, "in"),
    ("n5", S6, "in"),
    ("n6", S7, "in"),
    ("jvB", S8, "in"),          # Luke 6:38 good measure returned — sacred silence 2
    ("n7", S9, "in"),
    ("n8", S10, "in"),
]
...
def build_still(seg_id, src, dur, zdir, spoken_end, cap_text, kjv, first):
    ...
    # stills may carry a painted storybook border; crop the outer ~6% to remove it
