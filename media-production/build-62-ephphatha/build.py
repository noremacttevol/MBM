#!/usr/bin/env python3
"""Assemble Story Video #62 — Ephphatha, the Deaf Man (Mark 7:31-37).
...
Output: mark-7_ephphatha.mp4, 1080x1920 H.264 30fps, <25MB.
"""
import os
import subprocess
import textwrap
...
S1 = "s1-the-road-back.jpeg"
S2 = "s2-behind-the-wall.jpeg"
S3 = "s3-they-brought-him.jpeg"
S4 = "s4-aside.jpeg"
S5 = "s5-the-sign.jpeg"
S6 = "s6-the-sigh.jpeg"
S7 = "s7-opened.jpeg"
...
SPEAKER = {s[0]: s[1] for s in make_narration.SEGMENTS}  # SEGMENTS are (name, speaker, text) since the speaker migration
CARD_TEXT = ("He does not heal for an audience. He takes you aside, meets "
             "you in your silence, and opens what was shut.")

# s3 (the begging) is banked in assets but not cut in — n2's point is the
# taking-aside, which s4 shows; one still per audio segment.
BEATS = [
    ("n0", S1, "in"),
    ("n1", S2, "in"),
    ("n2", S4, "in"),
