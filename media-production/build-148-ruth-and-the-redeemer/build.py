...
BEATS = [
    ("n0", ST1, "in"),     # leaving Moab — the road at dawn
    ("n1", ST2, "in"),     # the parting — one leaves, Ruth clings
    ("n2", ST3, "in"),     # the pledge (sacred hold)
    ("n3", ST4, "in"),     # gleaning the Bethlehem fields
    ("n4", ST5, "in"),     # Boaz notices — a redeemer by the law
    ("n5", ST6, "in"),     # the threshing floor — the cloak
    ("n6a", ST7, "in"),    # the town gate — the right redeemed
    ("n6b", ST8, "in"),    # Naomi's arms filled
    ("n7", ST9, "out"),    # the line toward the sun — to the Redeemer
]
