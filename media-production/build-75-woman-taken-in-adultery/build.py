#!/usr/bin/env python3
"""Assemble Story Video #75 — The Woman Taken in Adultery (John 8:1-11).
...
(John 8:7, 8:10, 8:11 — exact KJV; her reply is narrator-paraphrased, never voiced).
NO music bed of any kind (HUM PURGE 2026-07-16): narration + intentional silence only.
CONTENT-CARE (D,R): the accusation is named once, never dramatized; no violence,
no stone ever raised or in the air; no shame framing; mercy spoken in the KJV lines.

SPLIT BEAT: n1 (stood in the middle / caught in adultery, what do you say) plays over
TWO stills — s2, s3 — cut at a caption-chunk boundary. j1 [SILENCE] on s6; j2 on s8
(only the two), n5 on s8-out (she looked up); j3 [SILENCE] on s9, then a short SILENT
HUSH on s10 (the unthrown stone) breathes before the closing card — the hush stays
inside the 2.5s dead-air law.

Caption box black@0.55 — dawn temple, verified on the lightest frame.

Output: john-8_woman-taken-in-adultery.mp4, 1080x1920 H.264 30fps, <30MB.
"""
import os
import subprocess
import textwrap
...
S1 = "s1-teaching-at-dawn.jpeg"
S2 = "s2-the-interruption.jpeg"
S3 = "s3-in-the-middle.jpeg"
S4 = "s4-the-stone-held-low.jpeg"
S5 = "s5-writing-in-the-dust.jpeg"
S6 = "s6-the-one-line.jpeg"
S7 = "s7-stones-on-the-ground.jpeg"
S8 = "s8-only-the-two.jpeg"
...
def main():
    ...
    OUT = "john-8_woman-taken-in-adultery.mp4"
    A_KBPS, MUX = 96, 20
