...
BEATS = [
    ("n0a", ST1, "in"),    # the caravan leaves Jerusalem
    ("n0b", ST2, "in"),    # he is not with us
    ("n1a", ST3, "in"),    # three days searching
    ("n1b", ST4, "in"),    # found among the teachers
    ("n1c", ST5, "in"),    # the questions that amazed them
    ("n2", ST6, "in"),     # found — his mother asks why
    ("j1", ST7, "in"),     # KJV Luke 2:49 — my Father's business [SILENCE]
    ("n3", ST8, "in"),     # went home and obeyed, kept growing
]
