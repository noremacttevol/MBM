#!/usr/bin/env python3
"""Generate #168's 8 stills via flow_driver.py (Nano Banana 2, 9:16, $0).
No Christ/God/Spirit figure anywhere (the one Nicodemus comes to + the Spirit shown only as
warm light, never a dove), NO --ref. Shot bodies from PROMPTS.md in order; outputs = build.py's S1..S8."""
import re
import subprocess
import sys
...
FILENAMES = [
    "s1-nicodemus-by-night.jpeg", "s2-comes-to-the-light.jpeg", "s3-born-again.jpeg",
    "s4-how-can-this-be.jpeg", "s5-born-of-water.jpeg", "s6-and-of-the-spirit.jpeg",
    "s7-enter-the-kingdom.jpeg", "s8-the-gate-for-you.jpeg",
]
...
print("ALL 168 STILLS GENERATED")
