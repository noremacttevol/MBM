#!/usr/bin/env python3
"""Assemble MEMBER Verse Video #191 — The Windows of Heaven
(Malachi 3:8-10).
...
CONTENT-CARE: clean — generosity and wonder, no fear. Jesus does not
appear (Old Testament prophet); no divine figure.

ONE SACRED SILENCE: s1 — Malachi 3:10 (the windows of heaven), scripture
voice, cream italic. n2 (the dare) gets the draft's extended hold. n3 is
recorded in two halves (n3a/n3b) landing on s5 no-room-enough and s6
wonder-not-worry per the CAPTION LAW; s7 the-open-door doubles the card's
invitation and is left unused rather than creating dead air.
...
paths in segs/. Output: malachi-3_windows-of-heaven.mp4,
...
ST1 = "s1-the-storehouse-at-dawn.jpeg"
ST2 = "s2-the-willing-tithe.jpeg"
ST3 = "s3-the-prophet-speaks.jpeg"
ST4 = "s4-the-windows-open.jpeg"
ST5 = "s5-no-room-enough.jpeg"
ST6 = "s6-wonder-not-worry.jpeg"

TEXT = {s[0]: s[4] for s in make_narration.SEGMENTS}
KJV = {"s1"}

# MEMBER shelf: one-line Gospel Library pointer under the closing invitation.
GL_POINTER = "Learn more — Gospel Library: Tithing"

BEATS = [
    ("n0", ST1, "in"),           # the storehouse at dawn
    ("n1", ST2, "in"),           # the willing tithe
    ("s1", ST3, "in"),           # SACRED SILENCE — Mal 3:10, the prophet speaks
    ("n2", ST4, "in"),           # the windows open — extended quiet hold
    ("n3a", ST5, "in"),          # not a trickle
    ("n3b", ST6, "in"),          # more than there is room to hold
]
...
def main():
    ...
    print(f"sacred silence: s1 (Mal 3:10) at {start_of['s1']:.1f}s", flush=True)
    ...
    OUT = "malachi-3_windows-of-heaven.mp4"
    A_KBPS = 96
    MUX = 20
