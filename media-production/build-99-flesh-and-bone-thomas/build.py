#!/usr/bin/env python3
"""Assemble Story Video #99 — Flesh and Bone; Thomas's Hands
...
CONTENT-CARE: the risen wounds are the story's PROOF, shown gently — clean
scar-marks in the hands, never gore or fresh wounds. FACE LAW v3: Jesus is
face-shown (master-locked, only he wears cream); audit against the master ref.

TWO SACRED SILENCES: j1 — Luke 24:39 (handle me and see) and j2 — John 20:27
(reach hither thy finger), Jesus voice, cream italic. n2 gets the draft's
extended hold before the eight-days-later beat. n4 recorded in halves so the
eight beats fill the eight stills per the CAPTION LAW.
...
paths in segs/. Output: john-20_flesh-and-bone-thomas.mp4,
...
ST1 = "s1-he-stood-among-them.jpeg"
ST2 = "s2-behold-my-hands.jpeg"
ST3 = "s3-terror-to-joy.jpeg"
ST4 = "s4-the-quiet-proof.jpeg"
ST5 = "s5-thomas-doubts.jpeg"
ST6 = "s6-reach-hither.jpeg"
...
BEATS = [
    ("n0", ST1, "in"),           # he stood among them
    ("n1", ST3, "in"),           # calmed them — terror to joy
    ("j1", ST2, "in"),           # SACRED SILENCE 1 — Luke 24:39, behold my hands
    ("n2", ST5, "in"),           # Thomas wasn't there — Thomas doubts; extended hold
    ("n3", ST4, "in"),           # eight days later — the quiet proof offered
    ("j2", ST6, "in"),           # SACRED SILENCE 2 — John 20:27, reach hither
    ("n4a", ST7, "in"),          # met the doubt with his hands — my Lord and my God
    ("n4b", ST8, "in"),          # he steps toward honest doubt — the open hand
]

LEAD = 0.28
GAP = 0.65
KJV_GAP = 1.60
# Per-beat gap override: n2 = the draft's sacred-silence beat before j2's setup.
HOLD = {"n2": 1.60}
CARD_HOLD = 5.0
...
def main():
    ...
    print(f"sacred silences: j1 (Luke 24:39) at {start_of['j1']:.1f}s, j2 (John 20:27) at {start_of['j2']:.1f}s", flush=True)
    ...
    OUT = "john-20_flesh-and-bone-thomas.mp4"
    A_KBPS = 96
    MUX = 20
