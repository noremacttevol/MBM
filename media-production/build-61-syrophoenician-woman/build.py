#!/usr/bin/env python3
"""Assemble Story Video #61 — The Syrophoenician Woman (Mark 7:24-30).
...
Output: mark-7_syrophoenician-woman.mp4, 1080x1920 H.264 30fps, <25MB.
"""
import os
import subprocess
import textwrap
...
S1 = "s1-the-house.jpeg"
S2 = "s2-she-heard.jpeg"
S3 = "s3-at-his-feet.jpeg"
S4 = "s4-children-first.jpeg"
S5 = "s5-her-answer.jpeg"
S6 = "s6-go-thy-way.jpeg"
S7 = "s7-the-walk-home.jpeg"
S8 = "s8-whole.jpeg"
S9 = "s9-the-doorway.jpeg"

TEXT = {s[0]: s[4] for s in make_narration.SEGMENTS}
KJV = {"j1", "j2"}
CARD_TEXT = ("She refused to believe there was no room for her at his "
             "table. There is room for you.")
...
def main():
    ...
    OUT = "mark-7_syrophoenician-woman.mp4"
    A_KBPS, MUX = 96, 20
