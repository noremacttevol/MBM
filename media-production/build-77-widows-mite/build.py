#!/usr/bin/env python3
"""Assemble Story Video #77 — The Widow's Mite (Mark 12:41-44).
...
CARE-GREEN: the widow keeps full dignity, never a pity-spectacle; all cheeks
dry (no-fake-tears). Face-shown Jesus locked to master (s1/s7), only-Jesus-in-
cream held. Two-voice: narrator en-US-AndrewNeural; Jesus
en-US-ChristopherNeural exact KJV Mark 12:43-44. Ear-check pass incl. "living"
(noun). n1/n2/n4 split so each still lands its beat.

SACRED SILENCE: the marked hold on j1 (more than all of them) on s7.

NO MUSIC BED (HUM PURGE law). Warm interior-daylight: caption box black@0.60.

Output: mark-12_the-widows-mite.mp4, 1080x1920 H.264 30fps, <25MB.
"""
import os
import subprocess
import textwrap
...
ST1 = "s1-he-sat-and-watched.jpeg"
ST2 = "s2-the-flourish.jpeg"
ST3 = "s3-the-parade.jpeg"
ST4 = "s4-small-and-unnoticed.jpeg"
ST5 = "s5-two-mites.jpeg"
ST6 = "s6-he-saw-it.jpeg"
ST7 = "s7-more-than-all-of-them.jpeg"
ST8 = "s8-she-never-knew.jpeg"
ST9 = "s9-heavens-math.jpeg"

TEXT = {s[0]: s[4] for s in make_narration.SEGMENTS}
KJV = {"j1"}   # Mark 12:43-44, Jesus voice — cream italic
LONG_HOLD = {"j1"}   # the marked more-than-all silence
MID_HOLD = set()
CARD_TEXT = TEXT["card"]

BEATS = [
    ("n0", ST1, "in"),     # he sat and watched
    ("n1a", ST2, "in"),    # the rich, the flourish
    ("n1b", ST3, "in"),    # the parade, everyone noticed
    ("n2a", ST4, "in"),    # a poor widow, small and unnoticed
    ("n2b", ST5, "in"),    # two mites
    ("n3", ST6, "in"),     # he saw it — called the disciples
    ("j1", ST7, "in"),     # KJV Mark 12:43-44 — more than all [SILENCE]
    ("n4a", ST8, "in"),    # she gave what she needed (she never knew)
    ("n4b", ST9, "in"),    # heaven's math
]
...
def main():
    ...
    OUT = "mark-12_the-widows-mite.mp4"
    A_KBPS, MUX = 96, 20
