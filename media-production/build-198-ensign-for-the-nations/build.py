#!/usr/bin/env python3
"""Assemble MEMBER Verse Video #198 — An Ensign for the Nations
(Isaiah 11:11-12).
...
CONTENT-CARE: clean — gathering and homecoming, no fear. Jesus does not
appear (Isaiah; the root of Jesse is hinted, no master face).

TWO SACRED SILENCES: kv11 — Isaiah 11:11 (recover the remnant the second
time) and kv12 — Isaiah 11:12 (set up an ensign for the nations, the
centerpiece), scripture voice, cream italic. Only five stills, so the ensign
still is HELD across n1 and kv11 (in-drift then out-drift) — the raising and
the second-time recovery are the same beat visually.
...
paths in segs/. Output: isaiah-11_ensign-for-the-nations.mp4,
...
ST1 = "s1-the-ensign-raised.jpeg"
ST2 = "s2-the-root-of-jesse.jpeg"
ST3 = "s3-from-the-four-corners.jpeg"
ST4 = "s4-the-gathered.jpeg"
ST5 = "s5-home.jpeg"
...
BEATS = [
    ("n0", ST2, "in"),           # the root of Jesse
    ("n1", ST1, "in"),           # the ensign raised as a banner
    ("s1", ST1, "out"),          # SACRED SILENCE 1 — Isa 11:11, second-time recovery
    ("s2", ST3, "in"),           # SACRED SILENCE 2 — Isa 11:12, from the four corners
    ("n2", ST4, "in"),           # exiles brought home — the gathered
    ("n3", ST5, "in"),           # the seeking ones come home
]
...
def main():
    ...
    print(f"sacred silences: s1 (Isa 11:11) at {start_of['s1']:.1f}s, s2 (11:12) at {start_of['s2']:.1f}s", flush=True)
    ...
    OUT = "isaiah-11_ensign-for-the-nations.mp4"
    A_KBPS = 96
    MUX = 20
