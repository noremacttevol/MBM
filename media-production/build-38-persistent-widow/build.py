#!/usr/bin/env python3
"""Assemble Story Video #38 — The Persistent Widow (Luke 18:1-8).
...
Face-never (#18): this is a parable told from off-screen — the widow, the cold
judge, and the person praying are all ordinary characters shown fully; there is
NO Jesus figure in any still.

Milk framing: the whole point is CONTRAST — God is nothing like the reluctant,
annoyed judge. He is not worn down into caring; he already loves you and already
wants to hear you.
...
("...shall not God avenge his own elect..." — the turn, the peak), so it lands in
true silence; a warm bed returns after and is out before the closing card.

Output: luke-18_persistent-widow.mp4 (SCRIPTURE-NAME LAW), 1080x1920 H.264 30fps, <25MB.
"""
import os
import subprocess
import textwrap
...
S1 = "s1-widow-alone.jpeg"
S2 = "s2-widow-pleads.jpeg"
S3 = "s3-judge-dismisses.jpeg"
S4 = "s4-again-and-again.jpeg"
S5 = "s5-judge-relents.jpeg"
S6 = "s6-praying-heard.jpeg"
S7 = "s7-the-good-father.jpeg"
...
def main():
    ...
    OUT = "luke-18_persistent-widow.mp4"
