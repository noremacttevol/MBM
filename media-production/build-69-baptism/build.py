#!/usr/bin/env python3
"""Assemble Story Video #69 — The Baptism of Jesus (Matt 3:13-17).
...
Output: matt-3_baptism-of-jesus.mp4, 1080x1920 H.264 30fps, <25MB.
"""
import os
import subprocess
import textwrap
...
S1 = "s1-john-baptizing.jpeg"
S2 = "s2-he-joined-the-line.jpeg"
S3 = "s3-john-protests.jpeg"
S4 = "s4-fulfil-all-righteousness.jpeg"
S5 = "s5-the-baptism.jpeg"
S6 = "s6-heavens-opened.jpeg"
S7 = "s7-the-voice.jpeg"
S8 = "s8-beloved-son.jpeg"
S9 = "s9-toward-the-wilderness.jpeg"

TEXT = {s[0]: s[4] for s in make_narration.SEGMENTS}
KJV = {"j1", "jv1"}
CARD_TEXT = ("He walked through the door first, so you would never face "
             "one he hadn't. The way in is still open.")
...
def main():
    ...
    OUT = "matt-3_baptism-of-jesus.mp4"
    A_KBPS, MUX = 96, 20
