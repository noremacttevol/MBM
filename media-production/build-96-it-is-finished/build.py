#!/usr/bin/env python3
"""Assemble Story Video #96 — "It Is Finished"; the Veil Torn
(John 19:30 / Matthew 27:50-51).
...
CONTENT-CARE — CRUCIFIXION (R, RESTRAINT LAW): the cross is real but the
violence is never the picture — no gore, no wounds in focus, no nails driving.
The stills carry the completion (eyes to heaven, bowed head) and the torn veil,
not the suffering. FACE LAW v3: Jesus face-shown (master-locked, only he wears
cream); audit every frame with "would a parent let a 10-year-old see this?"

ONE SACRED SILENCE: j1 — John 19:30 ("It is finished." — three words), Jesus
voice, cream italic. n1 gets the draft's extended hold. n3/n4 recorded in
halves so the eight beats fill the eight stills per the CAPTION LAW.
...
paths in segs/. Output: john-19_it-is-finished.mp4,
...
ST1 = "s1-the-failing-light.jpeg"
ST2 = "s2-eyes-toward-heaven.jpeg"
ST3 = "s3-it-is-finished.jpeg"
ST4 = "s4-he-bowed-his-head.jpeg"
ST5 = "s5-the-veil-begins-to-split.jpeg"
ST6 = "s6-torn-in-two.jpeg"
ST7 = "s7-the-way-standing-open.jpeg"
ST8 = "s8-light-into-darkness.jpeg"
...
BEATS = [
    ("n0", ST1, "in"),           # the failing light — a work being finished
    ("n1", ST2, "in"),           # eyes toward heaven — a declaration; extended hold
    ("j1", ST3, "in"),           # SACRED SILENCE — John 19:30 "It is finished."
    ("n2", ST4, "in"),           # he bowed his head, gave up the spirit
    ("n3a", ST5, "in"),          # the veil begins to split
    ("n3b", ST6, "in"),          # torn in two — by a hand from above
    ("n4a", ST7, "in"),          # ripped open — the way standing open
    ("n4b", ST8, "in"),          # thrown wide for everyone — light into darkness
]

LEAD = 0.28
GAP = 0.65
KJV_GAP = 1.60
# Per-beat gap override: n1 = the draft's sacred-silence beat before the words.
HOLD = {"n1": 1.60}
CARD_HOLD = 5.0
...
def main():
    ...
    print(f"sacred silence: j1 (John 19:30) at {start_of['j1']:.1f}s", flush=True)
    ...
    OUT = "john-19_it-is-finished.mp4"
    A_KBPS = 96
    MUX = 20
