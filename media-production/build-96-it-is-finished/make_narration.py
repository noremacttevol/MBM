...
SEGMENTS = [
    ...
    ("n1c", NARRATOR, "Father, I put my spirit in your hands. The last words he said were words of trust, spoken to the Father he had been talking to all night."),
    # John 19:30
...
SPOKEN.update({'twain': 'twaine'})  # boundary-slur fixes, in-context verified 2026-07-20
