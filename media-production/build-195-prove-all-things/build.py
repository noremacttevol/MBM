#!/usr/bin/env python3
"""Assemble MEMBER Verse Video #195 — Prove All Things; Hold Fast That
...
CONTENT-CARE: clean — discernment, no fear. Jesus does not appear (epistle).

TWO SACRED SILENCES: s1 — 1 Thes 5:21 (prove all things, the centerpiece)
and s2 — 5:22 (abstain from all appearance of evil), scripture voice, cream
italic. n1 (test everything) gets the draft's extended hold. Stills matched
...
paths in segs/. Output: 1thessalonians-5_prove-all-things.mp4,
...
ST1 = "s1-weighing-the-scrolls.jpeg"
ST2 = "s2-held-to-the-light.jpeg"
ST3 = "s3-holding-fast-the-good.jpeg"
ST4 = "s4-the-closed-door.jpeg"
ST5 = "s5-conviction-not-anxiety.jpeg"
ST6 = "s6-carried-like-a-lantern.jpeg"
ST7 = "s7-worth-keeping.jpeg"
...
BEATS = [
    ("n0", ST1, "in"),           # the sharp command — weighing the scrolls
    ("s1", ST2, "in"),           # SACRED SILENCE 1 — 1 Thes 5:21, held to the light
    ("n1", ST6, "in"),           # test everything, hold to light — the lantern
    ("n2", ST3, "in"),           # cling to what is good — holding fast the good
    ("n3", ST5, "in"),           # the warning, the shortest fence — conviction
    ("s2", ST4, "in"),           # SACRED SILENCE 2 — 1 Thes 5:22, the closed door
    ("n4", ST7, "in"),           # checks then commits — worth keeping
]
...
def main():
    ...
    print(f"sacred silences: s1 (1 Thes 5:21) at {start_of['s1']:.1f}s, s2 (5:22) at {start_of['s2']:.1f}s", flush=True)
    ...
    OUT = "1thessalonians-5_prove-all-things.mp4"
    A_KBPS = 96
    MUX = 20
