...
S1 = "s1-amos-foretells.jpeg"
S2 = "s2-fed-but-hollow.jpeg"
S3 = "s3-the-hollow-place.jpeg"
S4 = "s4-the-empty-shelf.jpeg"
S5 = "s5-wandering-to-seek.jpeg"
S6 = "s6-seeking-not-finding.jpeg"
S7 = "s7-from-sea-to-sea.jpeg"
S8 = "s8-the-word-returns.jpeg"
...
GL_POINTER = "Learn more — Gospel Library: Apostasy"

BEATS = [
    ("n1", S1, "in"),
    ("n2", S2, "in"),
    ("n3", S3, "in"),
    ("kv11", S4, "in"),                      # SACRED SILENCE 1 — famine of the word (Amos 8:11, named)
    ("n4", S4, "out"),
    ("n5", S5, "in"),
    ("n6", S6, "in"),
    ("kv12", S7, "in"),                      # SACRED SILENCE 2 — wander, seek, not find (Amos 8:12)
    ("n7", S7, "out"),
    ("n8", S8, "in"),
]
...
def main():
    ...
    print(f"sacred silence 1 (famine of the word, Amos 8:11): kv11 at {start_of['kv11']:.1f}s",
          flush=True)
    print(f"sacred silence 2 (wander, seek, not find, Amos 8:12): kv12 at {start_of['kv12']:.1f}s",
          flush=True)
    ...
    p2_end = start_of["kv12"] + spoken["kv12"]
    beds = [
        (0.0, start_of["kv11"] - 1.2, "b"),
        (p1_end + 1.0, start_of["kv12"] - 1.0, "a"),
