...
Output: 1kings-19_the-still-small-voice.mp4, 1080x1920 H.264 30fps, <30MB.
"""
import os
import subprocess
import textwrap
...
S1 = "s1-flight-in-the-wilderness.jpeg"
S2 = "s2-bread-in-the-desert.jpeg"
S3 = "s3-the-long-journey.jpeg"
S4 = "s4-the-cave-on-the-mount.jpeg"
S5 = "s5-the-great-wind.jpeg"
S6 = "s6-the-earthquake.jpeg"
S7 = "s7-the-fire.jpeg"
S8 = "s8-the-still-small-voice.jpeg"
S9 = "s9-standing-to-listen.jpeg"
S10 = "s10-seven-thousand.jpeg"

TEXT = {s[0]: s[4] for s in make_narration.SEGMENTS}
KJV = {"jv9", "jv11a", "jv11b", "jv12", "jv18"}
...
BEATS = [
    ...
    ("n2", S2, "in"),
    ("n3", S3, "in"),
    ("jv9", S4, "in"),          # "What doest thou here, Elijah?"
    ("n4", S4, "out"),
    ("jv11a", S5, "in"),        # the great wind — the LORD not in it
    ("jv11b", S6, "in"),        # the earthquake — the LORD not in it
    ("n5", S7, "in"),           # the fire — not in any of them
    ("jv12", S8, "in"),         # the STILL SMALL VOICE — sacred silence 1
    ("n6", S8, "out"),
    ("n7", S9, "in"),
    ("jv18", S10, "in"),        # seven thousand — sacred silence 2
    ("n8", S10, "out"),
]
...
def main():
    ...
    print(f"sacred silence 1 (still small voice): jv12 at {start_of['jv12']:.1f}s", flush=True)
    print(f"sacred silence 2 (seven thousand): jv18 at {start_of['jv18']:.1f}s", flush=True)
    ...
    OUT = "1kings-19_the-still-small-voice.mp4"
    A_KBPS = 96
    MUX = 20
