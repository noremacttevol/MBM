...
S1 = "s1-at-caesarea-philippi.jpeg"
S2 = "s2-peters-confession.jpeg"
S3 = "s3-thou-art-peter.jpeg"
S4 = "s4-upon-this-rock.jpeg"
S5 = "s5-gates-shall-not-prevail.jpeg"
S6 = "s6-the-keys-given.jpeg"
S7 = "s7-bind-and-loose.jpeg"
S8 = "s8-the-keys-of-the-kingdom.jpeg"
...
GL_POINTER = "Learn more — Gospel Library: Priesthood Keys"

BEATS = [
    ("n1", S1, "in"),
    ("n2", S2, "in"),
    ("n3", S3, "in"),
    ("kv18", S4, "in"),                      # SACRED SILENCE 1 — upon this rock I will build my church (Matt 16:18)
    ("n4", S4, "out"),
    ("n5", S5, "in"),
    ("n6", S6, "in"),
    ("kv19", S7, "in"),                      # SACRED SILENCE 2 — the keys of the kingdom (Matt 16:19, named)
    ("n7", S7, "out"),
    ("n8", S8, "in"),
]
...
def main():
    ...
    print(f"sacred silence 1 (upon this rock, Matt 16:18): kv18 at {start_of['kv18']:.1f}s",
          flush=True)
    print(f"sacred silence 2 (the keys of the kingdom, Matt 16:19): kv19 at {start_of['kv19']:.1f}s",
          flush=True)
    ...
    p1_end = start_of["kv18"] + spoken["kv18"]
    p2_end = start_of["kv19"] + spoken["kv19"]
    beds = [
        (0.0, start_of["kv18"] - 1.2, "b"),
        (p1_end + 1.0, start_of["kv19"] - 1.0, "a"),
    ...
    OUT = "matthew-16_keys-of-the-kingdom.mp4"
    A_KBPS, MUX = 96, 20
