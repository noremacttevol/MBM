...
SEGMENTS = [
    ...
    ("n0b", NARRATOR, "I will not leave you comfortless. He was hours from the cross, and He was the one doing the comforting — promising that whatever else they lost that week, they would not be left on their own."),
