#!/usr/bin/env python3
"""Assemble MEMBER Verse Video #193 — The Comforter Shall Teach You All
Things (John 14:26).
...
CONTENT-CARE: clean — comfort, no fear. FACE LAW v3: Jesus face-shown per
the W prompt sheet, master-locked, only he wears cream; the Comforter is
HINTED as light, never given a face.

ONE SACRED SILENCE: j1 — John 14:26 (the Comforter, the centerpiece), Jesus
voice, cream italic. n1 (the Helper promised) gets the draft's extended hold.
n2/n3 each recorded in two halves so their named acts land on their own
stills per the CAPTION LAW; stills are matched to beats semantically, not
by numeric order.
...
paths in segs/. Output: john-14_the-comforter.mp4,
...
ST1 = "s1-not-left-alone.jpeg"
ST2 = "s2-the-promise-spoken.jpeg"
ST3 = "s3-receiving.jpeg"
ST4 = "s4-the-hinted-comforter.jpeg"
ST5 = "s5-open-hands.jpeg"
ST6 = "s6-held-in-memory.jpeg"
ST7 = "s7-let-him-teach-you.jpeg"
...
BEATS = [
    ("n0", ST1, "in"),           # not left alone
    ("n1", ST2, "in"),           # the promise spoken — extended quiet hold
    ("n2a", ST3, "in"),          # teach them everything — receiving
    ("n2b", ST6, "in"),          # bring every word back — held in memory
    ("j1", ST4, "in"),           # SACRED SILENCE — John 14:26, the hinted Comforter
    ("n3a", ST5, "in"),          # the promise still stands — open hands
    ("n3b", ST7, "in"),          # teaches everyone now — let him teach you
]

LEAD = 0.28
GAP = 0.65
KJV_GAP = 1.60
# Per-beat gap overrides: n1 = the draft's sacred-silence beat; n3b = a
# longer breath before the card.
HOLD = {"n1": 1.60, "n3b": 1.90}
CARD_HOLD = 5.0
...
def main():
    ...
    print(f"sacred silence: j1 (John 14:26) at {start_of['j1']:.1f}s", flush=True)
