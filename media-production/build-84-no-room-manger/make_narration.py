...
SEGMENTS = [
    ...
    ("n1", NARRATOR, 'The emperor in far-off Rome had ordered it, and so every family in the land had to pack up and travel to the town their ancestors came from, to be registered.'),
