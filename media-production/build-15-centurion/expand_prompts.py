...
JESUS = (
    "a first-century Judean man with warm middle-eastern olive-brown skin, "
    "never pale or European, dark shoulder-length hair and a short dark beard, "
    "wearing an undyed cream wool robe with a simple mantle, his hands and "
    "hair visible and natural, seen three-quarter from a gentle distance with "
    "soft non-specific features, plainly lit with no glow or halo around his "
    "head, exactly two arms, two hands, two legs"
)
CENTURION = (
...
BEATS = {
"s1": "[STILL STYLE BLOCK] Bright honest midday light on [SETTING]. Walking at the head of a small band of travelers entering the town is [JESUS LOCK], stepping gently forward as the group follows behind him. Off to one side, a single Roman soldier in bronze-and-leather armor stands guard beside a tall military standard, marking this as a town under Roman occupation. The lake and low basalt rooftops spread behind them. Every figure has exactly two arms and two hands. One single continuous scene painted edge to edge.",
...
"s4": "[STILL STYLE BLOCK] Bright daylight at the edge of the gathered crowd. [CENTURION LOCK] stands before [JESUS LOCK] and bows his head low, his crested helmet now removed and held under one arm, his other fist pressed to his chest over his heart, his weathered face full of plain honest conviction with no performance. Jesus stands warm and open, seen three-quarter from a gentle distance, receiving him, his soft non-specific features turned toward the kneeling officer. Around them, watching Jewish faces register astonishment that a Roman commander would bow. Every gaze in the crowd is turned toward the two men. Each person has exactly two arms and two hands. One single continuous scene painted edge to edge.",
"s5": "[STILL STYLE BLOCK] Bright daylight. [JESUS LOCK] stands facing the bowed centurion and half-turns his body toward the town beyond, one hand opening outward in a gentle offer to come, his warm olive-brown face soft and three-quarter at a gentle distance, plainly lit with no glow. [CENTURION LOCK] stands close before him, head still lowered, helmet under his arm. A few followers in undyed wool stand near, watching. Each person has exactly two arms and two hands. One single continuous scene painted edge to edge.",
"s6": "[STILL STYLE BLOCK] Bright daylight, close on [CENTURION LOCK], who lifts one open hand to gently STAY the teacher — a respectful halt, palm up — his head still bowed, his weathered clean-shaven face lit with complete quiet conviction, his crested helmet under his other arm. Just past his raised hand, softly out of crisp focus, is the warm cream-robed shoulder and olive-brown hand of [JESUS LOCK] at a gentle distance, plainly lit with no glow. Behind the officer, blurred watching villagers show surprise. The composition centers on the Roman's face and his staying hand. Exactly two arms and two hands on the centurion. One single continuous scene painted edge to edge.",
...
"s8": "[STILL STYLE BLOCK] Bright daylight. A half-ring of following disciples and villagers in undyed wool fills the frame, their faces turned in a row toward one point — disbelief, offense, and slow wonder moving across them. At the point where every gaze converges stands [JESUS LOCK], warm and present three-quarter at a gentle distance, one hand gesturing back toward the armored Roman officer who stands at attention to the side. Jesus's warm olive-brown face is soft and non-specific, plainly lit with no glow or halo. He is not the largest figure — the ring of astonished human faces carries the frame, and all of them look at him. Each person has exactly two arms and two hands. One single continuous scene painted edge to edge.",
...
"s10": "[STILL STYLE BLOCK] Bright daylight. [JESUS LOCK] turns back to [CENTURION LOCK] with a warm, final, reassuring word, his olive-brown face soft and three-quarter at a gentle distance, one hand lifted gently toward the officer, plainly lit with no glow. The centurion is beginning to straighten from his bow, helmet under his arm, his face lifting with dawning relief, his body angling to turn for home. A few followers watch softly behind. Each person has exactly two arms and two hands. One single continuous scene painted edge to edge.",
