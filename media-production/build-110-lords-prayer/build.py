...
Output: matthew-6_the-lords-prayer.mp4, 1080x1920 H.264 30fps, <30MB.
"""
import os
import subprocess
import textwrap
...
S1 = "s1-they-asked-how-to-pray.jpeg"
S2 = "s2-our-father.jpeg"
S3 = "s3-thy-kingdom-come.jpeg"
S4 = "s4-daily-bread.jpeg"
S5 = "s5-forgive-us.jpeg"
S6 = "s6-deliver-us.jpeg"
S7 = "s7-not-many-words.jpeg"
S8 = "s8-a-child-prays.jpeg"
S9 = "s9-the-circle-prays.jpeg"
S10 = "s10-you-can-call-him-father.jpeg"
...
BEATS = [
    ("n1", S1, "in"),
    ("jv9", S2, "in"),          # Our Father... thy kingdom come — sacred silence 1
    ("n2", S3, "in"),           # Father; his name and kingdom first
    ("jv11", S4, "in"),         # daily bread; forgive our debts
    ("n3", S5, "in"),           # the plain things; mercy given and received
    ("jv13", S6, "in"),         # deliver us; thine is the kingdom — sacred silence 2
    ("n4", S7, "in"),           # short, honest, nothing showy
    ("n5", S8, "in"),           # the simplest prayer a child ever whispered
    ("n6", S9, "in"),           # a child in the lap of a good Father
    ("n7", S10, "in"),          # begin with two words: Our Father
]
...
def main():
    ...
    print(f"sacred silence 1 (Our Father): jv9 at {start_of['jv9']:.1f}s", flush=True)
    print(f"sacred silence 2 (deliver us): jv13 at {start_of['jv13']:.1f}s", flush=True)
    ...
    p1_end = start_of["jv9"] + spoken["jv9"]
    p2_end = start_of["jv13"] + spoken["jv13"]
    beds = [
        (0.0, start_of["jv9"] - 1.2, "b"),
        (p1_end + 1.0, start_of["jv13"] - 1.0, "a"),
        (p2_end + 1.0, card_start - 0.8, "a"),
    ]
    print(f"music: bed out at {start_of['jv9'] - 1.2:.1f}s, silent through jv9 "
          f"(ends {p1_end:.1f}s); returns; silent again through jv13 "
    ...
    OUT = "matthew-6_the-lords-prayer.mp4"
    A_KBPS = 96
    MUX = 20
