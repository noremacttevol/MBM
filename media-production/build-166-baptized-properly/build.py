#!/usr/bin/env python3
"""Assemble Story Video #166 — Baptized again, properly (Acts 19:1-6).
...
shown only as warm light (never a dove, never a figure); Paul and the disciples are the
human actors (gate PASS — no divine proper noun in any shot).

TWO SACRED SILENCES (the music bed dies to true silence for both):
  kv5  Acts 19:5  "...they were baptized in the name of the Lord Jesus." — done properly
  kv6  Acts 19:6  "...the Holy Ghost came on them; and they spake with tongues..." — the gift
A warm bed carries it in, dies before the baptism verse, returns, dies again before
...
Output: acts-19_baptized-again-properly.mp4, 1080x1920 H.264 30fps, <30MB.
"""
...
S1 = "s1-paul-at-ephesus.jpeg"
S2 = "s2-the-question.jpeg"
S3 = "s3-only-johns-baptism.jpeg"
S4 = "s4-paul-teaches.jpeg"
S5 = "s5-baptized-properly.jpeg"
S6 = "s6-hands-laid.jpeg"
S7 = "s7-received.jpeg"
...
BEATS = [
    ...
    ("n3", S3, "in"),
    ("n4", S4, "in"),
    ("kv5", S5, "in"),                       # SACRED SILENCE 1 — baptized in the name of the Lord Jesus (Acts 19:5, named)
    ("n5", S6, "in"),
    ("kv6", S7, "in"),                       # SACRED SILENCE 2 — laid hands, received the Holy Ghost (Acts 19:6)
    ("n6", S7, "out"),
    ("n7", S8, "in"),
]
...
def main():
    ...
    print(f"sacred silence 1 (baptized properly, Acts 19:5): kv5 at {start_of['kv5']:.1f}s",
          flush=True)
    print(f"sacred silence 2 (received the Holy Ghost, Acts 19:6): kv6 at {start_of['kv6']:.1f}s",
          flush=True)
    ...
    p1_end = start_of["kv5"] + spoken["kv5"]
    p2_end = start_of["kv6"] + spoken["kv6"]
    beds = [
        (0.0, start_of["kv5"] - 1.2, "b"),
        (p1_end + 1.0, start_of["kv6"] - 1.0, "a"),
    ...
    OUT = "acts-19_baptized-again-properly.mp4"
    A_KBPS, MUX = 96, 20
