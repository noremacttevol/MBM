...
- Luke 2:42 — "twelve years old" at the Passover temple visit.
- Luke 2:46-47 — sitting among the doctors, hearing and asking questions; all
  astonished at his understanding.
- Luke 2:52 — "increased in wisdom and stature" — a boy still growing.
- Isa 53:2 — "no beauty that we should desire him" — an ordinary boy's face,
  not an idealized cherub.

## Written description
The SAME person as JESUS-MASTER-REF scaled to twelve years old — the sheet
must visibly read as that man as a boy: the same warm tan olive-brown skin,
the same dark brown-black wavy hair (worn to the shoulders even young), the
same kind warm BROWN eyes and facial structure with softer, unfinished boyish
features, no beard. Slender, mid-growth build of a twelve-year-old. Calm,
alert, questioning expression.

## Standard garments
A plain undyed off-white CREAM wool boy's tunic (the cream signature belongs
to him alone even young), simple rope belt, worn leather sandals. Bare-headed,
hair loose. No halo, no glow, ever.

## Generation prompts (Nano Banana 2 · 9:16 · 1x, flow_driver.py)
NOTE: BOTH portrait prompts and the full-body attach
`../../JESUS-MASTER-REF/jesus-face.jpeg` as --ref, so the boy's face derives
from the locked man's face. The three-quarter and full-body ALSO attach this
sheet's own face-front.jpeg once it exists (two refs).
...
[STYLE BLOCK] The attached reference image shows a grown man; paint the SAME
person as a twelve-year-old boy — identical skin tone, identical warm brown
...
### full-body (refs: face-front.jpeg + JESUS-MASTER-REF/jesus-face.jpeg)
[STYLE BLOCK] The SAME twelve-year-old boy as the attached reference images —
