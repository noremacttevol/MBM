...
Output: isaiah-49_graven-on-his-palms.mp4, 1080x1920 H.264 30fps, <30MB.
"""
import os
import subprocess
import textwrap
...
S1 = "s1-the-forgotten-one.jpeg"
S2 = "s2-has-god-forgotten.jpeg"
S3 = "s3-a-mother-and-child.jpeg"
S4 = "s4-even-if-she-could.jpeg"
S5 = "s5-graven-on-the-palms.jpeg"
S6 = "s6-your-walls-before-me.jpeg"
S7 = "s7-the-light-finds-her.jpeg"
S8 = "s8-she-lifts-her-head.jpeg"
S9 = "s9-not-forgotten.jpeg"
S10 = "s10-you-are-kept.jpeg"
...
BEATS = [
    ...
    ("n2", S2, "in"),
    ("n3", S3, "in"),
    ("jv15", S4, "in"),         # can a woman forget... yet will I not forget thee — silence 1
    ("n4", S5, "in"),
    ("jv16", S6, "in"),         # graven upon the palms of my hands — sacred silence 2
    ("n5", S7, "in"),
    ("n6", S8, "in"),
    ("n7", S9, "in"),
    ("n7b", S10, "in"),
...
def main():
    ...
    print(f"sacred silence 1 (yet will I not forget): jv15 at {start_of['jv15']:.1f}s", flush=True)
    print(f"(single sacred silence) at {start_of['jv15']:.1f}s", flush=True)
    ...
    p1_end = start_of["jv15"] + spoken["jv15"]
    p2_end = start_of["jv15"] + spoken["jv15"]
    beds = [
        (0.0, start_of["jv15"] - 1.2, "b"),
        (p1_end + 1.0, start_of["jv15"] - 1.0, "a"),
        (p2_end + 1.0, card_start - 0.8, "a"),
    ]
    print(f"music: bed out at {start_of['jv15'] - 1.2:.1f}s, silent through jv15 "
          f"(ends {p1_end:.1f}s); returns; silent again through jv10 "
    ...
    OUT = "isaiah-49_graven-on-his-palms.mp4"
    A_KBPS = 96
    MUX = 20
