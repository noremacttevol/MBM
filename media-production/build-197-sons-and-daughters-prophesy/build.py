#!/usr/bin/env python3
"""Assemble MEMBER Verse Video #197 — Your Sons and Your Daughters Shall
...
CONTENT-CARE: clean — outpouring and inclusion, no fear. Jesus does not
appear (Joel; Pentecost shown as the crowd). Spirit hinted as light/tongues.

TWO SACRED SILENCES: s1 — Joel 2:28 (pour out my spirit on all flesh, the
centerpiece) and s2 — 2:29 (upon servants and handmaids), scripture voice,
cream italic. The two "everyone" stills carry the two verses; stills matched
to beats semantically, not by numeric order.
...
paths in segs/. Output: joel-2_sons-and-daughters-prophesy.mp4,
...
ST1 = "s1-joel-names-the-future.jpeg"
ST2 = "s2-every-kind-of-person.jpeg"
ST3 = "s3-pentecost.jpeg"
ST4 = "s4-peter-stands.jpeg"
ST5 = "s5-in-every-tongue.jpeg"
ST6 = "s6-all-flesh.jpeg"
...
BEATS = [
    ("n0", ST1, "in"),           # Joel names the future
    ("s1", ST2, "in"),           # SACRED SILENCE 1 — Joel 2:28, every kind of person
    ("s2", ST6, "in"),           # SACRED SILENCE 2 — Joel 2:29, all flesh (servants)
    ("n1", ST3, "in"),           # every kind, same Spirit — Pentecost outpouring
    ("n2", ST4, "in"),           # Peter stands — the promise arrived
    ("n3", ST5, "in"),           # poured out widely — in every tongue
]

LEAD = 0.28
GAP = 0.65
KJV_GAP = 1.60
# The two consecutive KJV verses carry the sacred silence; no extra holds.
HOLD = {}
CARD_HOLD = 5.0
...
def main():
    ...
    print(f"sacred silences: s1 (Joel 2:28) at {start_of['s1']:.1f}s, s2 (2:29) at {start_of['s2']:.1f}s", flush=True)
    ...
    OUT = "joel-2_sons-and-daughters-prophesy.mp4"
    A_KBPS = 96
    MUX = 20
