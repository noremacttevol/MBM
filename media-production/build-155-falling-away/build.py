...
S1 = "s1-paul-writing.jpeg"
S2 = "s2-rumors-and-fear.jpeg"
S3 = "s3-paul-steadies-them.jpeg"
S4 = "s4-anchored.jpeg"
S5 = "s5-the-light-dimming.jpeg"
S6 = "s6-foretold-not-failed.jpeg"
S7 = "s7-night-before-morning.jpeg"
S8 = "s8-the-light-returns.jpeg"
...
BEATS = [
    ...
    ("n2", S2, "in"),
    ("n3", S3, "in"),
    ("kv2", S4, "in"),                       # SACRED SILENCE 1 — be not shaken (2 Thes 2:2)
    ("n4", S4, "out"),
    ("n5", S5, "in"),
    ("n6", S6, "in"),
    ("kv3", S7, "in"),                       # SACRED SILENCE 2 — a falling away first (2 Thes 2:3, named)
    ("n7", S7, "out"),
    ("n8", S8, "in"),
]
...
def main():
    ...
    print(f"sacred silence 1 (be not shaken, 2 Thes 2:2): kv2 at {start_of['kv2']:.1f}s",
          flush=True)
    print(f"sacred silence 2 (a falling away first, 2 Thes 2:3): kv3 at {start_of['kv3']:.1f}s",
          flush=True)
    ...
    p1_end = start_of["kv2"] + spoken["kv2"]
    p2_end = start_of["kv3"] + spoken["kv3"]
    beds = [
        (0.0, start_of["kv2"] - 1.2, "b"),
        (p1_end + 1.0, start_of["kv3"] - 1.0, "a"),
    ...
    OUT = "2thessalonians-2_a-falling-away.mp4"
    A_KBPS, MUX = 96, 20
