#!/usr/bin/env python3
"""Generate #155's 8 stills via flow_driver.py (Nano Banana 2, 9:16, $0).
No Christ/Jesus figure anywhere (apostasy shown only as fading light), NO --ref.
...
FILENAMES = [
    "s1-paul-writing.jpeg", "s2-rumors-and-fear.jpeg", "s3-paul-steadies-them.jpeg",
    "s4-anchored.jpeg", "s5-the-light-dimming.jpeg", "s6-foretold-not-failed.jpeg",
    "s7-night-before-morning.jpeg", "s8-the-light-returns.jpeg",
]
...
print("ALL 155 STILLS GENERATED")
