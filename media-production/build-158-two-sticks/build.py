...
S1 = "s1-word-to-ezekiel.jpeg"
S2 = "s2-stick-for-judah.jpeg"
S3 = "s3-stick-for-joseph.jpeg"
S4 = "s4-join-them.jpeg"
S5 = "s5-two-made-one.jpeg"
S6 = "s6-the-people-ask.jpeg"
S7 = "s7-one-in-Gods-hand.jpeg"
S8 = "s8-take-them-up.jpeg"
...
BEATS = [
    ...
    ("n2", S2, "in"),
    ("n3", S3, "in"),
    ("kv16", S4, "in"),                      # SACRED SILENCE 1 — two sticks, Judah and Joseph (Ezek 37:16)
    ("n4", S4, "out"),
    ("n5", S5, "in"),
    ("n6", S6, "in"),
    ("kv19", S7, "in"),                      # SACRED SILENCE 2 — one in mine hand (Ezek 37:19, named)
    ("n7", S7, "out"),
    ("n8", S8, "in"),
]
...
def main():
    ...
    print(f"sacred silence 1 (two sticks, Ezek 37:16): kv16 at {start_of['kv16']:.1f}s",
          flush=True)
    print(f"sacred silence 2 (one in mine hand, Ezek 37:19): kv19 at {start_of['kv19']:.1f}s",
          flush=True)
    ...
    p1_end = start_of["kv16"] + spoken["kv16"]
    p2_end = start_of["kv19"] + spoken["kv19"]
    beds = [
        (0.0, start_of["kv16"] - 1.2, "b"),
