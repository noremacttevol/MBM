#!/usr/bin/env python3
"""Assemble MEMBER Verse Video #188 — "Be Ye Therefore Perfect"
(Matthew 5:44-48).
...
CONTENT-CARE: clean. FACE LAW v3: Jesus face-shown per the W prompt sheet,
master-locked, only he wears cream.

THREE SACRED SILENCES: j1 — Matt 5:44 (love your enemies), j2 — 5:45 (sun on
the evil and the good), j3 — 5:48 (be ye therefore perfect, the centerpiece).
All Jesus voice, cream italic. n1 gets the draft's extended quiet hold.
...
paths in segs/. Output: matthew-5_be-ye-therefore-perfect.mp4,
...
ST1 = "s1-a-love-never-heard.jpeg"
ST2 = "s2-love-your-enemies.jpeg"
ST3 = "s3-the-mixed-crowd.jpeg"
ST4 = "s4-sun-on-the-just-and-unjust.jpeg"
ST5 = "s5-invitation-not-command.jpeg"
ST6 = "s6-the-teaching-lands.jpeg"
ST7 = "s7-come-and-learn-it.jpeg"

TEXT = {s[0]: s[4] for s in make_narration.SEGMENTS}
KJV = {"j1", "j2", "j3"}

# MEMBER shelf: one-line Gospel Library pointer under the closing invitation.
GL_POINTER = "Learn more — Gospel Library: Perfection"

BEATS = [
    ("n0", ST1, "in"),           # a love they had never heard
    ("j1", ST2, "in"),           # SACRED SILENCE 1 — Matt 5:44
    ("j2", ST3, "in"),           # SACRED SILENCE 2 — Matt 5:45, the mixed crowd
    ("n1", ST4, "in"),           # sun on the just and unjust — extended hold
    ("n2", ST5, "in"),           # the bar no one reaches alone
    ("j3", ST6, "in"),           # SACRED SILENCE 3 — Matt 5:48, the centerpiece
    ("n3", ST7, "in"),           # perfect by the Father's measure
]
...
def main():
    ...
    print(f"sacred silences: j1 at {start_of['j1']:.1f}s, j2 at {start_of['j2']:.1f}s, j3 at {start_of['j3']:.1f}s", flush=True)
    ...
    OUT = "matthew-5_be-ye-therefore-perfect.mp4"
    A_KBPS = 96
    MUX = 20
