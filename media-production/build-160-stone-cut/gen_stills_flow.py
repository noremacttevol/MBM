#!/usr/bin/env python3
"""Generate #160's 8 stills via flow_driver.py (Nano Banana 2, 9:16, $0).
No Christ/Jesus figure anywhere (God's kingdom shown as light), NO --ref.
...
FILENAMES = [
    "s1-daniel-before-the-king.jpeg", "s2-the-great-image.jpeg",
    "s3-the-stone-cut-without-hands.jpeg", "s4-the-stone-strikes.jpeg",
    "s5-the-image-shatters.jpeg", "s6-the-stone-becomes-a-mountain.jpeg",
    "s7-fills-the-whole-earth.jpeg", "s8-a-kingdom-forever.jpeg",
]
...
print("ALL 160 STILLS GENERATED")
