#!/usr/bin/env python3
"""Assemble Story Video #29 — The Pearl of Great Price (Matthew 13:45-46).
...
merchant is a character in the story, shown fully. Face gate trivially safe.
...
Music: a warm detuned-pair bed opens over the seeking and the finding, then
fades to a reverent hush just before j2 ("...went and sold all that he had, and
bought it" — the cost paid in joy); a warm bed returns just after j2 and swells
UNDER the joy and the closing turn (to him, YOU are the pearl), fading out only
before the closing card. No-Dead-Air: the only silences >2.5s are the hush around
j2 and the card's tail.

Output: matthew-13_pearl-of-great-price.mp4 (SCRIPTURE-NAME LAW), 1080x1920 H.264
30fps, <25MB.
"""
import os
import subprocess
...
S1 = "s1-merchant.jpeg"
S2 = "s2-searching.jpeg"
S3 = "s3-the-pearl.jpeg"
S4 = "s4-sells-all.jpeg"
S5 = "s5-buys-it.jpeg"
S6 = "s6-pearl-radiant.jpeg"
...
def main():
    ...
    OUT = "matthew-13_pearl-of-great-price.mp4"
