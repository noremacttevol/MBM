...
S1 = "s1-lacking-wisdom.jpeg"
S2 = "s2-many-voices.jpeg"
S3 = "s3-the-quiet-place.jpeg"
S4 = "s4-kneeling-to-ask.jpeg"
S5 = "s5-given-liberally.jpeg"
S6 = "s6-upbraideth-not.jpeg"
S7 = "s7-ask-in-faith.jpeg"
S8 = "s8-it-shall-be-given.jpeg"
...
BEATS = [
    ...
    ("n2", S2, "in"),
    ("n3", S3, "in"),
    ("kv5", S4, "in"),                       # SACRED SILENCE 1 — the named verse (James 1:5, card)
    ("n4", S4, "out"),
    ("n5", S5, "in"),
    ("n6", S6, "in"),
    ("kv6", S7, "in"),                       # SACRED SILENCE 2 — ask in faith (James 1:6)
    ("n7", S7, "out"),
    ("n8", S8, "in"),
]
...
def main():
    ...
    print(f"sacred silence 1 (the named verse, James 1:5): kv5 at {start_of['kv5']:.1f}s",
          flush=True)
    print(f"sacred silence 2 (ask in faith, James 1:6): kv6 at {start_of['kv6']:.1f}s",
          flush=True)
