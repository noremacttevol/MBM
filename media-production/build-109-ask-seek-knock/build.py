...
Output: matthew-7_ask-seek-knock.mp4, 1080x1920 H.264 30fps, <30MB.
"""
import os
import subprocess
import textwrap
...
S1 = "s1-jesus-teaching.jpeg"
S2 = "s2-ask-seek-knock-said.jpeg"
S3 = "s3-a-child-asks.jpeg"
S4 = "s4-seeking.jpeg"
S5 = "s5-knocking.jpeg"
S6 = "s6-the-door-opens.jpeg"
S7 = "s7-the-father-and-bread.jpeg"
S8 = "s8-how-much-more.jpeg"
...
def main():
    ...
    p2_end = start_of["jv11"] + spoken["jv11"]
    beds = [
        (0.0, start_of["jv7"] - 1.2, "b"),
        (p1_end + 1.0, start_of["jv11"] - 1.0, "a"),
        (p2_end + 1.0, card_start - 0.8, "a"),
    ]
    print(f"music: bed out at {start_of['jv7'] - 1.2:.1f}s, silent through jv7 "
          f"(ends {p1_end:.1f}s); returns; silent again through jv11 "
    ...
    OUT = "matthew-7_ask-seek-knock.mp4"
    A_KBPS = 96
    MUX = 20
