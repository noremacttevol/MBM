#!/usr/bin/env python3
"""Assemble Story Video #60 — The Gerasene Demoniac (Mark 5:1-20).
...
Output: mark-5_gerasene-demoniac.mp4, 1080x1920 H.264 30fps, <25MB.
"""
import os
import subprocess
import textwrap
...
S1 = "s1-far-shore.jpeg"
S2 = "s2-among-the-tombs.jpeg"
S3 = "s3-he-ran.jpeg"
...
CARD_TEXT = ("He crossed a sea in a storm for one man everyone else had "
             "given up on. There is no distance he will not cross for you.")
...
def main():
    ...
    t = 0.0
    audio_place = []
    j1_start = j2_start = j3_start = None
    ...
    print(f"total runtime: {total:.1f}s ({total/60:.2f} min); "
          f"silences at j1 {j1_start:.1f}s / j3 {j3_start:.1f}s; "
    ...
    OUT = "mark-5_gerasene-demoniac.mp4"
    A_KBPS, MUX = 96, 20
