...
Output: exodus-33_face-to-face.mp4, 1080x1920 H.264 30fps, <30MB.
"""
import os
import subprocess
import textwrap
...
S1 = "s1-the-tent-outside-the-camp.jpeg"
S2 = "s2-moses-goes-out.jpeg"
S3 = "s3-the-people-watch.jpeg"
S4 = "s4-the-pillar-descends.jpeg"
S5 = "s5-face-to-face.jpeg"
S6 = "s6-show-me-thy-glory.jpeg"
S7 = "s7-the-cleft-of-the-rock.jpeg"
S8 = "s8-hidden-in-the-rock.jpeg"
S9 = "s9-the-shining-face.jpeg"
...
BEATS = [
    ...
    ("n3", S3, "in"),
    ("n4", S4, "in"),
    ("nface", S5, "in"),        # "face to face, as a friend" (narrator, white)
    ("jv14", S5, "out"),        # "My presence shall go with thee" — sacred silence 1
    ("n5", S6, "in"),
    ("n6", S6, "out"),
    ("jv19", S7, "in"),         # "all my goodness pass before thee"
    ("jv20", S8, "in"),         # "Thou canst not see my face" — sacred silence 2
    ("n7", S9, "in"),
    ("n8", S10, "in"),
]
...
def main():
    ...
    OUT = "exodus-33_face-to-face.mp4"
    A_KBPS = 96
    MUX = 20
