...
Output: matthew-11_john-the-baptists-doubt.mp4, 1080x1920 H.264 30fps, <30MB.
"""
import os
import subprocess
import textwrap
...
S1 = "s1-john-in-prison.jpeg"
S2 = "s2-the-question-sent.jpeg"
S3 = "s3-the-messengers-go.jpeg"
S4 = "s4-they-ask-jesus.jpeg"
S5 = "s5-the-blind-receive-sight.jpeg"
S6 = "s6-the-poor-hear-good-news.jpeg"
S7 = "s7-blessed-is-he.jpeg"
S8 = "s8-jesus-praises-john.jpeg"
S9 = "s9-the-answer-returns.jpeg"
S10 = "s10-do-not-be-offended.jpeg"
...
BEATS = [
    ("n1", S1, "in"),
    ("n2", S2, "in"),
    ("nq", S3, "in"),           # John's question (narrator, white) over the messengers
    ("n3", S4, "in"),           # they ask Jesus; he is not offended
    ("jv4", S5, "in"),          # the answer of evidence — sacred silence 1
    ("n4", S5, "out"),
    ("n5", S6, "in"),           # the poor hear good news
    ("jv6", S7, "in"),          # blessed is he — sacred silence 2
    ("n6", S8, "in"),           # Jesus praises John to the crowd
    ("n7", S9, "in"),           # the answer returns to the cell; John at peace
    ("n7b", S10, "in"),         # do not be offended — the closing invitation
]
...
def main():
    ...
    print(f"sacred silence 1 (the evidence): jv4 at {start_of['jv4']:.1f}s", flush=True)
    print(f"sacred silence 2 (blessed is he): jv6 at {start_of['jv6']:.1f}s", flush=True)
    ...
    p2_end = start_of["jv6"] + spoken["jv6"]
    beds = [
        (0.0, start_of["jv4"] - 1.2, "b"),
        (p1_end + 1.0, start_of["jv6"] - 1.0, "a"),
        (p2_end + 1.0, card_start - 0.8, "a"),
    ]
    print(f"music: bed out at {start_of['jv4'] - 1.2:.1f}s, silent through jv4 "
          f"(ends {p1_end:.1f}s); returns; silent again through jv6 "
    ...
    OUT = "matthew-11_john-the-baptists-doubt.mp4"
    A_KBPS = 96
    MUX = 20
