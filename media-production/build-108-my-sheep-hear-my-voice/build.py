...
Output: john-10_my-sheep-hear-my-voice.mp4, 1080x1920 H.264 30fps, <30MB.
"""
import os
import subprocess
import textwrap
...
S1 = "s1-the-sheepfold-at-dawn.jpeg"
S2 = "s2-the-shepherd-comes.jpeg"
S3 = "s3-he-calls-them-by-name.jpeg"
S4 = "s4-they-follow-him.jpeg"
S5 = "s5-green-pastures.jpeg"
S6 = "s6-the-lamb-carried.jpeg"
S7 = "s7-the-people-who-are-his-sheep.jpeg"
S8 = "s8-in-his-hand.jpeg"
S9 = "s9-leading-home-at-evening.jpeg"
S10 = "s10-the-voice-that-calls-you.jpeg"
...
BEATS = [
    ...
    ("n2", S2, "in"),
    ("n3", S3, "in"),
    ("jv27", S4, "in"),         # my sheep hear my voice... follow me — sacred silence 1
    ("n4", S5, "in"),
    ("n5", S7, "in"),           # the sheep are people
    ("jv28", S8, "in"),         # never perish; none pluck them from my hand — silence 2
    ("n6", S6, "in"),           # held; his grip does not depend on ours (lamb carried)
    ("n7", S9, "in"),           # leads them home at evening
    ("n7b", S10, "in"),
]
...
def main():
    ...
    print(f"sacred silence 1 (hear my voice): jv27 at {start_of['jv27']:.1f}s", flush=True)
    print(f"sacred silence 2 (my hand): jv28 at {start_of['jv28']:.1f}s", flush=True)
    ...
    p2_end = start_of["jv28"] + spoken["jv28"]
    beds = [
        (0.0, start_of["jv27"] - 1.2, "b"),
        (p1_end + 1.0, start_of["jv28"] - 1.0, "a"),
        (p2_end + 1.0, card_start - 0.8, "a"),
    ]
    print(f"music: bed out at {start_of['jv27'] - 1.2:.1f}s, silent through jv27 "
          f"(ends {p1_end:.1f}s); returns; silent again through jv28 "
    ...
    OUT = "john-10_my-sheep-hear-my-voice.mp4"
    A_KBPS = 96
    MUX = 20
