#!/usr/bin/env python3
"""Assemble MEMBER Verse Video #190 — Faith Without Works Is Dead
(James 2:17-26).
...
CONTENT-CARE: Abraham beat carries NO violence — the altar obedience is
reverent, distant, no knife-in-focus. Jesus does not appear (epistle).

ONE SACRED SILENCE: s1 — James 2:17 (faith without works is dead), scripture
voice, cream italic. n2 (Abraham) gets the draft's extended hold. n4 is
recorded in two halves (n4a/n4b) landing on s6 faith-made-visible and s7
live-the-words per the CAPTION LAW.
...
paths in segs/. Output: james-2_faith-without-works.mp4,
...
ST1 = "s1-the-letter-read-aloud.jpeg"
ST2 = "s2-no-clothes-no-food.jpeg"
ST3 = "s3-works-made-visible.jpeg"
ST4 = "s4-abraham-obeys.jpeg"
ST5 = "s5-rahabs-window.jpeg"
ST6 = "s6-faith-made-visible.jpeg"
ST7 = "s7-live-the-words.jpeg"
...
BEATS = [
    ("n0", ST1, "in"),           # the letter read aloud
    ("n1", ST2, "in"),           # no clothes, no food — the sharp question
    ("s1", ST3, "in"),           # SACRED SILENCE — James 2:17
    ("n2", ST4, "in"),           # Abraham obeys — extended quiet hold
    ("n3", ST5, "in"),           # Rahab's window
    ("n4a", ST6, "in"),          # belief that never moves
    ("n4b", ST7, "in"),          # faith and life belong together
]

LEAD = 0.28
GAP = 0.65
KJV_GAP = 1.60
# Per-beat gap overrides: n2 = the draft's sacred-silence beat (Abraham);
# n4b = a longer breath before the card.
...
def main():
    ...
    print(f"sacred silence: s1 (James 2:17) at {start_of['s1']:.1f}s", flush=True)
    ...
    OUT = "james-2_faith-without-works.mp4"
    A_KBPS = 96
    MUX = 20
