#!/usr/bin/env python3
"""Assemble Video #117 — Hosea Buys Her Back (Hosea 1-3).
...
TWO SACRED SILENCES (music bed dies to true silence across both back-to-back God lines):
  jvA   Hosea 2:14      "I will allure her, and bring her into the wilderness..." — tender
  jvB   Hosea 2:19-20   "I will betroth thee unto me for ever..." — the promise
No-Dead-Air is unaffected: the narrator never stops, only the music does.

Output: hosea-1_hosea-buys-her-back.mp4, 1080x1920 H.264 30fps, <30MB.
"""
import os
import subprocess
import textwrap
...
S1 = "s1-the-covenant-begun.jpeg"
S2 = "s2-she-wanders-away.jpeg"
S3 = "s3-gods-word-to-hosea.jpeg"
S4 = "s4-brought-low.jpeg"
S5 = "s5-he-comes-to-find-her.jpeg"
S6 = "s6-the-price-paid.jpeg"
S7 = "s7-he-lifts-her-up.jpeg"
S8 = "s8-the-road-home.jpeg"
S9 = "s9-betrothed-for-ever.jpeg"
S10 = "s10-come-home.jpeg"
...
BEATS = [
    ...
    ("n4", S4, "in"),
    ("n5", S5, "in"),
    ("n6", S6, "in"),           # the price paid — Hosea's own buy-back words (narrator, white)
    ("n7", S7, "in"),
    ("jvA", S8, "in"),          # I will allure her... into the wilderness — sacred silence 1
    ("jvB", S9, "in"),          # I will betroth thee unto me for ever — sacred silence 2
    ("n8", S10, "in"),
]
...
def main():
    ...
    print(f"sacred silence 1 (allure her into the wilderness): jvA at {start_of['jvA']:.1f}s", flush=True)
    print(f"sacred silence 2 (betroth thee for ever): jvB at {start_of['jvB']:.1f}s", flush=True)
    ...
    # The two God-KJV lines jvA and jvB are back-to-back beats; the music bed dies before
    # jvA and stays in true silence across BOTH, returning only after jvB until the card.
    ...
    OUT = "hosea-1_hosea-buys-her-back.mp4"
    A_KBPS = 96
    MUX = 20
