...
Output: genesis-3_where-art-thou.mp4, 1080x1920 H.264 30fps, <30MB.
"""
import os
import subprocess
import textwrap
...
S1 = "s1-the-garden.jpeg"
S2 = "s2-the-choice.jpeg"
S3 = "s3-their-eyes-opened.jpeg"
S4 = "s4-hiding-among-the-trees.jpeg"
S5 = "s5-where-art-thou.jpeg"
S6 = "s6-i-was-afraid.jpeg"
S7 = "s7-the-sorrow-of-it.jpeg"
S8 = "s8-he-clothed-them.jpeg"
S9 = "s9-out-of-the-garden.jpeg"
S10 = "s10-the-God-who-seeks.jpeg"
...
BEATS = [
    ...
    ("n3", S3, "in"),
    ("n4", S4, "in"),
    ("jv9", S5, "in"),          # "Where art thou?" — sacred silence
    ("n5", S6, "in"),
    ("n6", S7, "in"),
    ("n7", S8, "in"),
    ("n8", S9, "in"),
...
def main():
    ...
    print(f"sacred silence (Where art thou): jv9 at {start_of['jv9']:.1f}s", flush=True)
    print(f"(single sacred silence) at {start_of['jv9']:.1f}s", flush=True)
    ...
    OUT = "genesis-3_where-art-thou.mp4"
    A_KBPS = 96
    MUX = 20
