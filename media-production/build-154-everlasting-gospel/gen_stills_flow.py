#!/usr/bin/env python3
"""Generate #154's 8 stills via flow_driver.py (Nano Banana 2, 9:16, $0).
No Christ/Jesus figure anywhere (the angel is a winged messenger; God is light), NO --ref.
...
FILENAMES = [
    "s1-the-world-waiting.jpeg", "s2-the-angel-appears.jpeg", "s3-flying-in-heaven.jpeg",
    "s4-the-everlasting-gospel.jpeg", "s5-to-every-nation.jpeg",
    "s6-fear-God-give-glory.jpeg", "s7-worship-the-creator.jpeg",
    "s8-the-gospel-for-you.jpeg",
]
...
print("ALL 154 STILLS GENERATED")
