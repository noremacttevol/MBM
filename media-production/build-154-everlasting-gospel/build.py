...
S1 = "s1-the-world-waiting.jpeg"
S2 = "s2-the-angel-appears.jpeg"
S3 = "s3-flying-in-heaven.jpeg"
S4 = "s4-the-everlasting-gospel.jpeg"
S5 = "s5-to-every-nation.jpeg"
S6 = "s6-fear-God-give-glory.jpeg"
S7 = "s7-worship-the-creator.jpeg"
S8 = "s8-the-gospel-for-you.jpeg"
...
BEATS = [
    ...
    ("n2", S2, "in"),
    ("n3", S3, "in"),
    ("kv6", S4, "in"),                       # SACRED SILENCE 1 — the everlasting gospel (Rev 14:6, named)
    ("n4", S4, "out"),
    ("n5", S5, "in"),
    ("n6", S6, "in"),
    ("kv7", S7, "in"),                       # SACRED SILENCE 2 — worship the Creator (Rev 14:7)
    ("n7", S7, "out"),
    ("n8", S8, "in"),
]
...
def main():
    ...
    print(f"sacred silence 1 (everlasting gospel, Rev 14:6): kv6 at {start_of['kv6']:.1f}s",
          flush=True)
    print(f"sacred silence 2 (worship the Creator, Rev 14:7): kv7 at {start_of['kv7']:.1f}s",
          flush=True)
    ...
    p1_end = start_of["kv6"] + spoken["kv6"]
    p2_end = start_of["kv7"] + spoken["kv7"]
    beds = [
        (0.0, start_of["kv6"] - 1.2, "b"),
        (p1_end + 1.0, start_of["kv7"] - 1.0, "a"),
    ...
    OUT = "revelation-14_everlasting-gospel.mp4"
    A_KBPS, MUX = 96, 20
