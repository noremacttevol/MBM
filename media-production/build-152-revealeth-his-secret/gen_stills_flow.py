#!/usr/bin/env python3
"""Generate #152's 8 stills via flow_driver.py (Nano Banana 2, 9:16, $0).
No Christ/Jesus figure anywhere (God shown only as light), so NO --ref.
...
FILENAMES = [
    "s1-herdsman-called.jpeg", "s2-the-word-comes.jpeg", "s3-the-secret-revealed.jpeg",
    "s4-servant-entrusted.jpeg", "s5-declaring-at-the-gate.jpeg",
    "s6-the-warned-can-turn.jpeg", "s7-the-lion-hath-roared.jpeg",
    "s8-are-you-listening.jpeg",
]
...
print("ALL 152 STILLS GENERATED")
