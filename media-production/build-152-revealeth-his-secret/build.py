...
S1 = "s1-herdsman-called.jpeg"
S2 = "s2-the-word-comes.jpeg"
S3 = "s3-the-secret-revealed.jpeg"
S4 = "s4-servant-entrusted.jpeg"
S5 = "s5-declaring-at-the-gate.jpeg"
S6 = "s6-the-warned-can-turn.jpeg"
S7 = "s7-the-lion-hath-roared.jpeg"
S8 = "s8-are-you-listening.jpeg"
...
GL_POINTER = "Learn more — Gospel Library: Prophets"

BEATS = [
    ("n1", S1, "in"),
    ("n2", S2, "in"),
    ("n3", S3, "in"),
    ("kv7", S4, "in"),                       # SACRED SILENCE 1 — the named verse (Amos 3:7, card)
    ("n4", S4, "out"),
    ("n5", S5, "in"),
    ("n6", S6, "in"),
    ("kv8", S7, "in"),                       # SACRED SILENCE 2 — the lion hath roared (Amos 3:8)
    ("n7", S7, "out"),
    ("n8", S8, "in"),
]
...
def main():
    ...
    print(f"sacred silence 1 (the named verse, Amos 3:7): kv7 at {start_of['kv7']:.1f}s",
          flush=True)
    print(f"sacred silence 2 (the lion hath roared, Amos 3:8): kv8 at {start_of['kv8']:.1f}s",
          flush=True)
    ...
    p1_end = start_of["kv7"] + spoken["kv7"]
    p2_end = start_of["kv8"] + spoken["kv8"]
    beds = [
        (0.0, start_of["kv7"] - 1.2, "b"),
        (p1_end + 1.0, start_of["kv8"] - 1.0, "a"),
    ...
    OUT = "amos-3_revealeth-his-secret.mp4"
    A_KBPS, MUX = 96, 20
