...
Output: 1samuel-3_the-boy-samuel.mp4, 1080x1920 H.264 30fps, <30MB.
"""
import os
import subprocess
import textwrap
...
S1 = "s1-the-lamp-of-god.jpeg"
S2 = "s2-samuel-asleep.jpeg"
S3 = "s3-a-voice-in-the-night.jpeg"
S4 = "s4-here-am-i.jpeg"
S5 = "s5-lie-down-again.jpeg"
S6 = "s6-eli-understands.jpeg"
S7 = "s7-speak-lord.jpeg"
S8 = "s8-thy-servant-heareth.jpeg"
S9 = "s9-the-lord-speaks.jpeg"
S10 = "s10-samuel-the-prophet.jpeg"
...
BEATS = [
    ...
    ("n5", S5, "in"),
    ("n6", S6, "in"),
    ("jv10", S7, "in"),         # "Samuel, Samuel." — sacred silence
    ("ns", S8, "in"),           # "Speak; for thy servant heareth." (narrator, white)
    ("n7", S9, "in"),           # the LORD speaks over the listening boy
    ("n8", S10, "in"),
]
...
def main():
    ...
    print(f"sacred silence (the call): jv10 at {start_of['jv10']:.1f}s", flush=True)
    print(f"(single sacred silence) at {start_of['jv10']:.1f}s", flush=True)
    ...
    p1_end = start_of["jv10"] + spoken["jv10"]
    p2_end = start_of["jv10"] + spoken["jv10"]
    beds = [
        (0.0, start_of["jv10"] - 1.2, "b"),
        (p1_end + 1.0, start_of["jv10"] - 1.0, "a"),
        (p2_end + 1.0, card_start - 0.8, "a"),
    ]
    print(f"music: bed out at {start_of['jv10'] - 1.2:.1f}s, silent through jv10 "
    ...
    OUT = "1samuel-3_the-boy-samuel.mp4"
    A_KBPS = 96
    MUX = 20
