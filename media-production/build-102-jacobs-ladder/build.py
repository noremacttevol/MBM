...
Output: genesis-28_jacobs-ladder.mp4, 1080x1920 H.264 30fps, <30MB.
"""
import os
import subprocess
import textwrap
...
S1 = "s1-the-lonely-road.jpeg"
S2 = "s2-a-stone-for-a-pillow.jpeg"
S3 = "s3-the-ladder-set-up.jpeg"
S4 = "s4-angels-ascending.jpeg"
S5 = "s5-the-voice-from-the-light.jpeg"
S6 = "s6-the-light-over-the-sleeper.jpeg"
S7 = "s7-surely-the-lord-is-here.jpeg"
S8 = "s8-the-pillar-set-up.jpeg"
S9 = "s9-oil-on-the-pillar.jpeg"
S10 = "s10-on-his-way.jpeg"
...
BEATS = [
    ...
    ("n3", S3, "in"),
    ("n4", S4, "in"),
    ("jv13", S5, "in"),         # the covenant from the light — sacred silence 1
    ("n5", S5, "out"),
    ("jv15", S6, "in"),         # I am with thee — THE promise — sacred silence 2
    ("n6", S6, "out"),
    ("n7", S7, "in"),
    ("n8", S8, "in"),
    ("n8b", S9, "in"),
...
def main():
    ...
    print(f"sacred silence 1 (the covenant): jv13 at {start_of['jv13']:.1f}s", flush=True)
    print(f"sacred silence 2 (I am with thee): jv15 at {start_of['jv15']:.1f}s", flush=True)
    ...
    print(f"music: bed out at {start_of['jv13'] - 1.2:.1f}s, silent through jv13 "
          f"(ends {p1_end:.1f}s); returns; silent again through jv15 "
    ...
    OUT = "genesis-28_jacobs-ladder.mp4"
    A_KBPS = 96
    MUX = 20
