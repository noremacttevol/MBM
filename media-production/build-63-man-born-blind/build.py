#!/usr/bin/env python3
"""Assemble Story Video #63 — The Man Born Blind (John 9).
...
Output: john-9_man-born-blind.mp4, 1080x1920 H.264 30fps, <25MB.
"""
import os
import subprocess
import textwrap
...
S1 = "s1-whose-fault.jpeg"
S2 = "s2-works-made-manifest.jpeg"
S3 = "s3-the-clay.jpeg"
S4 = "s4-the-walk.jpeg"
S5 = "s5-siloam.jpeg"
S7 = "s7-the-interrogation.jpeg"
S8 = "s8-cast-out.jpeg"
S9 = "s9-found.jpeg"
S10 = "s10-lord-i-believe.jpeg"
# s6-first-sight.jpeg is banked in assets but not cut in (s5 carries the beat).

TEXT = {s[0]: s[4] for s in make_narration.SEGMENTS}
KJV = {"j1", "j2", "j3", "j4"}
CARD_TEXT = ("You may never get the why for what you carry. But when the "
...
def main():
    ...
    print(f"total runtime: {total:.1f}s ({total/60:.2f} min); "
          f"first silence at j1 {j1_start:.1f}s; "
