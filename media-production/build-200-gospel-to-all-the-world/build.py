#!/usr/bin/env python3
"""Assemble MEMBER Verse Video #200 — This Gospel Shall Be Preached in All
the World (Matthew 24:14). THE FINALE OF THE 200.
...
CONTENT-CARE: clean — hope and commission, no fear (the "wars and rumors"
beat is told steady, not alarming). FACE LAW v3: Jesus face-shown per the W
prompt sheet, master-locked, only he wears cream.

ONE SACRED SILENCE: j1 — Matthew 24:14 (this gospel preached in all the
world, the centerpiece and the last KJV line of all 200), Jesus voice, cream
italic. n1b (the message to every corner) gets the draft's extended hold.
n0/n1/n2 recorded in halves so the eight beats fill the eight stills.
...
paths in segs/. Output: matthew-24_gospel-to-all-the-world.mp4,
...
ST1 = "s1-on-the-mount-of-olives.jpeg"
ST2 = "s2-tender-and-sure.jpeg"
ST3 = "s3-steady-hope.jpeg"
ST4 = "s4-the-listeners.jpeg"
ST5 = "s5-the-word-goes-walking.jpeg"
ST6 = "s6-every-corner.jpeg"
...
GL_POINTER = "Learn more — Gospel Library: Missionary Work"

BEATS = [
    ("n0a", ST1, "in"),          # on the Mount of Olives
    ("n0b", ST2, "in"),          # the hard road, told tender and sure
    ("n1a", ST3, "in"),          # the one thing that outlasts — steady hope
    ("n1b", ST4, "in"),          # a message to every corner — the listeners; extended hold
    ("n2a", ST5, "in"),          # not a secret — the word goes walking
    ("n2b", ST6, "in"),          # a witness to all nations — every corner
    ("j1", ST7, "in"),           # SACRED SILENCE — Matt 24:14, seeing the whole world
    ("n3", ST8, "in"),           # the task we still carry — for all nations
]

LEAD = 0.28
GAP = 0.65
KJV_GAP = 1.60
# Per-beat gap override: n1b = the draft's sacred-silence beat before the
# witness-to-all-nations lines.
HOLD = {"n1b": 1.60}
CARD_HOLD = 5.0
...
def main():
    ...
    print(f"sacred silence: j1 (Matt 24:14) at {start_of['j1']:.1f}s", flush=True)
    ...
    OUT = "matthew-24_gospel-to-all-the-world.mp4"
    A_KBPS = 96
    MUX = 20
