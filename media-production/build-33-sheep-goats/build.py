#!/usr/bin/env python3
"""Assemble Story Video #33 — The Sheep and the Goats (Matthew 25:31-46).
...
clips. NO Jesus figure on screen — the King (Jesus) is voice + KJV only; the art
shows a shepherd dividing his flock (from behind / distance) and the acts of
mercy. Face gate trivially safe.
...
Music: a warm detuned-pair bed opens over the separation, the welcome (j1), and
the acts of mercy, then fades to a reverent hush around j2 ("...Inasmuch as ye
have done it unto one of the least of these my brethren, ye have done it unto me"
— the reveal); a warm bed returns just after j2 and swells UNDER the close (he
was in them; he hides in the overlooked), fading out only before the closing
card. No-Dead-Air: the only silences >2.5s are the hush around j2 and the card's
tail.

Output: matthew-25_sheep-and-goats.mp4 (SCRIPTURE-NAME LAW), 1080x1920 H.264
30fps, <25MB.
"""
import os
import subprocess
...
S1 = "s1-separate.jpeg"
S2 = "s2-hungry-fed.jpeg"
S3 = "s3-stranger-drink.jpeg"
S4 = "s4-clothed-sick.jpeg"
S5 = "s5-prison-visit.jpeg"
S6 = "s6-least.jpeg"
S7 = "s7-hands-close.jpeg"
...
KJV = {"j1", "j2"}   # Matthew 25:34-36 (j1), 25:40 (j2) — Jesus voice
PEAK = {"j2"}        # "...ye have done it unto me" — hush lands here
...
def main():
    ...
    OUT = "matthew-25_sheep-and-goats.mp4"
