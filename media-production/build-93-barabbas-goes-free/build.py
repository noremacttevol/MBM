...
BEATS = [
    ("n0", ST1, "in"),           # two men before the crowd
    ("n1a", ST2, "in"),          # Pilate saw Jesus was innocent — he weighs it
    ("n1b", ST3, "in"),          # surely they'd pick the innocent — extended hold
    ("n2", ST4, "in"),           # the crowd shouts for Barabbas
    ("n3", ST5, "in"),           # the guilty freed — chains struck off
    ("n4", ST6, "in"),           # someone took his sentence — walking away free
    ("n5", ST7, "in"),           # the whole gospel in one swap — the empty shackles
]
