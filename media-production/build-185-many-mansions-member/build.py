#!/usr/bin/env python3
"""Assemble MEMBER Verse Video #185 — In My Father's House Are Many
...
FACE LAW v3: Jesus appears per the W prompt sheet (master-ref look). QC
confirms one Jesus, cream robe on him alone, consistent look across stills.

TWO SACRED SILENCES: j1 — John 14:2 (many mansions) and j2 — John 14:3
(I will come again), both exact KJV in the Jesus voice, cream italic.
n3 is recorded in two halves (n3a/n3b) so each sentence lands on its own
still (s6 reassured, s7 dawn-at-the-window) per the CAPTION LAW.
...
paths in segs/. Output: john-14_in-my-fathers-house.mp4,
...
ST1 = "s1-the-last-night-together.jpeg"
ST2 = "s2-let-not-your-heart.jpeg"
ST3 = "s3-the-promise-lands.jpeg"
ST4 = "s4-many-rooms-of-light.jpeg"
ST5 = "s5-i-will-come-again.jpeg"
ST6 = "s6-reassured.jpeg"
ST7 = "s7-dawn-at-the-window.jpeg"
...
BEATS = [
    ("n0", ST1, "in"),           # the last night together
    ("n1", ST2, "in"),           # let not your heart be troubled
    ("j1", ST3, "in"),           # SACRED SILENCE 1 — John 14:2, the promise lands
    ("n2", ST4, "in"),           # many rooms of light — extended quiet hold
    ("j2", ST5, "in"),           # SACRED SILENCE 2 — John 14:3, I will come again
    ("n3a", ST6, "in"),          # not a far-off maybe — reassured
    ("n3b", ST7, "in"),          # carry them home — dawn at the window
]

LEAD = 0.28
GAP = 0.65
KJV_GAP = 1.60
# Per-beat gap override: n2 = the draft's sacred-silence beat before John 14:3
...
def main():
    ...
    print(f"sacred silences: j1 (John 14:2) at {start_of['j1']:.1f}s, j2 (14:3) at {start_of['j2']:.1f}s", flush=True)
    ...
    OUT = "john-14_in-my-fathers-house.mp4"
    A_KBPS = 96
    MUX = 20
