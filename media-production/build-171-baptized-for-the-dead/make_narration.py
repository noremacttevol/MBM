...
SEGMENTS = [
    ("n0", NARRATOR, 'Some in Corinth were arguing as though resurrection might not be real. Paul pointed to a practice already familiar to them and pressed the contradiction.'),
    ...
    ("n4a", NARRATOR, "That is Paul's foundation — not a metaphor or a wish."),
...
SPOKEN = {"lives": "livz"}  # forces verb /lɪvz/ if the card is ever re-rendered
