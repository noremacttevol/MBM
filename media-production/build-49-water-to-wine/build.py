#!/usr/bin/env python3
"""Assemble Story Video #49 — Water to Wine at Cana (John 2:1-11).
...
still, locked to JESUS-MASTER-REF/jesus-face.jpeg. He appears in s2, s4, s5, s8, s9,
s12. Only he wears cream. build.py only reads the finished jpegs.
...
TWO SACRED SILENCES (the music bed dies to true silence for both):
  jv7   John 2:7   "Fill the waterpots with water."      — the quiet command
  jv8   John 2:8   "Draw out now..."                      — the quiet miracle
jv4 (John 2:4, "Woman, what have I to do with thee?...") is a cream-italic KJV caption
in Jesus's voice, carried over the warm bed (not one of the two silences).
...
Output: john-2_water-to-wine.mp4 (SCRIPTURE-NAME LAW), 1080x1920 H.264 30fps, <30MB.
"""
import os
import subprocess
import textwrap
...
S1 = "s1-the-wedding-feast.jpeg"
S2 = "s2-the-guest.jpeg"
S3 = "s3-the-wine-runs-out.jpeg"
S4 = "s4-they-have-no-wine.jpeg"
S5 = "s5-mine-hour.jpeg"
S6 = "s6-do-whatever-he-says.jpeg"
S7 = "s7-the-six-waterpots.jpeg"
S8 = "s8-fill-them-with-water.jpeg"
S9 = "s9-draw-out-now.jpeg"
S10 = "s10-the-good-wine.jpeg"
S11 = "s11-the-feast-restored.jpeg"
S12 = "s12-they-believed.jpeg"
...
BEATS = [
    ...
    ("n3", S3, "in"),
    ("n4", S4, "in"),
    ("jv4", S5, "in"),                          # "Woman... mine hour is not yet come"
    ("n5", S5, "out"),
    ("n6", S6, "in"),
    ("n7", S7, "in"),
    ("jv7", S8, "in"),                          # FILL THE WATERPOTS — sacred silence 1
    ("n8", S8, "out"),
    ("jv8", S9, "in"),                          # DRAW OUT NOW — sacred silence 2
    ("n9", S9, "out"),
    ("n10", S10, "in"),
    ("n11", S11, "in"),
    ("n12", S12, "in"),
...
def main():
    ...
    print(f"sacred silence 1 (fill): jv7 at {start_of['jv7']:.1f}s", flush=True)
    print(f"sacred silence 2 (draw): jv8 at {start_of['jv8']:.1f}s", flush=True)
    ...
    print(f"music: bed out at {start_of['jv7'] - 1.2:.1f}s, silent through jv7 "
          f"(ends {p1_end:.1f}s); returns; silent again through jv8 "
