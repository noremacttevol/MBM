...
Phase-1 STILLS-ONLY (Law E) + the Face Law / #18. Nano Banana 2, x2, tall
vertical 9:16. Every picture is ONE single continuous painting (never panels /
comic strip). The traveller is the risen Lord, but the two disciples do NOT
recognize him — so he is staged ONLY from behind / over-the-shoulder / by his
hands, warm olive-brown skin, dark hair to his shoulders, an undyed cream wool
robe; his face is never shown, no glow or halo. Run the gate before generating:
`python jesus_face_gate.py --dir build-18-emmaus`.
...
brushstroke textures, warm golden late-afternoon light deepening toward
evening, earth-toned palette of first-century Judea. Sacred, tender tone. Not
photorealistic. No text or captions in the image. Historically modest rough-
woven wool and linen robes in undyed earth colors. No modern objects. ONE
SINGLE CONTINUOUS SCENE painted edge to edge as one unbroken composition
filling the entire tall vertical frame — NOT divided into panels, NOT a comic
strip, just one single picture."

CHARACTER LOCKS:
- CLEOPAS — a man in his fifties, grey-streaked dark beard, a brown wool robe,
  weary and grieving.
- THE YOUNGER DISCIPLE — a man in his thirties, dark hair and beard, a muted
  olive-green robe.
- THE TRAVELLER (the risen Lord) — warm olive-brown skin, dark hair to his
  shoulders, an undyed cream wool robe; shown ONLY from behind / over-the-
  shoulder / hands, face never shown, no glow. (Never name a face feature;
  hands may show.)
- Setting: the dusty road from Jerusalem to Emmaus, low golden hills, olive
  trees; then a small stone house with a lamplit table.
...
to his shoulders — all three seen only from the back, the traveller's face
turned away and never shown, no glow around his head, his skin warm olive-brown
never white. The two disciples turn their heads toward him as he walks with
them. Dust and long golden shadows on the road. Two arms, two hands, two legs
...
disciples reach toward him — Cleopas's hand on the traveller's arm, the younger
man gesturing toward the village — pleading with him to stay as the day ends.
Long sunset shadows. Every figure has exactly two arms, two hands, two legs.
...
## QC after every render (before banking)
- Face Law / #18: the traveller only ever back / over-shoulder / hands; a REAL
  man (dark hair, warm olive-brown skin), never a face, never white, never a
  hooded void; no glow (Correction #12).
- One single continuous scene — reject any 3-panel / comic-strip tile.
- Limb counts correct; two disciples consistent (Cleopas brown/grey beard,
  younger man olive-green).
- 1K download, bank to assets/ as s1..s8.
