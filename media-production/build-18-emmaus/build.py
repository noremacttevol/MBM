...
recognize him until the breaking of bread, then he vanishes). Music goes fully
silent for the sacred seal.
...
Output: luke-24_emmaus.mp4, 1080x1920 H.264 30fps, <25MB.
"""
import os
import shutil
import subprocess
