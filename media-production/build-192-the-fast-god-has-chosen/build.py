#!/usr/bin/env python3
"""Assemble MEMBER Verse Video #192 — The Fast God Has Chosen
(Isaiah 58:6-11).
...
CONTENT-CARE: compassion without misery-porn framing — the oppressed and
poor kept dignified. Jesus does not appear (Old Testament prophet).

TWO SACRED SILENCES: s1 — Isaiah 58:6 (break every yoke) and s2 — 58:8
(light break forth as the morning), scripture voice, cream italic. n1b
(into your home) gets the draft's extended hold. n1 is recorded in two
halves (n1a/n1b) landing on s3 bread-shared and s4 the-open-door per the
CAPTION LAW.
...
paths in segs/. Output: isaiah-58_the-fast-god-has-chosen.mp4,
...
ST1 = "s1-loosing-the-ropes.jpeg"
ST2 = "s2-the-yoke-set-down.jpeg"
ST3 = "s3-bread-shared.jpeg"
ST4 = "s4-the-open-door.jpeg"
ST5 = "s5-covered.jpeg"
ST6 = "s6-light-breaks-like-dawn.jpeg"
ST7 = "s7-open-yours.jpeg"

TEXT = {s[0]: s[4] for s in make_narration.SEGMENTS}
KJV = {"s1", "s2"}

# MEMBER shelf: one-line Gospel Library pointer under the closing invitation.
GL_POINTER = "Learn more — Gospel Library: Fasting"

BEATS = [
    ("n0", ST1, "in"),           # loosing the ropes — the fast God wants
    ("s1", ST2, "in"),           # SACRED SILENCE 1 — Isa 58:6, the yoke set down
    ("n1a", ST3, "in"),          # share your bread
    ("n1b", ST4, "in"),          # into your home — extended quiet hold
    ("n2", ST5, "in"),           # cover them
    ("s2", ST6, "in"),           # SACRED SILENCE 2 — Isa 58:8, light like dawn
    ("n3", ST7, "in"),           # call, and He answers — open yours
]

LEAD = 0.28
GAP = 0.65
KJV_GAP = 1.60
# Per-beat gap overrides: n1b = the draft's sacred-silence beat; n3 = a
# longer breath before the card.
HOLD = {"n1b": 1.60, "n3": 1.90}
CARD_HOLD = 5.0
...
def main():
    ...
    print(f"sacred silences: s1 (Isa 58:6) at {start_of['s1']:.1f}s, s2 (58:8) at {start_of['s2']:.1f}s", flush=True)
    ...
    OUT = "isaiah-58_the-fast-god-has-chosen.mp4"
    A_KBPS = 96
    MUX = 20
