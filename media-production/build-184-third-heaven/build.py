#!/usr/bin/env python3
"""Assemble MEMBER Verse Video #184 — Caught Up to the Third Heaven
(2 Cor 12:2-4, 9).
...
CONTENT-CARE: awe, never fear. No divine figure — the heavens are layered
light only.

THREE SACRED SILENCES: s1 — 2 Cor 12:2 (caught up to the third heaven);
s2 — 2 Cor 12:4 (caught up into paradise); j1 — 2 Cor 12:9, the Lord's own
answer to Paul (my grace is sufficient), Jesus voice. All cream italic.
...
paths in segs/. Output: 2corinthians-12_caught-up-to-the-third-heaven.mp4,
...
ST1 = "s1-the-quiet-room.jpeg"
ST2 = "s2-caught-up.jpeg"
ST3 = "s3-the-third-heaven.jpeg"
ST4 = "s4-paradise.jpeg"
ST5 = "s5-the-letter.jpeg"
ST6 = "s6-peace-not-pride.jpeg"
...
BEATS = [
    ("n0", ST1, "in"),           # Paul writing of the man caught up
    ("s1", ST2, "in"),           # SACRED SILENCE 1 — 2 Cor 12:2, caught up
    ("n1", ST3, "in"),           # the third heaven — carried further still
    ("s2", ST4, "in"),           # SACRED SILENCE 2 — 2 Cor 12:4, paradise
    ("n2", ST5, "in"),           # he could have boasted — the letter
    ("j1", ST6, "in"),           # SACRED SILENCE 3 — 2 Cor 12:9, the Lord's answer
    ("n3", ST7, "in"),           # still pointed back to grace
]

LEAD = 0.28
GAP = 0.65
KJV_GAP = 1.60
# No extra per-beat holds — the three KJV beats carry the sacred silences.
HOLD = {}
CARD_HOLD = 5.0
...
def main():
    ...
    print(f"sacred silences: s1 at {start_of['s1']:.1f}s, s2 at {start_of['s2']:.1f}s, j1 at {start_of['j1']:.1f}s", flush=True)
    ...
    OUT = "2corinthians-12_caught-up-to-the-third-heaven.mp4"
    A_KBPS = 96
    MUX = 20
