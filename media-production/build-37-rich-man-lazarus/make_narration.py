...
SEGMENTS = [
    ...
    ("n13", NARRATOR, "Because there is still a gate in front of you today. There is still someone you walk past. And there is still time to stop, and see them, and turn — while the day is yours."),
