#!/usr/bin/env python3
"""Assemble Story Video #46 — The Seed Growing Secretly (Mark 4:26-29).

PHASE-1 STILLS-ONLY (Law E): 11 painted stills, Ken Burns drift, narration, serif
...
generated in audio/ (make_narration.SEGMENTS). CAPTIONS ARE VERBATIM. KJV (Jesus) lines
render cream italic. Face-never: Jesus appears only in s1 and s11, from directly behind.

GREEN / plain milk — the most restful parable in the set. The two SACRED SILENCES (music
bed dies to true silence) land on the mystery and the payoff:
  jv27  Mark 4:27   he sleeps and rises; it grows "he knoweth not how" (the comfort)
  jv29  Mark 4:29   the harvest is come (the promise kept)
...
S2 = "s2-casting-seed.jpeg"
S3 = "s3-he-sleeps.jpeg"
S4 = "s4-ordinary-days.jpeg"
S5 = "s5-he-knows-not-how.jpeg"
S6 = "s6-the-blade.jpeg"
S7 = "s7-the-ear.jpeg"
S8 = "s8-the-full-corn.jpeg"
S9 = "s9-the-harvest.jpeg"
S10 = "s10-the-rest.jpeg"
S11 = "s11-the-invitation.jpeg"

TEXT = {s[0]: s[4] for s in make_narration.SEGMENTS}
KJV = {"jv26", "jv27", "jv28", "jv29"}

BEATS = [
    ("n1", S1, "in"),
    ("jv26", S2, "in"), ("n2", S2, "out"),
    ("jv27", S3, "in"), ("n3", S3, "out"),        # SACRED SILENCE 1 — he knoweth not how
    ("n4", S4, "in"),
    ("n5", S5, "in"),
    ("jv28", S6, "in"), ("n6", S6, "out"),
    ("n7", S7, "in"),
    ("n8", S8, "in"),
    ("jv29", S9, "in"), ("n9", S9, "out"),         # SACRED SILENCE 2 — the harvest is come
    ("n10", S10, "in"),
    ("n11", S11, "in"),
]
...
def main():
    ...
    print(f"sacred silence 1 (he knoweth not how): jv27 at {start_of['jv27']:.1f}s", flush=True)
    print(f"sacred silence 2 (the harvest is come): jv29 at {start_of['jv29']:.1f}s", flush=True)
    ...
    p1_end = start_of["jv27"] + spoken["jv27"]
    p2_end = start_of["jv29"] + spoken["jv29"]
    beds = [
        (0.0, start_of["jv27"] - 1.2, "b"),
        (p1_end + 1.0, start_of["jv29"] - 1.0, "a"),
