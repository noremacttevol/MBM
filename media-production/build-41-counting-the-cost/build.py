...
KJV = {"j1", "j2", "j3", "j5", "j6", "j7", "j8"}

BEATS = [
    ("n1", S1, "in"),
    ("n2", S2, "in"), ("j1", S2, "out"),        # SACRED SILENCE 1 — the hard saying
    ("n3", S3, "in"),
    ("n4", S4, "in"),
    ("j2", S5, "in"), ("n5", S5, "out"),
    ("j3", S6, "in"), ("n6", S6, "out"),
    ...
    ("j5", S8, "in"), ("n8", S8, "out"),
    ("j6", S9, "in"), ("n9", S9, "out"),
    ("j7", S10, "in"), ("n10", S10, "out"),      # SACRED SILENCE 2 — THE VERDICT
    ("n11", S11, "in"),
    ("j8", S12, "in"), ("n12", S12, "out"),
    ("n13a", S13, "in"), ("n13b", S13, "out"),
    ("n14", S14, "in"),
    ("n15", S15, "in"),
    ("n16", S16, "in"),
]
