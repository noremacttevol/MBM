...
SEGMENTS = [
    ...
    ("n2", NARRATOR, "Everyone on that hillside knew that old arithmetic. Love the people who love you. Keep your guard up against the ones who don't. It felt fair. It felt safe. And then Jesus said this."),
    # Matthew 5:44
