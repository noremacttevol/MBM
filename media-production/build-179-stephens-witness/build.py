#!/usr/bin/env python3
"""Assemble MEMBER Verse Video #179 — Stephen's Witness (Acts 7:55-60).
...
CONTENT-CARE — MARTYRDOM (R): the stoning is told with reverent distance —
no gore, no wounds, no stone striking flesh in frame; the focus is Stephen's
heavenly vision and peace. Mercy is spoken aloud (n4a: he forgave his killers).
The closing card is peace, never a fear-question. FACE LAW v3: Jesus is shown
standing at the right hand (master-locked, only he wears cream); his face is
now SHOWN per v3 — audit that it matches the master ref.

ONE SACRED SILENCE: s1 — Acts 7:56 (Behold, I see the heavens opened, the
centerpiece), scripture voice, cream italic, on the "i see him" still. n3/n4
recorded in halves; s4 tender-receiving (a near-duplicate of s8) is left
unused rather than padding. Stills matched to beats semantically.
...
paths in segs/. Output: acts-7_stephens-witness.mp4,
...
ST1 = "s1-before-the-council.jpeg"
ST2 = "s2-he-looked-up.jpeg"
ST3 = "s3-the-standing-witness.jpeg"
ST5 = "s5-i-see-him.jpeg"
ST6 = "s6-outside-the-walls.jpeg"
ST7 = "s7-the-face-of-an-angel.jpeg"
ST8 = "s8-received-into-glory.jpeg"
ST9 = "s9-peace-not-horror.jpeg"

TEXT = {s[0]: s[4] for s in make_narration.SEGMENTS}
KJV = {"s1"}

# MEMBER shelf: one-line Gospel Library pointer under the closing invitation.
GL_POINTER = "Learn more — Gospel Library: Testimony"

BEATS = [
    ("n0", ST1, "in"),           # dragged before the council
    ("n1", ST2, "in"),           # he looked up
    ("n2", ST3, "in"),           # Jesus standing at the right hand — the witness
    ("s1", ST5, "in"),           # SACRED SILENCE — Acts 7:56, "I see him"
    ("n3a", ST6, "in"),          # they rushed him out — outside the walls
    ("n3b", ST7, "in"),          # the face of an angel, at peace
    ("n4a", ST9, "in"),          # mercy for the stone-throwers — peace not horror
    ("n4b", ST8, "in"),          # he fell asleep — received into glory
]

LEAD = 0.28
GAP = 0.65
KJV_GAP = 1.60
# Per-beat gap override: n2 = the draft's sacred-silence beat before the verse.
HOLD = {"n2": 1.60}
CARD_HOLD = 5.0
...
def main():
    ...
    print(f"sacred silence: s1 (Acts 7:56) at {start_of['s1']:.1f}s", flush=True)
    ...
    OUT = "acts-7_stephens-witness.mp4"
    A_KBPS = 96
    MUX = 20
