...
if os.path.exists("/usr/share/fonts/truetype/dejavu/DejaVuSerif.ttf"):
...
CARD = "card"
# PEAK: the beat the music bed dies for. j2 is the midnight cry, the first
# red-letter line in the parable.
PEAK = "j2"
...
def main():
    ...
    # gentle drones; go SILENT under the verse itself (the sacred seal)
