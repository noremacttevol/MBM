...
S1 = "s1-in-the-temple.jpeg"
S2 = "s2-the-kings-feast.jpeg"
S3 = "s3-the-summons.jpeg"
S4 = "s4-they-would-not-come.jpeg"
S5 = "s5-made-light-of-it.jpeg"
S6 = "s6-the-city-far-off.jpeg"
S7 = "s7-go-to-the-highways.jpeg"
S8 = "s8-out-on-the-roads.jpeg"
S9 = "s9-clothed-at-the-door.jpeg"
S10 = "s10-the-king-sees-him.jpeg"
S11 = "s11-friend.jpeg"
S12 = "s12-outer-darkness.jpeg"
S13 = "s13-many-are-called.jpeg"
S14 = "s14-the-door-is-open.jpeg"

# Caption text = verbatim spoken text, keyed by segment name.
TEXT = {s[0]: s[4] for s in make_narration.SEGMENTS}
KJV = {"jv4", "jv8_9", "jv12", "jv13", "jv14"}
...
BEATS = [
    ...
    ("n5", S5, "in"),
    ("n6", S6, "in"),
    ("n7", S7, "in"), ("jv8_9", S7, "out"),   # THE GRACE PIVOT — lands in full silence
    ("n8", S8, "in"),
    ("n9", S9, "in"), ("n10", S9, "out"),
    ("n11", S10, "in"),
    ("jv12", S11, "in"),                        # "FRIEND" — also in full silence
    ("n12", S11, "out"),
    ("n13", S12, "in"), ("jv13", S12, "out"),  # outer darkness — restrained, UNDER the bed
    ("n14", S13, "in"), ("jv14", S13, "out"), ("n15", S13, "in"),
    ("n16", S14, "in"),
]
...
def main():
    ...
    print(f"sacred silence 1 (grace pivot): jv8_9 at {start_of['jv8_9']:.1f}s", flush=True)
    print(f"sacred silence 2 (\"Friend\"):    jv12 at {start_of['jv12']:.1f}s", flush=True)
    ...
    p1_end = start_of["jv8_9"] + spoken["jv8_9"]
    p2_end = start_of["jv12"] + spoken["jv12"]
    beds = [
        # carries the story in; out before the grace pivot
        (0.0, start_of["jv8_9"] - 1.2, "b"),
        # returns to carry the gathering off the roads; dies before "Friend"
        (p1_end + 1.0, start_of["jv12"] - 1.0, "a"),
        # returns to carry the outer-darkness resolution, the frame and the
        # invitation; gone before the closing card. jv13 plays UNDER this soft bed
        # on purpose — the J-law forbids a reverent spotlight on the judgment.
        (p2_end + 1.0, card_start - 0.8, "a"),
    ]
    print(f"music: bed out at {start_of['jv8_9'] - 1.2:.1f}s, silent through jv8_9 "
          f"(ends {p1_end:.1f}s); returns under n8; silent again through jv12 "
    ...
    OUT = "matthew-22_wedding-garment.mp4"
