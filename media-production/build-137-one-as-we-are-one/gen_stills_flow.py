#!/usr/bin/env python3
"""Build full Flow prompts for #137 (One, as we are one) from PROMPTS.md and generate
...
STYLE = 'Beautiful hand-painted 2D animation style, reverent and warm, like a classic illustrated storybook of scripture brought to life. Soft painterly brushstroke textures, deep blue night tones with warm lamp-gold highlights. First-century Jerusalem at night. Sacred, hushed tone. Not photorealistic. No text or captions in the image. Historically modest clothing: rough-woven wool and linen in undyed earth colors. No modern objects.'
