#!/usr/bin/env python3
"""Assemble Story Video #137 — "One, as we are one" (John 17:20-23).

PHASE-1 STILLS-ONLY (Law E): six painted stills, Ken Burns drift, narration,
...
The swapped story (2026-07-20 repeat purge): Jesus prays his followers become
one THE SAME WAY he and the Father are one — perfect unity, distinct persons,
no church named. TIME-OF-DAY LAW: night video (caption box 0.5).

TWO SACRED SILENCES: j1 (John 17:20-21) and j2 (John 17:22-23a), Jesus voice,
cream italic. The Father is addressed, not seen — no divine figure depicted.

CHARACTER-LAW: Jesus per JESUS-MASTER-REF only (behind/over-shoulder angles);
disciples distant and non-individual (Peter/John/James sheets pending —
CHARACTERS/WANTED.md).

NO MUSIC BED of any kind (HUM PURGE law 2026-07-16): narration + silence only.
Output: john-17_one-as-we-are-one.mp4, 1080x1920 H.264 30fps, <30MB.
"""
import os
import shutil
import subprocess
...
ST1 = "s1-the-night-path.jpeg"
ST2 = "s2-he-stopped-to-pray.jpeg"
ST3 = "s3-the-listening-sky.jpeg"
ST4 = "s4-two-flames.jpeg"
ST5 = "s5-hands-open.jpeg"
ST6 = "s6-one-light.jpeg"
...
def main():
    ...
    print(f"sacred silences: j1 (John 17:20-21) at {start_of['j1']:.1f}s, "
          f"j2 (John 17:22-23a) at {start_of['j2']:.1f}s", flush=True)
    ...
    OUT = "john-17_one-as-we-are-one.mp4"
    A_KBPS = 96
    MUX = 20
