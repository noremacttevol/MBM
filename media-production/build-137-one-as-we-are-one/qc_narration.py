...
EQUIV = {
    # 2026-07-17 (#186): true homophones whisper spells differently — the
    # audio is correct ("heir" IS pronounced "air"; "Son" and "sun" are
    # identical sounds). Same class as knight/night below.
    "air": "heir", "airs": "heirs", "wares": "heirs", "sun": "son",
    "knight": "night",
...
def main():
    ...
    tiebreak = None
    failures = 0
    # 2026-07-21: adapted for the 3-tuple speaker-system SEGMENTS
    # (id, speaker, caption_text) — voice/rate/pitch live in mbm_speakers.
    for name, _speaker, text in SEGMENTS:
