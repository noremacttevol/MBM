...
to the master ref, continuity locks on Zacchaeus + the Jericho setting. Caption-v2
(wide bottom, chunked). Two-voice: narrator en-US-AndrewNeural, KJV en-US-ChristopherNeural.
KJV lines (j1a/j1b Luke 19:5, j2a/j2b Luke 19:9-10) render cream-italic; the music dies
to true silence around n4 (Jesus stops under the tree and calls him by name). Closing
card is an invitation.

Output: luke-19_zacchaeus.mp4, 1080x1920 H.264 30fps, <25MB.
"""
import os
import subprocess
import textwrap
...
S6 = "s6-looks-up.jpeg"
S7 = "s7-invites.jpeg"
S8 = "s8-comes-down.jpeg"
S9 = "s9-table-gives.jpeg"
S10 = "s10-salvation.jpeg"
S11 = "s11-seek-save.jpeg"
...
PEAK = "n4"   # "Jesus stopped, looked up, and called him by name" — sacred silence
CARD_TEXT = ("He called you by name before you changed a thing. That is how "
             "he comes — to want you, exactly as you are.")
