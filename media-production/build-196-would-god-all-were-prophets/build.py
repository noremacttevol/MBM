#!/usr/bin/env python3
"""Assemble MEMBER Verse Video #196 — Would God That All the LORD's People
Were Prophets (Numbers 11:24-29).
...
CONTENT-CARE: clean — generosity, no fear. Jesus does not appear (Old
Testament, Moses). No divine figure — the Spirit is hinted as light.

ONE SACRED SILENCE: s1 — Numbers 11:29 (Moses's generous answer, the
centerpiece), scripture voice, cream italic. n3b (Joshua's objection) gets
the draft's extended hold before Moses answers. n1/n3 recorded in two halves
so the eight beats fill the eight stills per the CAPTION LAW.
...
paths in segs/. Output: numbers-11_would-god-all-were-prophets.mp4,
...
ST1 = "s1-the-weight.jpeg"
ST2 = "s2-gather-me-seventy.jpeg"
ST3 = "s3-the-spirit-shared.jpeg"
ST4 = "s4-eldad-and-medad.jpeg"
ST5 = "s5-the-runner.jpeg"
ST6 = "s6-forbid-them.jpeg"
ST7 = "s7-the-generous-answer.jpeg"
ST8 = "s8-the-wish-over-every-tent.jpeg"
...
BEATS = [
    ("n0", ST1, "in"),           # the weight crushing Moses
    ("n1a", ST2, "in"),          # gather me seventy
    ("n1b", ST3, "in"),          # the Spirit shared
    ("n2", ST4, "in"),           # Eldad and Medad in the camp
    ("n3a", ST5, "in"),          # the runner
    ("n3b", ST6, "in"),          # Joshua: forbid them — extended quiet hold
    ("s1", ST7, "in"),           # SACRED SILENCE — Num 11:29, the generous answer
    ("n4", ST8, "in"),           # he wished it wider — over every tent
]

LEAD = 0.28
GAP = 0.65
KJV_GAP = 1.60
# Per-beat gap override: n3b = the draft's sacred-silence beat before Moses
# answers.
HOLD = {"n3b": 1.60}
CARD_HOLD = 5.0
...
def main():
    ...
    print(f"sacred silence: s1 (Num 11:29) at {start_of['s1']:.1f}s", flush=True)
    ...
    OUT = "numbers-11_would-god-all-were-prophets.mp4"
    A_KBPS = 96
    MUX = 20
