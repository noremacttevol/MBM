...
S1 = "s1-the-good-shepherd.jpeg"
S2 = "s2-he-knows-his-sheep.jpeg"
S3 = "s3-known-of-mine.jpeg"
S4 = "s4-not-all-my-sheep.jpeg"
S5 = "s5-a-far-off-fold.jpeg"
S6 = "s6-they-shall-hear.jpeg"
S7 = "s7-other-sheep.jpeg"
S8 = "s8-one-fold-one-shepherd.jpeg"
...
GL_POINTER = "Learn more — Gospel Library: Book of Mormon"

BEATS = [
    ("n1", S1, "in"),
    ("n2", S2, "in"),
    ("n3", S3, "in"),
    ("kv14", S4, "in"),                      # SACRED SILENCE 1 — I am the good shepherd (John 10:14)
    ("n4", S4, "out"),
    ("n5", S5, "in"),
    ("n6", S6, "in"),
    ("kv16", S7, "in"),                      # SACRED SILENCE 2 — other sheep I have (John 10:16, named)
    ("n7", S7, "out"),
    ("n8", S8, "in"),
]
...
def main():
    ...
    print(f"sacred silence 1 (I am the good shepherd, John 10:14): kv14 at {start_of['kv14']:.1f}s",
          flush=True)
    print(f"sacred silence 2 (other sheep I have, John 10:16): kv16 at {start_of['kv16']:.1f}s",
          flush=True)
    ...
    p2_end = start_of["kv16"] + spoken["kv16"]
    beds = [
        (0.0, start_of["kv14"] - 1.2, "b"),
        (p1_end + 1.0, start_of["kv16"] - 1.0, "a"),
