#!/usr/bin/env python3
"""Generate #164's 8 stills via flow_driver.py (Nano Banana 2, 9:16, $0).
No Christ/God figure anywhere (the risen Lord + heaven shown only as warm light), NO --ref.
...
FILENAMES = [
    "s1-gifts-given.jpeg", "s2-the-fivefold.jpeg", "s3-equipping-the-saints.jpeg",
    "s4-the-body-built.jpeg", "s5-coming-into-unity.jpeg", "s6-full-stature.jpeg",
    "s7-tossed-no-more.jpeg", "s8-grow-up-together.jpeg",
]
...
print("ALL 164 STILLS GENERATED")
