...
// Phase 1 — missionary referral only shown when restoration-ready signals present
const MISSIONARY_EMAIL =
      ...
      <View style={styles.header}>
        ...
        {restorationReady && (
          <TouchableOpacity
            ...
            activeOpacity={0.75}
            onPress={() => Linking.openURL(MISSIONARY_EMAIL).catch(() => {})}
          >
            <Text style={styles.missionaryBtnText}>Talk to someone real →</Text>
          </TouchableOpacity>
        )}
      </View>
