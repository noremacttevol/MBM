...
PLACE_REFS = {
    # HILL deliberately UNWIRED (see QC.md and row 94): build-38's golden
    # village frame is the wrong world for Golgotha. Take row 94's approved
    # HILL once it exists — one Skull across the passion block.
}
# === end PLACE-PLATES ===
