...
PLACE_REFS = {
    "HOME": "PLACE-REF/home.jpeg",  # build-110-lords-prayer s06-not-a-distant-judge-not (manual)
    "PLACE": "PLACE-REF/place.jpeg",  # build-110-lords-prayer s01-one-day-his-followers-asked (manual)
}
# === end PLACE-PLATES ===
