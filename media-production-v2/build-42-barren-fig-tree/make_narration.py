...
SEGMENTS = [
    ...
    ("n6", NARRATOR, 'The gardener steps between the sentence and the tree. He does not deny the failure; he volunteers his own labor.'),
    ...
    ("n9", NARRATOR, 'The ending is deliberately unfinished. Jesus leaves his listeners inside that extra year, while mercy is still at work.'),
