...
COVERAGE: 38 pictures against V1's 8, over 219.7 s = 5.8 s/picture.
...
LOCKS = {
    ...
    "ROAD": (
        ...
        "vineyards on the slopes, stony hillsides with thorn scrub, the walls and "
        "rooftops of Jerusalem falling away behind, and low hills opening ahead. "
...
BEATS = [
    ...
    {
        "id": "v2-r018-b02", "out": "s02-going-over-it-again.jpeg", "seg": "n0 p3",
        "window": "7.61-19.09", "wide": True, "jesus": False, "ref": False,
        "locks": ["CLEOPAS", "COMPANION", "ROAD"],
    ...
    # -------------------------------------------- n1 — the stranger joins ----
    {
        ...
        "window": "19.66-24.62", "wide": True, "jesus": True, "ref": REF,
        "locks": ["CLEOPAS", "COMPANION", "ROAD"],
    ...
    },
    {
        ...
        "window": "24.62-30.43", "wide": False, "jesus": True, "ref": REF,
    ...
    },
    {
        ...
        "window": "30.43-35.82", "wide": True, "jesus": True, "ref": REF,
        "locks": ["CLEOPAS", "COMPANION", "ROAD"],
    ...
    # ---------------------------------------------------- n2 — what happened ----
    {
        ...
        "window": "36.43-42.16", "wide": True, "jesus": True, "ref": REF,
        "locks": ["CLEOPAS", "COMPANION", "ROAD"],
    ...
    },
    {
        ...
        "window": "42.16-50.13", "wide": False, "jesus": False, "ref": False,
        "locks": ["CLEOPAS"],
    ...
    },
    {
        ...
        "window": "50.73-56.39", "wide": True, "jesus": True, "ref": REF,
        "locks": ["CLEOPAS", "COMPANION", "ROAD"],
    ...
    # -------------------------------------------------- n3 — it poured out ----
    {
        ...
        "window": "57.91-64.74", "wide": True, "jesus": True, "ref": REF,
        "locks": ["CLEOPAS", "COMPANION", "ROAD"],
    ...
    },
    {
        ...
        "window": "64.74-71.04", "wide": False, "jesus": False, "ref": False,
        "locks": ["CLEOPAS", "COMPANION"],
    ...
    },
    {
        ...
        "window": "71.04-77.55", "wide": True, "jesus": True, "ref": REF,
        "locks": ["CLEOPAS", "COMPANION", "ROAD"],
    ...
    },
    {
        ...
        "window": "78.14-81.80", "wide": False, "jesus": False, "ref": False,
        "locks": ["CLEOPAS"],
    ...
    # --------------------------------------------------- n4a / j1 — the answer ----
    {
        ...
        "window": "83.38-86.39", "wide": False, "jesus": True, "ref": REF,
        "locks": [],
    ...
    },
    {
        ...
        "window": "86.98-91.5", "wide": True, "jesus": True, "ref": REF,
        "locks": ["CLEOPAS", "COMPANION"],
    ...
    },
    {
        ...
        "window": "91.5-96.04", "wide": False, "jesus": True, "ref": REF,
        "locks": [],
    ...
    # --------------------------------------------- n4b — he opened the scriptures ----
    {
        ...
        "window": "97.59-104.0", "wide": True, "jesus": True, "ref": REF,
        "locks": ["CLEOPAS", "COMPANION", "ROAD"],
    ...
    },
    {
        ...
        "window": "104.0-110.37", "wide": False, "jesus": False, "ref": False,
        "locks": ["CLEOPAS", "COMPANION"],
    ...
    },
    {
        ...
        "window": "110.37-114.45", "wide": True, "jesus": True, "ref": REF,
        "locks": ["CLEOPAS", "COMPANION", "ROAD"],
    ...
    # ------------------------------------------------- n5 — abide with us ----
    {
        ...
        "window": "115.02-120.89", "wide": True, "jesus": True, "ref": REF,
        "locks": ["CLEOPAS", "COMPANION", "ROAD", "HOUSE"],
    ...
    },
    {
        ...
        "window": "120.89-127.65", "wide": True, "jesus": True, "ref": REF,
        "locks": ["CLEOPAS", "COMPANION"],
    ...
    },
    {
        ...
        "window": "127.65-134.50", "wide": True, "jesus": True, "ref": REF,
    ...
    # ---------------------------------------------------- n6 — the bread ----
    {
        ...
        "window": "135.99-141.20", "wide": True, "jesus": True, "ref": REF,
        "locks": ["CLEOPAS", "COMPANION", "HOUSE"],
    ...
    },
    {
        ...
        "window": "141.20-142.51", "wide": False, "jesus": True, "ref": REF,
        "locks": [],
    ...
    },
    {
        ...
        "window": "142.51-143.57", "wide": False, "jesus": True, "ref": REF,
        "locks": [],
    ...
    },
    {
        ...
        "window": "143.57-144.30", "wide": False, "jesus": True, "ref": REF,
        "locks": [],
    ...
    },
    {
        ...
        "window": "144.30-146.06", "wide": True, "jesus": True, "ref": REF,
        "locks": ["CLEOPAS", "COMPANION"],
    ...
    # ------------------------------------------------ n7 — they knew him ----
    {
        ...
        "window": "146.63-153.80", "wide": False, "jesus": False, "ref": False,
        "locks": ["CLEOPAS", "COMPANION"],
    ...
    },
    {
        ...
        "window": "153.80-155.26", "wide": True, "jesus": True, "ref": REF,
        "locks": ["CLEOPAS", "COMPANION", "HOUSE"],
    ...
    },
    {
        ...
        "window": "155.26-162.97", "wide": True, "jesus": False, "ref": False,
        "locks": ["CLEOPAS", "COMPANION", "HOUSE"],
    ...
    # ------------------------------------------------ n8 — our hearts burned ----
    {
        ...
        "window": "163.62-165.15", "wide": False, "jesus": False, "ref": False,
        "locks": ["CLEOPAS", "COMPANION"],
    ...
    {
        "id": "v2-r018-b31", "out": "s31-he-was-with-us-the-whole-way.jpeg", "seg": "n8 p2-p3",
        "window": "165.15-176.99", "wide": True, "jesus": False, "ref": False,
        "locks": ["CLEOPAS", "COMPANION", "HOUSE"],
    ...
    },
    {
        ...
        "window": "177.58-183.34", "wide": False, "jesus": False, "ref": False,
        "locks": ["CLEOPAS"],
    ...
    # ------------------------------------------------ n9 — the run back ----
    {
        ...
        "window": "184.89-186.34", "wide": True, "jesus": False, "ref": False,
        "locks": ["CLEOPAS", "COMPANION", "HOUSE"],
    ...
    },
    {
        ...
        "window": "186.34-192.0", "wide": True, "jesus": False, "ref": False,
        "locks": ["CLEOPAS", "COMPANION", "ROAD"],
    ...
    },
    {
        ...
        "window": "192.0-197.07", "wide": True, "jesus": False, "ref": False,
        "locks": ["CLEOPAS", "COMPANION"],
    ...
    },
    {
        ...
        "window": "197.07-199.52", "wide": False, "jesus": False, "ref": False,
        "locks": ["CLEOPAS", "COMPANION"],
    ...
    # ------------------------------------------------- n10 — how he spent it ----
    {
        ...
        "window": "200.13-206.15", "wide": True, "jesus": False, "ref": False,
        "locks": ["ROAD"],
    ...
    {
        "id": "v2-r018-b38", "out": "s38-walking-with-the-ones-who-lost-hope.jpeg", "seg": "n10 p4-p5",
        "window": "206.15-219.50", "wide": True, "jesus": True, "ref": REF,
        "locks": ["CLEOPAS", "COMPANION", "ROAD"],
