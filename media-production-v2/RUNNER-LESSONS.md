...
- **A "shining face" beat (Moses, Ex 34 "the skin of his face shone") can render as a full white HALO-BURST around the head — the row's own law usually wants BRIGHT SKIN, no halo/rays (2026-08-13, row 105 b24).** One `--redo` reduced it to a localized facial luminance (people shielding their eyes = scripturally apt, Ex 34:30). Reroll a shining-face halo to a skin-shine; don't over-reroll into no-shine-at-all (misses the beat).
