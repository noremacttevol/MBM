...
LOCKS = {
    ...
    "VINEYARD": (
        ...
        "stakes, heavy with dusty dark grapes, the earth between the rows dry, "
        "pale and cracked. At its head stand a square dry-stone watchtower two "
...
BEATS = [
    ...
    # ============================== PARABLE — third hour ====
    {
        ...
        "scene": (
            ...
            "short hard shadows, fine film grain. THE CAMERA STANDS BEHIND AND "
            "SLIGHTLY LEFT OF THE LANDOWNER AND SHOOTS PAST HIS BACK: his dark "
            "oxblood mantle and grey head fill the near right of the frame from "
            "behind, out of focus, and his face is not visible to the lens. Sharp "
            "beyond him, along the strip of shade under the long dry-stone wall, "
            "five labourers wait with nothing in their hands — two sitting on their "
            "heels, three standing, one scraping a line in the dust with his toe. "
            "Every one of them has turned his head toward the landowner as he comes "
            "into the square, so all five eyelines converge on him inside the frame "
            "and no one is looking anywhere near the camera. Packed earth, the well "
            "head at the left edge, flat village roofs and the bare ridge behind."
        ),
    },
    {
    ...
    },
    {
        ...
        "scene": (
            ...
            "already bent to the vines with pruning hooks, both in profile with their "
            "eyes on the fruit in their hands. Dust, dry cracked earth between the "
            "rows, the dry-stone watchtower standing beyond them."
        ),
    },
    ...
    },
    {
        ...
        "scene": (
            ...
            "of his shoulders coming loose. Neither man's pupils go anywhere near the "
            "lens. Behind them the empty square and the wall fall away into warm gold "
            "blur."
        ),
    },
    {
    ...
    },
    {
        ...
        "scene": (
            ...
            "nowhere near the lens, his mouth open on the accusation. Behind his "
    ...
    },
    {
        ...
        "scene": (
            ...
            "head-and-shoulders frame of the first-hired man in three-quarter view. "
            "His eyes are lifted and locked on the landowner's face, which sits just "
            "behind his own head at the right edge of the picture badly out of focus "
            "but plainly there — so his gaze has a named target inside the frame and "
            "leaves the picture nowhere near the camera. The clenched set has gone "
    ...
    },
    {
        ...
        "scene": (
            ...
            "fine film grain. THE CAMERA STANDS LOW JUST OUTSIDE THE GATE GAP AHEAD "
            "OF THEM, SHOOTING BACK AT THE MEN AS THEY COME OUT — but every man is "
            "angled away or in profile with his head down, walking across and past "
            "the lens, and NOT ONE FACE IS TURNED TOWARD THE CAMERA. Each of them "
            "holds his closed fist against his chest where the coin is. The "
            "first-hired man is the last through the gap, seen almost entirely from "
            "behind. Beyond the gate the dark terraces climb away under the first "
            "stars."
        ),
    },
    {
