...
BEATS = [
    ...
    # ==================== KJV — Matthew 13:33, Jesus speaking ==================
    {
        ...
        "scene": (
            ...
            "on the left, fine film grain. THE CAMERA IS PLACED COMPLETELY SIDE-ON TO "
            "THE WHOLE GROUP, OUT ON THE EARTH SQUARE AND WELL TO ONE SIDE, SHOOTING "
            "ALONG THE FACE OF THE WALL AT RIGHT ANGLES TO EVERY EYELINE IN THE "
            "PICTURE, so the whole conversation runs HORIZONTALLY ACROSS THE FRAME. "
            "Jesus sits at the LEFT of the frame SEEN FROM HIS RIGHT SIDE IN CLEAN "
            "PROFILE and the listeners are ranged along the bench and the steps to the "
            "RIGHT of him. HIS GAZE HAS A NAMED TARGET INSIDE THE PICTURE: those seated "
            "listeners at the right of the frame, so his eyeline travels rightward "
            "across the picture and exits through the RIGHT EDGE, while every listener "
            "is seen in profile or three-quarter from behind with an eyeline travelling "
            "leftward and out through the LEFT EDGE. NOT ONE PERSON'S FACE IS SQUARED "
            "UP TO THE CAMERA AND NOT ONE PAIR OF PUPILS IS CENTRED ON THE LENS. Two "
            "seated backs fill the near bottom corners, soft and out of focus, a DEEP "
            "INDIGO shouldered back at the near left and a DARK UMBER back at the near "
            "right, with nothing pale, grey, beige, taupe, cream or off-white on either "
            "of them. Sharp in the middle distance Jesus sits on the worn stone bench "
            "against the honey-coloured limestone wall, his right hand lifted and "
            "turned palm-up in the explaining gesture, his lips parted mid-word. More villagers sit on the three broad stone "
    ...
    },
    {
        ...
        "scene": (
            ...
            "NAMED TARGET INSIDE THE PICTURE — a listener seated on the steps at the "
            "right of the frame whose ENTIRE body, back, shoulder, arm, sleeve, lap, "
            "knee and head cloth are DEEP INDIGO, ONE SINGLE UNBROKEN DARK NAVY MASS "
            "out of focus at the right edge, with NOTHING pale, grey, beige, taupe, "
            "sand, ivory, cream or off-white anywhere on him, on his clothing or on "
            "anything he holds — and his "
    ...
    },
    {
        ...
        "scene": (
            ...
            "rough tan mud-brick walls close the yard. ABOVE THE WALLS THERE IS NOTHING "
            "BUT OPEN SKY AND THE ROUNDED WEATHERED TOP OF THE MUD BRICK ITSELF: no "
            "roof, no eave, no beam, no rafter, no awning, no sheet of corrugated or "
            "ribbed metal, no plank or tile overhang and no structure of any kind "
            "projects over any wall or breaks the skyline at any corner or edge of the "
            "frame."
        ),
    },
    # ==================== HIDING IT — the yard, late afternoon =================
    {
        ...
        "scene": (
            ...
            "of a working woman's right hand. Behind the wrist, out of focus, is the "
            "pushed-up sleeve of her DEEP INDIGO tunic, and it is COARSE FLAT "
            "HAND-WOVEN WOOL showing an open over-and-under grid of warp and weft "
            "threads with a frayed cut edge — never a knitted, ribbed, cabled, fleecy "
            "or stretchy cuff of any kind. Between the very tips of the "
    ...
    },
    {
        ...
        "scene": (
            ...
            "grain. THE WHOLE PICTURE IS OUTDOORS INSIDE THE FIRST-CENTURY BAKING "
            "YARD, ON BARE SWEPT EARTH BESIDE A ROUGH TAN MUD-BRICK WALL, and the "
            "camera is high above the trough looking straight down into it, tilted just "
            "enough that a band of that sunlit earth floor and the foot of the "
            "mud-brick wall show along one edge. There is no person in the picture at "
            "all and NOTHING MODERN ANYWHERE IN OR BEHIND THE FRAME: no decking, "
            "planking, paving slab, table top, railing, fence, painted surface, window, "
            "plant pot, garden or building of any kind, and no small modern wooden "
            "bowl — the vessel is the long adzed olive-wood trough of this yard. The frame is filled almost entirely by "
    ...
    },
    {
        ...
        "scene": (
            ...
            "base of the fingers and dusted with flour. At the wrist, out of focus, is "
            "the pushed-up sleeve of a DEEP INDIGO tunic, and it is COARSE FLAT "
            "HAND-WOVEN WOOL showing an open over-and-under grid of warp and weft "
            "threads with a frayed cut edge — never knitted, ribbed, cabled, brushed, "
            "napped, fleecy or stretchy. In the hollow of the palm, "
    ...
    },
    {
        ...
        "scene": (
            ...
            "INDIGO sleeves pushed up out of focus at the wrists, the sleeve cloth "
            "coarse flat hand-woven wool with a visible warp-and-weft grid and a frayed "
            "cut edge, never knitted, ribbed or fleecy and never a collar, placket or "
            "button. The crust is rough, "
            ...
            "of the lower half of the loaf along the bottom edge. THE WHOLE PICTURE IS "
            "OUTDOORS INSIDE THE FIRST-CENTURY BAKING YARD: everything behind the loaf "
            "is the sunlit rough tan mud-brick yard wall and the swept beaten earth, "
            "thrown completely out of focus into warm earth-coloured shapes. THERE IS "
            "NOTHING MODERN ANYWHERE IN OR BEHIND THE FRAME: no kitchen, no window, no "
            "bright white or grey background, no table top, no planed board, no bamboo "
            "or rolled slat mat, no stitched or threaded matting, no cloth of any kind "
            "under the bread, and no second loaf staged beside it — only the one torn "
            "loaf in the two hands."
        ),
    },
    ...
    },
    {
        ...
        "scene": (
            ...
            "fall out of focus. EVERY SACK ANYWHERE IN THIS PICTURE, sharp or blurred, "
            "near or far, IS COARSE DARK BROWN-BLACK HAND-WOVEN GOAT-HAIR CLOTH "
            "gathered and tied at the neck with twisted flax cord — there is no white, "
            "cream, pale, bleached, glossy or woven-plastic sack anywhere in the frame, "
            "and nothing pale stands against the wall behind her."
        ),
    },
    {
