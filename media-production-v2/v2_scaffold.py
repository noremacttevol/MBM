...
def render(build, data, groups):
    ...
    L.append("  3. Run v2_outline.py for this row and obey its prior-review lesson.")
    L.append("     Also read media-production-v2/V2-REBUILD-RUBRIC.md in full.")
    L.append("  4. Decide the time-of-day arc and state it here, so no later QC pass")
    L.append("     mistakes a correct sunset for the row-11 storm defect.")
    L.append("  5. Name any prop or condition that CHANGES across the row (a cloak, a")
