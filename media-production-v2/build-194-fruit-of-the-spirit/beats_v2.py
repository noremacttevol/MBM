...
# never embodied.
# AUDIO guard fix (2026-08-24) — verified STALE-V1, not lost content: the V1
# mp4 was rendered 2026-07-21 and carries the OLD slower voice, while all 8
# mp3s are ElevenLabs new-voice (44100/128k) written 2026-07-29. A full
# transcription of the V1 mp4 matches the segment texts (incl. the card line),
# so rebuilding at 50.572s loses nothing and ships the NEW voice.
...
BEATS = [
    ...
    },
    {
        ...
        "scene": (
            ...
            "ONE single continuous photograph from ONE camera — a single medium two-shot at eye level. Absolutely NO grid, NO collage, NO stacked or side-by-side panels, NO multiple vignettes or scenes in one frame, NO dividing lines or borders: one moment, one picture."
        ),
    },
    {
    ...
    },
    {
        ...
        "scene": (
            ...
            "CAMERA: a LOW WIDE from behind the believer, the open road stretching away ahead of him and the village small behind, his figure unhurried mid-frame. NOT a village-lane framing."
        ),
    },
    {
        ...
        "scene": (
            ...
            "CAMERA: a TIGHT over-the-shoulder two-shot, only two faces close and level in the frame, the village a soft blur. NOT a full-figure shot."
        ),
    },
    {
        ...
        "scene": (
            ...
            "CAMERA: from slightly ABOVE and behind the believer's head, the ring of hard unsettled faces turned in toward him around the frame. NOT an eye-level single."
        ),
    },
    {
        ...
        "scene": (
            ...
            "anywhere; no divine or Spirit figure."
            "CAMERA: a CLOSE PROFILE of his calm absorbing face at frame right, the others out of focus beyond him. NOT a frontal or group shot."
        ),
    },
    {
        ...
        "scene": (
            ...
            "anywhere; no divine or Spirit figure."
            "CAMERA: a CLOSE INSERT on his steadying hand on the other person's arm, both faces soft above the frame edge. NOT a face-led shot."
        ),
    },
    {
        ...
        "scene": (
            ...
            "head; nothing is written anywhere; no divine or Spirit figure."
            "CAMERA: an EXTREME tight close — only his eyes, cheek and set jaw filling the frame as he holds back. NOT any shot showing his whole head or body."
        ),
    },
    {
        ...
        "scene": (
            ...
            "head; nothing is written anywhere; no divine or Spirit figure."
            "CAMERA: a HIGH WIDE of the sunlit square with the believer among the welcoming group small and central, long shadows across the paving. NOT a close or two-shot."
        ),
    },
    {
...
PLACE_REFS = {
    "ORCHARD": "PLACE-REF/orchard.jpeg",  # build-194-fruit-of-the-spirit s02-a-harvest-of-character (manual)
    "PAUL-ROOM": "PLACE-REF/paul-room.jpeg",  # build-184-third-heaven v2-r184-b01 (manual)
    "VILLAGE": "PLACE-REF/village.jpeg",  # build-123-golden-rule v2-r123-b21
}
# === end PLACE-PLATES ===
