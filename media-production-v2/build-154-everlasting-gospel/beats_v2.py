...
PLACE_REFS = {
    "ANGEL": "PLACE-REF/angel.jpeg",  # build-154-everlasting-gospel s04-not-an-army-not-a (manual)
    "PATMOS": "PLACE-REF/patmos.jpeg",  # build-154-everlasting-gospel s03-and-then-in-a-vision (manual)
}
# === end PLACE-PLATES ===
