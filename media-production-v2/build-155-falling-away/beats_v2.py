...
# audio-eleven.log confirms all 11 cast) but they were newer than the V1 mp4
# (old-voice render) so v2_assemble's AUDIO LOCK refused. Rebuild the track
# from the newer new-voice mp3s — no re-voice, no still regen.
