...
REFS = {
    ...
    "BITTEN-MAN": "CAST-REF-V2/bitten-man.jpeg",
}
...
PLACE_REFS = {
    "SERPENT-POLE": "PLACE-REF/serpent-pole.jpeg",  # build-140-bronze-serpent s17-lifted-on-a-pole (manual)
    "WILDERNESS-CAMP": "PLACE-REF/wilderness-camp.jpeg",  # build-140-bronze-serpent s01-out-of-egypt-on-a-miracle (manual)
}
# === end PLACE-PLATES ===
