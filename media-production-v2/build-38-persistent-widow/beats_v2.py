...
BEATS = [
    ...
    # ===== n1b — the narrator states why the story exists ====================
    {
        ...
        "scene": (
            ...
            "ONTO THE LENS AXIS. "
            "LIGHT GEOMETRY, STATED AS A SECOND GOVERNING RULE: THE SUN IS IN "
            "FRONT OF THE PEOPLE AND OFF TO THE CAMERA'S RIGHT, low and level, "
            "so it strikes the FRONT PLANES of every face and the FRONT of every "
            "shoulder. NOTHING IN THIS PICTURE IS LIT FROM BEHIND. The wall "
            "behind Jesus stands in its own flat shade and is DARKER than he is. "
            "NO BRIGHT FRINGE, RIM, EDGE, OUTLINE, CONTOUR OR BAND OF LIGHT RUNS "
            "HIS HAIR, THE TOP OR BACK OF HIS HEAD, HIS SHOULDERS OR ANY PART OF "
            "HIS BODY; his hair is lit only on the side facing the sun and stays "
            "matte dark brown everywhere else; and no sun disc, sunburst, "
            "starburst or lens flare appears in the frame. "
    ...
    },
    {
        ...
        "scene": (
            "LENS-AXIS GEOMETRY, STATED FIRST BECAUSE IT GOVERNS THIS FRAME: "
            "THE CAMERA STANDS SQUARE TO THE SIDE OF THE LINE BETWEEN THE TWO "
            "PEOPLE, AT RIGHT ANGLES TO IT. The judge sits at the RIGHT of the "
            "frame and the woman stands at the LEFT of the frame, and they face "
            "EACH OTHER ACROSS THE PICTURE, so both are seen in CLEAN SIDE-ON "
            "PROFILE with the near cheek broad and the far eye hidden behind the "
            "bridge of the nose. Their two eyelines run horizontally toward one "
            "another along the middle of the frame and meet in the empty air "
            "between them. NEITHER OF THEM IS TURNED TOWARD THE LENS, NEITHER "
            "FACE IS SEEN SQUARE-ON, AND NEITHER PAIR OF PUPILS EVER COMES ROUND "
            "ONTO THE CAMERA AXIS. "
            "One photograph, 50mm lens, hard flat late-morning daylight falling "
            "in from the LEFT through a plain square-topped opening in the side "
            "wall and across the worn limestone flags between them, striking the "
            "FRONT planes of both faces; the sun is well out of frame and NOTHING "
            "is lit from behind, with no bright rim, fringe or outline along "
            "anybody's hair, head or shoulders, " + _GRAIN +
            "A WIDE FULL-LENGTH SCENE WITH TWO PEOPLE, NOT A PORTRAIT: the camera "
            "is far enough back that both are in frame head to sandals with four "
            "paces of bare sunlit stone floor between them and NOTHING in that "
            "space — no rail, no barrier, no furniture, no other person. AT THE "
            "RIGHT, THE JUDGE sits on his plain rectangular limestone seat "
            "against the back wall, in strict profile facing LEFT toward her, his "
            "thick iron-grey hair combed back and cut to the middle of his neck "
            "and his full trimmed iron-grey beard squared at the jaw, in his DEEP "
            "DARK RUST-RED ankle-length tunic under his DEEP CHARCOAL-BLACK "
            "mantle, his expression flat and incurious. AT THE LEFT, THE WIDOW "
            "has just walked in and stopped, standing straight and square in "
            "strict profile facing RIGHT toward him, her weight even on both "
            "feet, her chin level, her hands down in front of her. SHE IS THE "
            "SAME WOMAN AS THE ATTACHED REFERENCE AND HER IDENTITY IS RESTATED "
            "HERE: a JUDEAN WOMAN OF ABOUT FORTY-FIVE, small, spare and upright, "
            "her skin WARM SUN-DARKENED OLIVE-BROWN and clearly Middle Eastern, "
            "never fair and never pale, her face narrow and weathered with fine "
            "deep lines at the outer corner of the eye, her DARK BROWN HAIR GOING "
            "IRON-GREY AT THE TEMPLES drawn back into a low coiled knot at the "
            "nape and UNCOVERED. SHE WEARS EXACTLY THREE PIECES OF CLOTH: ONE "
            "ankle-length coarse hand-woven DARK UMBER-BROWN wool tunic with "
            "straight unshaped sleeves, ONE rectangular DEEP INDIGO hand-woven "
            "wool mantle draped over both shoulders and crossed at the breast, "
            "and ONE twisted brown flax cord at her waist — NEVER a tailored "
            "cloak, cape, shawl collar, lapel, front opening, fastening or "
            "floor-length gown of any later century. BEHIND HER, at the far LEFT "
            "of the picture, the way she came in is a PLAIN SQUARE-TOPPED "
            "RECTANGULAR OPENING spanned by ONE SINGLE FLAT LIMESTONE LINTEL laid "
            "straight across the top between two jambs of dressed limestone "
            "blocks, and IT IS COMPLETELY EMPTY — there is no door, no leaf, no "
            "gate, no hinge and no barrier in it, and no arch, curved head or ring "
            "of dressed voussoirs anywhere over it. Through it only bare pale dust "
            "and one low mud-brick wall with a flat roofline are visible, with no "
            "other building, no window, no rendered white wall and no person out "
            "there. Everything light-toned in the picture is dressed limestone, "
            "dust and bare skin."
        ),
    },
    {
        ...
        "scene": (
            ...
            "SHE IS THE ONLY PERSON IN THE PICTURE, AND SHE IS STANDING INSIDE "
            "THE STONE JUDGMENT CHAMBER OF THE CITY GATE — NOT in a house and "
            "NOT in any mud-plastered room. A TIGHT SHOT filling the "
            ...
            "bright out-of-focus slab of the sunlit opening. EVERYTHING BEHIND "
            "HER IS BIG DRY-LAID PALE DRESSED LIMESTONE BLOCKS AND WORN "
            "LIMESTONE FLAGS: there is NO mud plaster, no mud-brick wall, no "
            "reed mat, no rolled matting, no clay jar, no timber beam, no wall "
            "ledge and no domestic object of any kind anywhere in the frame. "
            "NOBODY ELSE IS IN "
            "THE PICTURE."
        ),
    },
    ...
    # ===== n4 — THE MONTAGE: one composition, four hours =====================
    {
        ...
        "scene": (
            ...
            "gate-chamber opening, at chest height, square on to the wall. THE "
            "OPENING IS BUILT OF BIG PALE DRESSED LIMESTONE BLOCKS AND IS THE "
            "SAME OPENING IN ALL FOUR PICTURES: two JAMBS of large squared "
            "dressed limestone standing vertical at left and right, ONE SINGLE "
            "SQUARED HEWN TIMBER LINTEL BEAM laid straight across the top with a "
            "course of dressed limestone above it, and a WORN HOLLOWED LIMESTONE "
            "THRESHOLD SLAB crossing the bottom. The wall around it is the same "
            "dressed pale limestone. THERE IS NO MUD PLASTER, NO MUD-BRICK, NO "
            "TIMBER DOOR FRAME OR LINING, NO DOOR, NO LEAF AND NO BARRIER IN THE "
            "OPENING, and no arch or curved head over it. "
    ...
    },
    {
        ...
        "must_not_show": _NO_HALO + _NO_DEITY + _NO_CREAM + _NO_MOURNING + _NO_MOCK + _NO_MODERN_TOWN + _NO_IRONGATE + _NO_GREEN + _NO_MODERN_LAMP + _GAZE,
        "scene": (
            "LENS-AXIS GEOMETRY, STATED FIRST BECAUSE IT GOVERNS THIS FRAME: THIS "
            "IS A STRICT SIDE-ON PROFILE. Her body and her head are BOTH turned a "
            "FULL QUARTER-TURN to her own right, into the dark chamber, and the "
            "camera stands square to her LEFT SIDE at her own eye height. The "
            "picture therefore shows the NEAR cheek broad and complete and the FAR "
            "CHEEK AND THE FAR EYE HIDDEN BEHIND THE BRIDGE OF HER NOSE. Her "
            "eyeline runs LATERALLY ACROSS the frame and exits through the RIGHT "
            "EDGE. HER HEAD NEVER TURNS BACK TOWARD THE LENS, HER FACE IS NEVER "
            "SEEN SQUARE-ON OR IN THREE-QUARTER, AND HER PUPILS NEVER COME ROUND "
            "ONTO THE CAMERA AXIS. "
            ...
            "WEATHER — THE SAME OPENING OF BIG PALE DRESSED LIMESTONE BLOCKS: the "
            "same two JAMBS of large squared dressed limestone standing vertical "
            "at left and right, the SAME single squared hewn timber lintel beam "
            "laid straight across the top with dressed limestone above it, and the "
            "same worn hollowed limestone threshold slab across the bottom, with "
            "NO mud plaster, NO mud-brick, NO timber door frame or lining, NO "
            "door, leaf or barrier in the opening and no arch over it — but the "
            "lens is longer so she is larger in the frame. "
    ...
    },
    {
        ...
        "scene": (
            ...
            "TOWARD THE LENS. HE IS COMPLETELY BAREFOOT: both feet are bare "
            "brown skin on the beaten earth, and there is NO sandal, shoe, "
            "strap, sole or footwear of any kind on either foot and none "
            "lying anywhere in the picture. Beyond him the empty bright doorway opens onto "
    ...
    },
    {
        ...
        "scene": (
            ...
            "doorway with its two plain mud-plastered jambs over a footing of "
            "undressed stone, ONE single squared hewn timber lintel beam laid "
            "straight across the top, and a worn hollowed limestone threshold "
            "slab — the SAME doorway of the SAME house in every frame of it. "
    ...
    },
    {
        ...
        "scene": (
            ...
            "at the centre the plain SQUARE-TOPPED doorway — two plain "
            "mud-plastered jambs over a footing of undressed stone, ONE SINGLE "
            "SQUARED HEWN TIMBER LINTEL BEAM laid "
            "straight across the top, and a WORN HOLLOWED LIMESTONE THRESHOLD "
            ...
            "OPENING IS COMPLETELY EMPTY AND STANDS OPEN TO THE LANE: THERE IS "
            "NO DOOR AND NO DOOR LEAF ANYWHERE IN THIS PICTURE — no plank door, "
            "no boarded door, no timber slab standing in or across the opening, "
            "no batten, no nail head, no stud, no handle, no ring, no hinge, no "
            "pivot, no latch and no barrier of any kind, and nothing is leaned "
            "against the jambs or hung in the gap. The doorway is a clear dark "
            "rectangle from threshold to lintel, and the level first light "
            "reaches straight through it and lies in one long bright slab on the "
            "beaten earth floor inside, which is plainly visible. "
            "Beside the opening stand two fired-clay jars. The dust of the lane "
