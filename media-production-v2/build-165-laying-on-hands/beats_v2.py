...
PLACE_REFS = {
    "JERUSALEM-ROOM": "PLACE-REF/jerusalem-room.jpeg",  # build-165-laying-on-hands s04-not-a-letter (manual)
    "SAMARIA-HILL": "PLACE-REF/samaria-hill.jpeg",  # build-165-laying-on-hands s01-samaria-believes (manual)
}
# === end PLACE-PLATES ===
