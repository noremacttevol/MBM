...
| 69 | build-69-baptism | NEEDS-AUDIO | 29 | CHECK | AUDIO-FIX 2026-08-06 LIVE — A-auto 2026-08-06 PARKED: all 29 stills GENERATED + QC-PASS (scale complaint FIXED), but v2_assemble FAILS AUDIO LOCK — V1 mp4 (206.6s, Jul-29 09:47) is STALE vs current narration segments (172.3s); make_narration.py edited later. Author must fix audio (re-render V1 OR set AUDIO_FROM_V1_SEGMENTS). Stills reusable, do NOT regen. See QC.md RUNNER PARK. |  |
