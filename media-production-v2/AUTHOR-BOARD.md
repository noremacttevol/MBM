...
| 78 | build-78-who-is-my-mother | NEEDS-AUDIO | 0 | CHECK | AUDIO-FIX 2026-08-06 LIVE — A-auto 2026-08-06 PARKED ($0): STALE V1 mp4 (row-69 class), pre-flighted at step 2 before any spend. V1 mark-3 mp4 rendered 2026-07-24; all 11 locked mp3s NEWER (2026-07-28), excess +5.18s — v2_assemble refuses AUDIO LOCK. Author: set AUDIO_FROM_V1_SEGMENTS=True in beats_v2.py OR re-render V1 mp4. See QC.md RUNNER PARK. |  |
