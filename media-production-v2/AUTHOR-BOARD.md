...
| 63 | build-63-man-born-blind | NEEDS-AUDIO | 41 | CHECK | RUNNER PARK 2026-08-07 (Machine A `Dev`, Opus resume): OPEN complaint is AUDIO-domain — Cameron "still wrong its : si-LOH-uhm" (Siloam). Picture runner STOPPED at the audio gate, $0 spent, 0 pictures touched. VERIFIED WRONG: audio/j2.mp3 (Jesus "Go, wash in the pool of Siloam") transcribes "Salome" on faster-whisper base.en+small.en. The make_narration.py:89 override "sih low um" did NOT land. AUDIO LANE: respell Siloam→si-LOH-uhm + re-voice j2 (+n4/n5) through the REAL engine (ElevenLabs, not edge-tts), AUDIO_FROM_V1_SEGMENTS=True. Stills 41/43 — b42/b43 still ungenerated (~$0.27), so after audio fix hand to picture runner (AUTHORED+Ready), not directly BUILT. Full spec in QC.md §0. | ✅ |
...
| 67 | build-67-the-transfiguration | BUILT | 16 | OK | A-auto 2026-08-06 SHIPPED · C-FIX 2026-08-07 LIVE | ✅ |
