...
BEATS = [
    ...
    },
    {
        ...
        "scene": (
            ...
            "right and very slightly below, shallow depth of field with the water "
            ...
            "OUT ON THE STONE TO HIS RIGHT AND SHOOTS ACROSS HIM, so his head is turned "
            "well off the camera axis with his nose pointed toward the LEFT EDGE of the "
            "frame, and his gaze goes level into the face of a man seated below and "
            "left of him and clean out through that LEFT EDGE — his pupils never come "
            "near the lens. He is seated on a flat-topped grey-brown boulder in his one "
