...
PLACE_REFS = {
    "NATIONS-WORLD": "PLACE-REF/nations-world.jpeg",  # build-200-gospel-to-all-the-world s05-to-every-corner (manual)
    "OLIVET": "PLACE-REF/olivet.jpeg",  # build-200-gospel-to-all-the-world s01-on-the-mount-of-olives (manual)
}
# === end PLACE-PLATES ===
