...
SEGMENTS = [
    ("n0a", NARRATOR, "-20%", "-4Hz", 'Jesus sat with his disciples on the Mount of Olives, telling them what the long road ahead would hold —'),
    ("n0b", NARRATOR, "-20%", "-4Hz", 'wars, rumors, hardship, and patience under strain.'),
    ("n1a", NARRATOR, "-20%", "-4Hz", 'Then he turned to the one thing that would outlast all of it:'),
    ("n1b", NARRATOR, "-20%", "-4Hz", 'a message carried to every corner of the earth.'),
    ("n2a", NARRATOR, "-20%", "-4Hz", 'Not a secret kept for a few.'),
    ("n2b", NARRATOR, "-20%", "-4Hz", 'A witness given to all nations — the good news of the kingdom going out until the very end.'),
    ("j1", JESUS, "-22%", "-2Hz", 'And this gospel of the kingdom shall be preached in all the world for a witness unto all nations; and then shall the end come.'),
    ("n3", NARRATOR, "-20%", "-4Hz", 'The task he gave is still the task we carry: tell it, show it, live it — until the promise is fulfilled. Every honest witness, every quiet act of discipleship, carries the message one person farther.'),
    ("card", NARRATOR, "-22%", "-5Hz", 'The good news was meant for the whole world — and for you. Receive it, then help it cross the next distance. Come, hear it, and carry it on.'),
]
