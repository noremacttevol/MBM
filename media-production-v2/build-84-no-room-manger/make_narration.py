...
SEGMENTS = [
    ...
    ("n1", NARRATOR, 'A command issued in a distant palace reached all the way into two ordinary lives in Nazareth.'),
    ...
    ("n6", NARRATOR, 'Luke records the moment without spectacle, in a single quiet sentence:'),
