...
# AUDIO guard fix (2026-08-24) — verified STALE-V1, not a dropped segment:
# the V1 mp4 (68.767s, rendered 09:46:32) carries the OLD slower voice; all 9
# mp3s are ElevenLabs new-voice (44100/128k, written 09:47:29, audio-eleven.log
# complete). Full transcription of the V1 mp4 matches the 9 segment texts exactly
# — nothing extra, so nothing is lost by rebuilding at 52.662s in the new voice.
...
BEATS = [
    ...
    },
    {
        ...
        "scene": (
            ...
            "anywhere."
            "CAMERA: a tight CLOSE on the seated believer's face and idle hands, the room only soft warm blur behind. NOT the establishing room wide of b01."
        ),
    },
    {
    ...
    },
    {
        ...
        "scene": (
            ...
            "CAMERA: a MEDIUM two-shot from the side, both figures in profile facing each other across the frame, the lane running away behind them. NOT the poor pair's own framing from b03."
        ),
    },
    {
        ...
        "scene": (
            ...
            "CAMERA: a WIDE of the emptied lane with the believer small and alone at one edge, the long lane and its shadows filling most of the frame. NOT a close or two-shot."
        ),
    },
    {
    ...
    },
    {
        ...
        "scene": (
            ...
            "CAMERA: a LOW angle close on Isaac's calm face and Abraham's steadying hand, the altar stones large in the near foreground. NOT the wide of the high place used earlier."
        ),
    },
    {
    ...
    },
    {
        ...
        "scene": (
            ...
            "CAMERA: from OUTSIDE the wall looking back in at the deep window, Rahab's braced arms and the cord dropping toward the lens. NOT the interior room framing of b08."
        ),
    },
    {
        ...
        "scene": (
            ...
            "is written anywhere."
            "CAMERA: an OVER-THE-SHOULDER from behind the poor brother and sister, looking past their shoulders at the believer as he finally moves toward them. NOT a framing that favours the believer alone."
        ),
    },
    {
        ...
        "scene": (
            ...
            "anywhere."
            "CAMERA: a CLOSE ACTION insert — the believer's pushed-back sleeves and working hands filling the lower frame as he lifts bread and a folded blanket, his face partly above. NOT a full-figure standing shot."
        ),
    },
    {
        ...
        "scene": (
            ...
            "ring of light around any head; nothing is written anywhere."
            "CAMERA: a warm CLOSE three-shot, the three faces near together and level in the frame, the lane soft behind. NOT a wide of the lane."
        ),
    },
]
...
PLACE_REFS = {
    "JAMES-ROOM": "PLACE-REF/james-room.jpeg",  # build-190-faith-without-works s01-james-writes (manual)
    "JERICHO-WINDOW": "PLACE-REF/jericho-window.jpeg",  # build-190-faith-without-works s08-rahab-hides-the-spies (manual)
    "MORIAH-ALTAR": "PLACE-REF/moriah-altar.jpeg",  # build-190-faith-without-works s06-abraham-obeys (manual)
    "TOWN-DOORWAY": "PLACE-REF/town-doorway.jpeg",  # build-190-faith-without-works s03-no-clothes-no-food (manual)
}
# === end PLACE-PLATES ===

# Image REFS wired 2026-08-24: v2_story_cast generated these five portraits after
# this map was authored but left REFS empty, so the first pass generated unanchored
# and the BELIEVER drifted in b02 (rubric lesson 2 — a text lock alone is not enough).
# Jesus does not appear in this row (every beat jesus=False); no one wears cream or white.
REFS = {
    "JAMES": "CAST-REF-V2/james.jpeg",
    "BELIEVER": "CAST-REF-V2/believer.jpeg",
    "ABRAHAM": "CAST-REF-V2/abraham.jpeg",
    "ISAAC": "CAST-REF-V2/isaac.jpeg",
    "RAHAB": "CAST-REF-V2/rahab.jpeg",
}
