...
PLACE_REFS = {
    "CAMP": "PLACE-REF/camp.jpeg",  # build-114-abraham-sodom s01-in-the-heat-of-the (manual)
    "HEIGHT": "PLACE-REF/height.jpeg",  # build-114-abraham-sodom s05-for-those-cities-had-grown (manual)
}
# === end PLACE-PLATES ===
