# QC / RUNNER HANDOFF — build-114-abraham-sodom (Genesis 18)

Lesson-12 + complaint-corpus pass done 2026-08-05 (Machine A). `--check`
PASSES, zero WARNs. 23 beats, ~130 s.

## ⚑ ONE PARKED DOCTRINE QUESTION FOR CAMERON (everything else is done)

Genesis 18's LORD appears among the THREE TRAVELERS and negotiates
face-to-face ("Abraham stood yet before the LORD"). Your row-113 order
gives God a body and a locked look. This build currently renders the
negotiation partner as warm presence-light (the pre-113 approach).
QUESTION: should the LORD here be EMBODIED as the third traveler —
and if so, with the new Father-canon face, or (per the Jehovah-is-
Christ reading) another treatment? One word from you re-authors the
plea beats; the row is buildable as-is meanwhile.

## Coverage shape

Three true wides with stated geometry: b01 (the noon appearing at the
oak in profile), b06 (the parting — camera behind Abraham's shoulder
as the two descend away: the row's hinge geometry), b15 (mercy's
compass — height and plain from the side). Nine flips including THREE
person-free/person-light frames (b05 far cities, b20 ridge presence,
b23 empty ridge) and four lone-Abraham beats.

## Laws

- ABRAHAM: ~99, great white beard per lock — face/beard-board across
  ~16 frames.
- THE THREE travelers: dignified robed men, distinct; feet washed,
  fed under the oak (the hospitality is the doorway to everything).
- The negotiation LADDER (50→45→40→30→20→10) rides Abraham's counting
  fingers and deepening boldness-with-reverence — the numbers must
  never appear as text.
- SODOM is never shown close and NEVER burning — the heavy-clouded
  far plain only (content-care; this row is the PLEA, not the
  destruction).
