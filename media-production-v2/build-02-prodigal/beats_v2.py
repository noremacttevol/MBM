...
BEATS = [
    ...
    },
    {
        ...
        "scene": (
            ...
            "the road ahead of him the younger son is SEEN FROM DIRECTLY BEHIND — "
            "the back of his head, the back of his shoulders and his heels toward "
            "the camera, HIS FACE ENTIRELY HIDDEN FROM US because he is facing away "
            "up the road, walking off into the distance and never once looking "
            "back. He is already small with "
    ...
    },
    {
        ...
        "scene": (
            ...
            "sharp and grainy with dust, absolutely not an illustration or a "
            "rendering. The father is in full run, his "
            ...
            "mid-stride with both feet clear of the ground. FAR AHEAD OF HIM DOWN "
            "THE SAME ROAD, small with distance and squarely IN THE DIRECTION HE IS "
            "RUNNING, the tiny ragged figure of his son comes up the road toward "
            "him. The two of them are closing the same stretch of road, and we are "
            "watching over the father's shoulder as the gap shrinks. Golden "
    ...
    },
    {
        ...
        "scene": (
            "On the open road in golden late-afternoon light, NEITHER MAN LOOKING "
            "AT THE CAMERA — this is a collision, not a posed portrait. The father "
            "has COLLAPSED FORWARD INTO HIS SON, both arms wrapped right around "
            "the young man's back and locked there, pulling him hard "
            "against his chest so the two are pressed chest to chest, his "
            "silver-grey head buried down against the boy's filthy "
            "shoulder, his face hidden in the ragged cloth and his "
            "eyes squeezed shut — and over the father's shoulder the son's gaunt "
    ...
    },
    {
        ...
        "scene": (
            ...
            "dark between them. Warm torchlight on real weathered skin, real "
            "grey beard hair and real coarse wool, photographed on location with a "
            "real camera — absolutely not an illustration, not a render, not a "
            "digital painting. Exactly two people are in the frame; each has two "
