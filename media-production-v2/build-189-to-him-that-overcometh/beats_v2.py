...
PLACE_REFS = {
    "DOOR-NIGHT": "PLACE-REF/door-night.jpeg",  # build-189-to-him-that-overcometh s01-the-drowsy-house (manual)
    "LAMPLIT-ROOM": "PLACE-REF/lamplit-room.jpeg",  # build-189-to-him-that-overcometh s04-any-man-hear-his-voice (manual)
    "THRONE-GLORY": "PLACE-REF/throne-glory.jpeg",  # build-189-to-him-that-overcometh s11-not-by-being-flawless (manual)
}
# === end PLACE-PLATES ===
