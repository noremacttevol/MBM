...
BEATS = [
    ...
    },
    {
        ...
        "scene": (
            ...
            "the back of one head-cloth and one russet shoulder fill the near left, "
            "out of focus, and NOT ONE FACE IS TURNED TOWARD THE LENS. Beyond them "
    ...
    },
    {
        ...
        "scene": (
            ...
            "grit of the road, and the clean leather sandal and dust-free ankle "
            "stepping through beneath it. The hand and the hem are sharp; his body "
    ...
    },
    {
        ...
        "scene": (
            ...
            "dirt already ground into the wool at his shins. He is leaning in and "
    ...
    },
    {
        ...
        "must_show": "Jesus's face, close and still, in the quiet beat after the answer — the argument is over and he has not raised his voice once.",
        ...
        "scene": (
            "One photograph, 135mm lens at f/2, extremely shallow depth of field, "
            "late afternoon, fine grain. Very close on Jesus — brow to beard, filling "
            "the frame, turned slightly to his own right. He is still and quiet in "
            "the beat after an answer he already knew was coming: his mouth closed "
            "and relaxed, no smile, no triumph, just steadiness and a warmth that "
            "does not press. His eyes are lifted and go up and out through the UPPER "
            "RIGHT of the frame toward the standing man, well clear of the camera "
            "axis. Low warm sun comes in from the right and crosses the bridge of his "
            "nose, the near cheekbone and the edge of his dark beard, leaving the far "
            "side of his face in soft shadow; the light lands on him and nothing at "
            "all comes off him, and there is nothing around his head or hair but "
            "ordinary air. Everything behind him is an unreadable warm wash of dust and olive "
            "green."
        ),
    },
    {
