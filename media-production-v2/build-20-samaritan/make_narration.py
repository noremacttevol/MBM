...
SEGMENTS = [
    ...
    ("n12", NARRATOR, "He did not just help and move on. He tied his own name to a stranger's recovery."),
    ...
    ("n14", NARRATOR, 'The scholar could not even bring himself to name the Samaritan. But he had understood the point: neighbor is not a category to define; it is mercy given to the person in front of you.'),
    ("j2", JESUS, 'Go, and do thou likewise.'),
    ("n15", NARRATOR, 'The lesson ends in motion, not admiration. Mercy is something to practice. That is how good he is. He will not even let you keep score.'),
