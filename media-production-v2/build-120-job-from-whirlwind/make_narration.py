...
SEGMENTS = [
    ...
    ("n5b", NARRATOR, "That is a man in the ashes with nothing left, saying it out loud. He does not understand a thing that is happening to him, and he still knows who is coming."),
    ...
    ("n6b", NARRATOR, "It sounds like a rebuke, and it is not. God is doing something gentler than that. He is taking a man who has shrunk down to the size of his own pain, and slowly widening the room."),
    # Job 38:7
    ("jv387", GOD, "When the morning stars sang together, and all the sons of God shouted for joy."),
    ("n7a", NARRATOR, "That is God describing the day the world was made — and it is not a lecture about power. It is a memory, and it is full of gladness."),
    # Job 38:31
