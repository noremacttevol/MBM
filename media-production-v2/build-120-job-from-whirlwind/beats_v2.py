...
PLACE_REFS = {
    "ASHES": "PLACE-REF/ashes.jpeg",  # build-120-job-from-whirlwind s10-he-is-wrecked-and-still (manual)
    "WHIRLWIND": "PLACE-REF/whirlwind.jpeg",  # build-120-job-from-whirlwind s20-and-god-answered-though-not (manual)
}
# === end PLACE-PLATES ===
