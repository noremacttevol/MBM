...
PLACE_REFS = {
    "GATHERING-ROADS": "PLACE-REF/gathering-roads.jpeg",  # build-198-ensign-for-the-nations s05-the-second-time (manual)
    "HOMELAND": "PLACE-REF/homeland.jpeg",  # build-198-ensign-for-the-nations s12-come-home (manual)
    "ISAIAH-HEIGHT": "PLACE-REF/isaiah-height.jpeg",  # build-198-ensign-for-the-nations s01-isaiah-points-ahead (manual)
}
# === end PLACE-PLATES ===
