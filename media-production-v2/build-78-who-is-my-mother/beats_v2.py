...
BEATS = [
    {
        ...
        "scene": (
            "The one-room house is full to its walls, the camera "
            "low behind the seated ring's near backs, packed to its "
    ...
    },
    {
        ...
        "scene": (
            "In the hard bright street, the camera across the lane "
            "taking family and doorway from the side, the family "
    ...
    },
    {
        ...
        "window": "9.44-18.16", "wide": False, "jesus": True, "ref": REF,
        "locks": ["HOUSE"],
        "narration": (
    ...
    },
    {
        ...
        "window": "23.30-28.96", "wide": False, "jesus": True, "ref": REF,
        "locks": ["HOUSE"],
        "narration": (
    ...
    },
    {
        ...
        "scene": (
            "The camera sits just behind two seated shoulders as "
    ...
    },
    {
        ...
        "window": "46.72-48.90", "wide": False, "jesus": True, "ref": REF,
        "locks": ["HOUSE"],
    ...
    },
    {
        ...
        "scene": (
            "The closing frame holds the whole room, the camera "
            "high in the corner behind the outer ring: "
...
PLACE_REFS = {
    "HOUSE": "PLACE-REF/house.jpeg",  # build-78-who-is-my-mother s01-jesus-was-inside-a-packed (manual)
}
# === end PLACE-PLATES ===
...
REFS = {
    "MOTHER": "CAST-REF-V2/mother.jpeg",
    "BROTHERS": "CAST-REF-V2/brothers.jpeg",
}
