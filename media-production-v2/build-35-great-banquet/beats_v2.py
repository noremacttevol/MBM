...
LOCKS = {
    ...
    "POOR": (
        ...
        "few have worn leather sandals. WHERE THE NARRATION NAMES THEM: a LAME man "
        "leans his weight on ONE forked crutch cut from a single natural branch, "
        "padded with folded cloth under the arm, or on ONE hand-hewn wooden staff; "
    ...
    "HOUSE": (
        ...
        "curtained with dark cloth, leads into the dining chamber. Everything is "
    ...
    "TOWN-LANES": (
        ...
        "panels of dark woven cloth. THERE IS NOTHING BUILT OR FITTED THAT IS NOT "
...
BEATS = [
    ...
    },
    {
        ...
        "scene": (
            "One photograph, 50mm lens, deep blue night and the ONLY light ONE "
            "shallow fired-clay oil lamp with a single small bare-wick flame "
            "standing LOW ON A STONE STEP in the near foreground, below both men's "
            "chins and nearer the camera than either head, throwing its light "
            "UPWARD AND FORWARD onto the fronts of their bodies while every crown, "
            "back of head and shoulder stays UNLIT AND DARK. NO LIGHT SOURCE "
            "STANDS BEHIND, ABOVE OR BEYOND ANY HEAD and there is no rim, outline "
            "or corona on anybody. Fine film grain. THE CAMERA STANDS BEHIND AND "
            "ABOVE THE TWO MEN AND SHOOTS DOWN AND PAST THEM along the lane, so "
            "both are seen from behind and in three-quarter from behind and a gaze "
            "into the lens is geometrically impossible. THERE ARE EXACTLY TWO "
            "PEOPLE IN THIS PICTURE and no third. Nearest the camera a LAME man of "
            "about forty-five stands with his weight visibly thrown onto ONE "
            "FORKED CRUTCH CUT FROM A SINGLE NATURAL BRANCH, its fork padded with "
            "folded dark cloth under his right armpit, his right leg turned out "
            "and not bearing, his patched deep rust tunic hanging crooked because "
            "of it; his head is turned away down the lane. Beside him a BLIND man "
            "of about fifty in ONE dark olive tunic stands with his face lifted "
            "and aimed slightly up and away past the lamp, his clouded pale "
            "unfocused eyes plainly not looking at anything, ONE hand resting on "
            "the lame man's near shoulder and the other out ahead of him reading "
            "the air. BOTH ARE DIGNIFIED AND HUMAN, never grotesque, comic or "
            "pitiable, and there is no metal crutch, walking frame, wheelchair, "
            "prosthesis or white bandage anywhere. NOT ONE FACE IS TURNED TOWARD "
            "THE LENS."
        ),
    },
    ...
    },
    {
        ...
        "scene": (
            ...
            "ON THE TABLE ITSELF and on a low stone ledge, all of them below every "
            "chin in the room and nearer the camera than the heads beyond them, so "
            "the light travels UPWARD AND FORWARD onto faces, hands and the front "
            "of the table while every crown, back of head and shoulder stays UNLIT "
            "AND DARK and the corners of the room fall away to near black. NO "
            "LIGHT SOURCE STANDS BEHIND, ABOVE OR BEYOND ANY HEAD; no rim, "
            "outline, corona on anybody. Fine film grain, deep focus. THE "
            "CAMERA STANDS HIGH IN THE CORNER OF THE ROOM BEHIND AND ABOVE THE LOW "
            "TABLE AND LOOKS DOWN AND ACROSS TOWARD THE OPENING, so the nearest "
            "figures are seen from behind and above and NOT ONE FACE IS TURNED "
            "TOWARD THE LENS. In the opening at the far side FOUR of the poor have "
            "just come in and stopped — seen in three-quarter from the side, faces "
            "lit from below, all four looking at the laid table and not at each "
            "other, mouths open, one with a hand halfway to her own mouth. Their "
            "expressions are ASTONISHMENT AND DISBELIEF, not fear or shame. At the "
            "LEFT the host stands in three-quarter from behind with BOTH ARMS OPEN "
            "AND LOW, palms up and out toward them, plainly welcoming and touching "
            "nobody; his greying dark brown hair shows at the nape above his deep "
            "indigo mantle. At the RIGHT the servant is half-turned away, one hand "
            "pointing down at the made-up reclining places. THIS IS A WIDE "
            "FULL-LENGTH SCENE: the whole KNEE-HIGH U-shaped table, the food, the "
            "bolsters and all six people are in frame together under the rough "
            "hewn beams."
        ),
    },
    {
