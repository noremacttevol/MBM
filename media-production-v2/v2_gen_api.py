...
PLACE_LOCK_TEXT = (
    ...
    "In particular the TOP EDGE of every wall and building runs against the sky "
    "exactly as it runs in the place photograph(s) — the same straight unbroken "
    "line, with NOTHING added along it: no notch, tooth, gap, step, battlement, "
    "parapet, cornice, column, colonnade, roofline or structure that the place "
