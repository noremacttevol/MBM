...
BEATS = [
    ...
    },
    {
        ...
        "must_show": "the obedience — Jonah a SMALL mid-distance figure, no larger than any townsperson near him, walking away toward the colossal winged-bull gate; one man swallowed by the city's vastness, one consistent human scale for everyone.",
        "must_not_show": "Jonah drawn larger than the people around him; any giant, oversized or hero-scale foreground figure looming over the crowd; inconsistent figure scale where the townsfolk beside or near him are dwarfed by one man.",
        "scene": (
            "This time the feet obey. "
            "The camera is high and "
            "well back, looking down "
            "over the whole gate "
            "plaza, so the reluctant "
            "Hebrew is a SMALL "
            "mid-distance figure "
            "walking away from us "
            "toward the winged-bull "
            "gate — the shot taken from "
            "behind and above him, his "
            "back to us, "
            "deep enough in the scene "
            "that the ordinary "
            "townsfolk nearest the "
            "camera are drawn LARGER "
            "than he is, and the "
            "people standing at his "
            "own depth are exactly his "
            "height. He is one stocky "
            "sea-green figure among "
            "many, in no way bigger "
            "than the men and women "
            "around him: same body "
            "scale, same head size, "
            "dwarfed by the "
            "five-man-high carved "
            "bulls of the great gate "
            "and swallowed by streets "
            "wide as rivers and crowds "
            "thick as harvest — the "
            "empire's capital roaring "
            "around one man with one "
            "sentence to say. He "
            "squares his shoulders and "
            "walks on into it. Every "
            "person in the frame is "
            "drawn at a consistent "
            "human scale that shrinks "
            "smoothly with distance; "
            "no single figure looms "
            "out of proportion to "
            "those beside him. Every "
            "figure has two arms, two "
            "hands and one head."
        ),
    },
    ...
    },
    {
        ...
        "must_show": "SCRIPTURE-EXACT: the city-wide turning — the great square at warm dusk: the king down off his throne-litter in sackcloth among his people, rich and poor alike in rough cloth; LIVING people with warm natural skin, breathing and weeping in honest sorrow, ash smudged on cloth and brow only.",
        "must_not_show": "grey, ashen, or corpse-like skin; people who look dead, lifeless, statue-like or asleep; ash covering the skin into a grey pallor; a field of motionless identical bowed figures with no sign of life; groveling spectacle.",
        "scene": (
            "The whole empire's capital "
            "kneels in rough cloth — the "
            "camera high past a thousand "
            "kneeling backs, the great "
            "square at warm dusk filled "
            "edge to edge with LIVING "
            "people: warm human skin "
            "tones, faces flushed and "
            "tear-streaked, chests "
            "breathing, some heads "
            "bowed, some lifted and "
            "weeping, some with open "
            "hands raised, children "
            "pressed against their "
            "mothers — grief that is "
            "plainly alive, never still "
            "or frozen. At its center "
            "the king himself, down off "
            "his gilded litter, crown "
            "set aside, sackcloth on "
            "his own shoulders among "
            "the porters and beggars "
            "wearing the same — rich "
            "robes traded for haircloth "
            "across a hundred thousand "
            "backs, fasting posted at "
            "every door. A little grey "
            "ash is smudged on "
            "foreheads and dusted on "
            "the cloth only; it never "
            "greys or deadens the skin, "
            "which stays warm and "
            "living. Rising off all of "
            "it, the one sound heaven "
            "bends closest for: honest "
            "sorrow, asking for what it "
            "knows it has not earned. "
            "Every figure has two arms, "
            "two hands and one head."
        ),
    },
...
PLACE_REFS = {
    "FISH": "PLACE-REF/fish.jpeg",  # build-118-jonah-god-who-relents s18-instead-god-sent-a-great (manual)
    "HILL": "PLACE-REF/hill.jpeg",  # build-118-jonah-god-who-relents s37-and-jonah-watching-from-a (manual)
    "NINEVEH": "PLACE-REF/nineveh.jpeg",  # build-118-jonah-god-who-relents s02-he-was-to-go-to (manual)
    "SHIP": "PLACE-REF/ship.jpeg",  # build-118-jonah-god-who-relents s08-he-found-a-ship-going (manual)
}
# === end PLACE-PLATES ===
