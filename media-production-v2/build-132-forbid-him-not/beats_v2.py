...
PLACE_REFS = {
    "CAMP": "PLACE-REF/camp.jpeg",  # build-132-forbid-him-not s02-john-came-to-jesus-with (manual)
    "STREET": "PLACE-REF/street.jpeg",  # build-132-forbid-him-not s03-seen-someone-driving-out-demons (manual)
}
# === end PLACE-PLATES ===
...
REFS = {
    "STRANGER": "CAST-REF-V2/stranger.jpeg",
}
