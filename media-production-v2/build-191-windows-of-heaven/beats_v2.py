...
PLACE_REFS = {
    "HARVEST-LAND": "PLACE-REF/harvest-land.jpeg",  # build-191-windows-of-heaven s08-windows-of-heaven (manual)
    "STOREHOUSE": "PLACE-REF/storehouse.jpeg",  # build-191-windows-of-heaven s01-storehouse-at-dawn (manual)
}
# === end PLACE-PLATES ===
