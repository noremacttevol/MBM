...
PLACE_REFS = {
    "BAPTISM-WATER": "PLACE-REF/baptism-water.jpeg",  # build-44-pentecost s22-three-thousand-baptized (manual)
    "JERUSALEM-COURT": "PLACE-REF/jerusalem-court.jpeg",  # build-44-pentecost s08-a-crowd-gathered-amazed (manual)
    "UPPER-ROOM": "PLACE-REF/upper-room.jpeg",  # build-44-pentecost s01-gathered-waiting-in-the-upper-room (manual)
}
# === end PLACE-PLATES ===
