"""QC mirror of the authoritative row-44 Pentecost narration.

The audio files remain authoritative in media-production/build-44-pentecost/audio.
This dependency-free mirror lets the project QC gate compare the V2 cut against the
same 11 spoken segments without importing or regenerating any TTS.
"""
