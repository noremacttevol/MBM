...
BEATS = [
    ...
    },
    {
        ...
        "scene": (
            ...
            "CAMERA: a CLOSE three-quarter on Joel's weathered face, the height falling away soft behind him. NOT the establishing wide of b01."
        ),
    },
    {
    ...
    },
    {
        ...
        "scene": (
            ...
            "CAMERA: a SIDE-ON two-shot at eye level, both faces in profile turned toward each other. NOT the street wide of b03."
        ),
    },
    {
        ...
        "scene": (
            ...
            "vision."
            "CAMERA: a LOW close from below, the seated old man's lifted face against the bright sky. NOT an eye-level portrait."
        ),
    },
    {
        ...
        "scene": (
            ...
            "floating apparition."
            "CAMERA: a TIGHT frontal close, the young man's eyes filling the upper frame, street soft behind. NOT a low or profile angle."
        ),
    },
    {
        ...
        "scene": (
            ...
            "divine figure."
            "CAMERA: a CLOSE at working height with the bondservant's hands and load in the near foreground, his alight face above. NOT a face-only portrait."
        ),
    },
    {
        ...
        "scene": (
            ...
            "CAMERA: a close PROFILE of the maidservant from her left, doorway light raking across her. NOT a frontal close."
        ),
    },
    {
        ...
        "scene": (
            ...
            "nothing is written anywhere; no divine figure."
            "CAMERA: a WIDE from BEHIND a foreground shoulder looking down the whole street, many small figures along it. NOT a close or two-shot."
        ),
    },
    {
    ...
    },
    {
        ...
        "scene": (
            ...
            "nothing is written anywhere; no divine figure."
            "CAMERA: a TIGHT close among the crowd — three or four faces of different nations filling the frame from edge to edge, so near that no square, no buildings and no sky are visible at all. NOT the square wide of b10, and not a view showing the whole crowd."
        ),
    },
    {
        ...
        "scene": (
            ...
            "CAMERA: a CLOSE two-shot at the square's edge, two ordinary faces near and level, the crowd a blur beyond. NOT a crowd shot."
        ),
    },
    {
        ...
        "scene": (
            ...
            "CAMERA: a HIGH closing wide looking down over the whole open square. NOT an eye-level wide."
        ),
    },
]
...
PLACE_REFS = {
    "JERUSALEM-PENTECOST": "PLACE-REF/jerusalem-pentecost.jpeg",  # build-197-sons-and-daughters-prophesy s10-peter-stands (manual)
    "JOEL-HEIGHT": "PLACE-REF/joel-height.jpeg",  # build-197-sons-and-daughters-prophesy s01-joel-names-the-future (manual)
    "PEOPLE-STREET": "PLACE-REF/people-street.jpeg",  # build-197-sons-and-daughters-prophesy s03-pour-out-on-all-flesh (manual)
}
# === end PLACE-PLATES ===
...
REFS = {
    "JOEL": "CAST-REF-V2/joel.jpeg",
    "ALL-FLESH": "CAST-REF-V2/all-flesh.jpeg",
}
