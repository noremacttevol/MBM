...
LOCKS = {
    ...
    "MAN": (
        ...
        "clothing. He is NEVER dressed in cream, off-white, white, ivory, ecru, "
    ...
    "OWNER": (
        ...
        "dark leather sandals. He is NEVER dressed in cream, off-white, white, ivory, "
    ...
    "FIELD": (
        ...
        "along its walls, or against the sky."
    ),
    "YARD": (
...
BEATS = [
    ...
    },
    {
        ...
        "scene": (
            ...
            "THE CAMERA IS SET LOW ON THE FIELD FLOOR ACROSS THE HOLE FROM HIM AND "
            "WELL TO HIS LEFT, LOOKING SLIGHTLY UP AT HIM IN THREE-QUARTER VIEW. HIS "
            "GAZE HAS A NAMED TARGET INSIDE THE PICTURE: the spilled silver at the "
            "bottom of the hole in the near lower right of the frame, so his head is "
            "bowed and turned down and to his own right and his eyeline leaves the "
            "frame through the BOTTOM RIGHT CORNER, far below and to the side of the "
            "lens. He fills the frame from the chest up and he is the only person in "
    ...
    },
    {
        ...
        "must_not_show": "no Jesus in this frame; no olive grove and no dappled light; no midday overhead glare; no third person anywhere in the frame; no coins, no purse, no clay jar, no gold and no treasure of any kind visible in this frame; no wide view of the whole valley and no view down from the ridge; no cream, off-white, ivory, beige or pale garment on either man; neither man's pupils centred on the lens.",
        "scene": (
            ...
            "CAMERA STANDS INSIDE THE FIELD BESIDE THE LABOURER AND WELL TO HIS LEFT, "
            "LOOKING ACROSS THE WALL AT THE OWNER IN THREE-QUARTER VIEW. THE OWNER'S "
            "GAZE HAS A NAMED TARGET INSIDE THE PICTURE: the labourer's face at the "
            "near right edge of the frame, so his eyeline runs horizontally across the "
            "picture to the right and exits through the RIGHT EDGE, at right angles to "
            "the camera. Sharp and filling the frame from the chest up is the owner — "
            ...
            "wears a DEEP INDIGO wool tunic with the sleeves down to the wrist and a "
            "heavy DARK MADDER-RED mantle over his left shoulder. Along the bottom of "
            ...
            "clasp — the owner's clean uncallused hand and, coming in from the near "
            "right, a hard sun-darkened working hand with a pale old scar across the "
            "back of it and a DARK UMBER-BROWN sleeve. Of the labourer only that hand, "
