...
LOCKS = {
    ...
    "DISCIPLES": (
        ...
        "cloth. EVERY SEPARATE PIECE OF CLOTH ON EVERY DISCIPLE IS A DARK SATURATED "
        "COLOUR — tunic, sleeves, sash, head cloth, and ANY scarf, stole, shawl, "
        "wrap or mantle draped round a neck or over a shoulder is DEEP INDIGO, DARK "
        "UMBER, DARK OLIVE-DRAB, RUSSET-RED or DARK MADDER-BROWN and nothing else. "
        "NOT ONE of them wears cream, off-white, white, ivory, ecru, oatmeal, buff, "
        "sand, khaki, beige, taupe, pale grey or pale linen, and NO DISCIPLE HAS A "
        "PALE OR LIGHT-COLOURED SCARF, STOLE OR SHAWL ROUND HIS NECK OR OVER HIS "
        "SHOULDER, anywhere in the frame, in focus or out of focus, sharp or blurred, "
        "in the foreground or the far background, because any pale cloth on anyone "
        "but Jesus reads as a second, unlocked Jesus and fails the picture. THE ONLY "
...
BEATS = [
    # ================= FRAME — the olive grove, warm low late afternoon ========
    {
        ...
        "scene": (
            ...
            "LENS. THIS IS A WIDE FULL-LENGTH GROUP PHOTOGRAPH AND NOT A PORTRAIT: the "
            "camera is far enough back that Jesus AND at least six seated disciples "
            "are all in the frame together, head to sandals, with the grove and the "
            "dry-stone wall behind them; Jesus occupies only a modest part of the "
            "picture and is never framed from the chest up. EXACTLY TWO out-of-focus "
            "seated BACKS fill the near bottom corners and they are the only "
            "foreground objects: a DEEP INDIGO shouldered back with a dark indigo head "
            "cloth at the near LEFT and a DARK UMBER back with a dark brown head cloth "
            "at the near RIGHT, BOTH OF THEM A SOLID DARK SATURATED MASS FROM EDGE TO "
            "EDGE. THERE IS NO PALE, CREAM, IVORY, BEIGE, TAUPE, BUFF, SAND, KHAKI OR "
            "LIGHT-TAN SHAPE, SHOULDER, BACK, SLEEVE, DRAPE OR BLURRED MASS ANYWHERE "
            "IN THE FOREGROUND OR AT ANY EDGE OF THIS PICTURE, and no standing figure "
            "in a pale garment at the left or right edge — the ONLY pale thing in the "
            "whole frame is the wool of Jesus's own robe. Sharp in the middle distance "
            "Jesus sits on the root "
    ...
    },
    {
        ...
        "must_not_show": "no Jesus in this frame; no olive grove, no olive tree, no trunk and no green foliage; no dappled light; no field, no dry-stone field wall, no chalk bank and no ridge house; no midday overhead glare and no morning light; NO ROOF, ROOF EDGE, EAVE, OVERHANG, RAFTER, THATCH, CORRUGATED SHEET, SKYLINE OR SKY anywhere in this frame; no wide view of the goods laid out in rows on the ground; no sorrow, no reluctance, no backward look and no tears; no steel spade or shovel, no broad flat bright sheet-steel blade, no cleaver, axe-head, chopper, hatchet or machete shape, no wide flat face of metal turned toward the camera, no shine or polish on any iron, no D-handle, no foot tread; no cream, off-white, ivory, beige or pale garment on anybody; his face must not drift into a different man from the reference photograph; his pupils never centred on the lens.",
        "scene": (
            ...
            "FRAME AND TILTED DOWN SO THAT THE ROUGH TAN MUD-BRICK WALL OF THE HUT "
            "FILLS THE WHOLE BACKGROUND BEHIND HIM EDGE TO EDGE: NO ROOF, NO ROOF "
            "EDGE, NO EAVE, NO OVERHANG, NO RAFTER, NO THATCH, NO SKYLINE AND NO SKY "
            "APPEARS ANYWHERE IN THIS PICTURE, and there is no tree, trunk or green "
            "foliage in it either. HIS GAZE HAS A NAMED TARGET INSIDE THE PICTURE: the "
            "neighbour's hands taking the mattock haft at the near left of the frame, "
            "so his head is turned down and to his own left and his eyeline runs "
            "across and out through the LEFT EDGE, well clear of the lens. Sharp and "
            "framed from the chest up is the labourer, WHO IS THE SAME MAN AS THE "
            "ATTACHED REFERENCE PHOTOGRAPH — the identical face, the identical "
            "features, the identical build — a lean hard-shouldered working man of "
            "about thirty with deeply sun-darkened olive-brown skin, a NARROW "
            "weathered face with a STRONG STRAIGHT NOSE, a short-cropped BLACK beard, "
            "close-cut black hair under a DARK RUSSET-RED head cloth, quick dark brown "
            "eyes under heavy black brows, wearing the DARK UMBER-BROWN coarse wool "
            "tunic with sleeves above the elbow and the DARK RUSSET-RED patch at one "
            "shoulder. THE MATTOCK IN HIS HANDS IS THE SAME ONE HE HAS USED ALL "
            "THROUGH, AND IT IS HELD EDGE-ON TO THE CAMERA SO THAT ITS IRON READS AS A "
            "NARROW DARK LINE AND NEVER AS A FLAT FACE: mostly what is in frame is "
            "the long straight rough-hewn unpainted wooden HAFT passing between their "
            "hands, with only the small dark head of the tool showing at the top edge "
            "of the picture, turned sideways, its iron NARROW, SHORT, DARK GREY, "
            "RUSTED, PITTED and hammer-marked with no shine on it at all. THE IRON IS "
            "NOT A BROAD FLAT PLATE: it is never a wide bright pressed sheet-steel "
            "blade, never a polished cleaver, axe-head, chopper, machete or hatchet "
            "shape, never a shovel, and no flat face of metal is ever turned toward "
            "the camera. HIS EXPRESSION IS "
    ...
    },
    {
        ...
        "scene": (
            ...
            "still in its hollows. ITS FACE CARRIES NO WRITING OF ANY KIND: no letters, "
            "no inscription running round the rim, no legend, no numerals, no date and "
            "NO PORTRAIT HEAD OR PROFILE OF A PERSON — only one worn, shallow, "
            "off-centre blob of a shape struck unevenly into soft metal, half of it "
            "flattened away, and the blank of the flan showing around it. Its edge is "
            "irregular and slightly lumpy, never a true circle. It does not shine, "
            "sparkle or give off any light. "
