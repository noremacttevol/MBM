...
# STALE-V1-FINAL fix (AUDIO-FIX 2026-08-06, Machine A): all 9 narration mp3s are
# newer than the V1 mp4 (recency gate fails) and |Δ|>1.0, so the packet-copy AUDIO
# LOCK would ship stale voices. Rebuild from this build's own 9 mp3 segments — $0.
...
PLACE_REFS = {
    "YARD": "PLACE-REF/yard.jpeg",  # build-92-peters-denial s01-after-they-arrested-jesus-peter (manual)
}
# === end PLACE-PLATES ===
