...
SEGMENTS = [
    ...
    ("n2", NARRATOR, "It was Simon Peter, the fisherman, who answered for them all. And Jesus told him that flesh and blood had not revealed that to him; his Father in heaven had."),
