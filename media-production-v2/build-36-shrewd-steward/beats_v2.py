...
LOCKS = {
    ...
    "STEWARD": (
        ...
        "no blood, no bandage, no glow and no light of any kind coming off "
        "him. IDENTITY FLOOR, WHICH HOLDS EVEN WHEN HE IS SMALL, DISTANT, "
        "PARTLY CROPPED, SOFTLY OUT OF FOCUS OR SEEN ENTIRELY FROM BEHIND, "
        "BECAUSE HE WAS ONCE DRAWN AS A PALE EUROPEAN BOY IN A GREY CLOAK AND "
        "HAD TO BE RESHOT: he is a MAN OF ABOUT FORTY, adult and full-grown, "
        "never a youth, a boy, a teenager or a servant lad; his SKIN IS WARM "
        "OLIVE-BROWN AND CLEARLY MIDDLE EASTERN, never fair, never pale, never "
        "pink, never European-looking; he ALWAYS HAS HIS SHORT NEAT DARK BROWN "
        "BEARD and is never clean-shaven; his hair is THICK DARK BROWN, "
        "straight, pushed back and cut to just below the ears, never "
        "short-cropped schoolboy hair and never blond, ginger or grey; and he "
        "is ALWAYS in his DARK OLIVE ankle-length tunic with the CHARCOAL "
        "mantle and the DEEP RUST waist sash, never in a plain grey cloak, "
        "never in a hooded cape and never bare-armed in a short tunic."
    ),
    "MASTER": (
    ...
    "DISCIPLES": (
        ...
        "Jesus and fails the picture. THE NECK AND SHOULDERS OF EVERY LISTENER "
        "ARE STATED POSITIVELY, BECAUSE PALE SCARVES KEEP APPEARING THERE AND "
        "HAD TO BE RESHOT: each man wears ONE dark tunic AND NOTHING ELSE "
        "ABOVE THE WAIST — its neckline is a plain cut slit or a plain round "
        "opening in the same dark cloth, and above that opening his BARE "
        "SUN-DARKENED OLIVE-BROWN NECK, THROAT AND COLLARBONE ARE VISIBLE "
        "AGAINST HIS OWN DARK CLOTH. THERE IS NO SCARF, NECKERCHIEF, MUFFLER, "
        "STOLE, WRAP, COWL, HOOD, COLLAR, TRIM, BAND, EDGING OR SECOND PIECE "
        "OF CLOTH OF ANY COLOUR ROUND ANY LISTENER'S NECK OR OVER ANY "
        "LISTENER'S SHOULDERS, and least of all a pale, tan, buff, sand, "
        "oatmeal, khaki, cream or light grey one — not on the near men in the "
        "foreground, not on the far men, not in focus and not blurred. THE "
        "ONLY PALE WOOL IN ANY ROOFTOP PICTURE "
...
LOCKS.update({
    ...
    "ESTATE": (
        "ESTATE-YARD LOCK. FIRST AND MOST IMPORTANT, BECAUSE A DOOR ALREADY "
        "APPEARED HERE ONCE AND HAD TO BE RESHOT: EVERY SINGLE OPENING IN "
        "EVERY WALL OF THIS ESTATE — every doorway, every window, every "
        "passage, near or far, sharp or blurred, in the foreground or the "
        "background — IS EITHER (A) A COMPLETELY EMPTY RECTANGULAR GAP IN "
        "THE STONE OR MUD BRICK WITH ABSOLUTELY NOTHING IN IT, so the "
        "viewer simply sees straight through it or into darkness, OR (B) "
        "closed by ONE heavy hanging panel of coarse undyed goat-hair cloth "
        "in near-black charcoal, knotted back against one jamb. THERE IS NO "
        "DOOR LEAF ANYWHERE IN THIS PICTURE: no planked, boarded, battened, "
        "panelled or framed door standing open, standing shut or leaning "
        "anywhere; no door on a pivot; no hinge, strap hinge, pintle, iron "
        "band, nail head, ring, pull, handle, latch, hasp, bolt, lock plate "
        "or padlock on any opening; and no timber frame, jamb lining, "
        "threshold board or sawn architrave around any opening — the stone "
        "and mud brick simply stop at the edge of the hole. "
        "The rich man's house is a well-off first-century "
...
BEATS = [
    ...
    # ========== j0 — Luke 16:1b, JESUS speaking (RED) =========================
    {
        ...
        "scene": (
            ...
            "both men are visible head to sandals. THE BACKGROUND OF THIS "
            "FRAME IS RE-STAGED AND CONTAINS NO OPENING AT ALL, BECAUSE A "
            "TIMBER GATE KEPT APPEARING IN IT AND HAD TO BE RESHOT TWICE: "
            "behind the two men there is ONE UNBROKEN BLANK WALL of dressed "
            "limestone below and pale tan mud plaster above, running "
            "continuously from the LEFT edge of the frame to the RIGHT edge "
            "with NO gateway, doorway, window, passage, arch, gap, hole or "
            "opening of any kind in it anywhere, and therefore NO door, gate, "
            "leaf, plank, board, batten, frame, jamb, hinge or fitting "
            "anywhere in the picture. Against that blank wall stand the row "
            "of great fired-clay jars sunk to the shoulder in the shaded "
            "earth, the fig tree throwing hard shade at the LEFT corner, and "
            "ONE donkey tethered to a plain wooden peg driven into the "
            "ground. THE STEWARD IS A FORTY-YEAR-OLD JUDEAN MAN with warm "
            "olive-brown Middle Eastern skin, a short neat dark brown beard "
            "and thick dark brown hair — a grown bearded man, never a youth "
            "and never pale-skinned or European-looking."
        ),
    },
    {
...
BEATS += [
    ...
    # ========== n6 — the wheat bill ===========================================
    {
        ...
        "scene": (
            ...
            "slighter stands the steward — a FORTY-YEAR-OLD JUDEAN MAN with "
            "WARM OLIVE-BROWN MIDDLE EASTERN SKIN, a SHORT NEAT DARK BROWN "
            "BEARD along his jaw and THICK STRAIGHT DARK BROWN HAIR pushed "
            "back off the crown and cut to just below the ears, clearly "
            "visible at the crown, the temple and the nape, wearing his "
            "ankle-length DARK OLIVE tunic, his CHARCOAL mantle down his "
            "back and his DEEP RUST waist sash. He is plainly a grown "
            "bearded man and NOT a youth, a boy or a pale-skinned European. "
            "His head is turned toward the farmer. Between and behind them "
...
BEATS += [
    ...
    },
    {
        ...
        "scene": (
            ...
            "mid-fall with a hint of honest motion blur. BOTH SLEEVES IN THIS "
            "FRAME — the near one at the top LEFT closest to the camera and "
            "the far one at the RIGHT — READ UNMISTAKABLY AS COARSE "
            "HAND-WOVEN WOOL AT THIS DISTANCE: a flat, thin, matte cloth with "
            "a plainly visible slightly irregular over-and-under grid of warp "
            "and weft threads and a frayed selvedge cuff, NEVER fluffy, "
            "furry, felted, fleeced, brushed, napped, tufted, looped, "
            "blanket-like or knitted, and with no raised pile anywhere. "
            "Behind the hands, softly out of focus, the pale dust of the "
            "lane. Nothing glitters, "
