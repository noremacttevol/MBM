...
LOCKS = {
    ...
    "PHARISEE": (
        ...
        "in DARK BLUE-BLACK, draped over both shoulders and carried over the "
        "left forearm, its four corners each finished with ONE short twisted "
        ...
        "into rage, scorn or comedy. IDENTITY FLOOR, WHICH HOLDS EVEN WHEN HE "
    ...
    "PUBLICAN": (
        ...
        "and at the very end of the story a stunned, careful relief. IDENTITY "
    ...
    "LISTENERS": (
        ...
        "coat, side-curls or any jewellery. THEY STAND — nobody sits, nobody "
...
BEATS += [
    {
        ...
        "must_show": "The Pharisee alone in his own doorway at first light, face clearly visible in strict side-on profile, calm and disciplined, an untouched bowl of food on the stone ledge beside him.",
        "must_not_show": _NO_HALO + _NO_DEITY + _NO_CREAM_STRICT + _NO_CHURCH + _NO_MOCK + _NO_IRONGATE + _GAZE,
        "scene": (
            "STRICT SIDE-ON PROFILE, STATED FIRST BECAUSE IT GOVERNS THIS "
            "FRAME: the camera stands at a RIGHT ANGLE to the direction he is "
            "facing, so we see the clean edge of his profile against the dark "
            "interior of the doorway — the near cheek, the eyelash line, the "
            ...
            "impossible. "
            "One photograph, 85mm lens at f/2.8, head and shoulders and the top "
            "of his chest only, the plain square-topped door opening behind him "
            "dark and thrown soft. Low horizontal first light of early morning "
            "comes from the LEFT and IN FRONT of him and lands on the front "
            "planes of his face — the brow, the nose, the cheekbone, the combed "
            "beard — while the back and top of his head stay in his own shadow "
            "and read DARKER than the plastered wall; the sun is well out of "
            "frame and there is no light source anywhere behind or above his "
            "head. " + _GRAIN +
            "HE IS A TALL SPARE UPRIGHT JUDEAN MAN OF ABOUT FIFTY with warm "
            "olive-brown Middle Eastern skin, a high clear forehead, a long "
            ...
            "shows at the front edge, the temples and the nape. He wears a DEEP "
            "INDIGO BLUE finely woven wool tunic under a DARK BLUE-BLACK "
            "tasselled mantle with a DARK MADDER RED woven sash. HE IS NOT A "
            "VILLAIN: his face is handsome, composed, serious and completely "
            "untroubled, the eyes bright and steady, nothing sneering or "
            "curling anywhere in it. At the very bottom edge of the frame, "
            "softly out of focus, one shallow fired-clay bowl of barley bread "
            "and olives sits UNTOUCHED on the low stone ledge, exactly as it "
            "was set down. Nothing else is in the frame: no other person, no "
            "shoulder at any edge."
        ),
    },
    {
...
BEATS += [
    {
        ...
        "scene": (
            ...
            "separate counted heaps, one plain open box of pegged adzed planks "
            "with no lid, and one hand-woven reed basket of loose rolled "
            "papyrus sheets. THIS IS A WIDE FULL-LENGTH SCENE AND NOT A "
    ...
    },
    {
        ...
        "scene": (
            ...
            "the jaw set, the eyes lowered into the plain open plank box of "
            "dull coins at the bottom of the frame — a man who knows exactly "
...
BEATS += [
    {
        ...
        "scene": (
            ...
            "nape, DARK BLUE-BLACK tasselled wool across the shoulder. HIS "
