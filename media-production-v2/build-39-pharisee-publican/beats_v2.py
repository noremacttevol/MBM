...
LOCKS = {
    ...
    "PHARISEE": (
        ...
        "into rage, scorn or comedy. " "LIGHT GEOMETRY THAT TRAVELS WITH HIM: every light in every "
    ...
    "PUBLICAN": (
        ...
        "and at the very end of the story a stunned, careful relief. " "LIGHT GEOMETRY THAT TRAVELS WITH HIM: every light in every "
        "picture of this man stands IN FRONT OF HIM AND ON THE CAMERA'S "
        "SIDE OF HIM, never beyond him and never above and behind him. THE "
        "OUTER EDGE OF HIS HAIR, THE TOP OF HIS HEAD, THE LINE OF HIS BEARD "
        "AND THE OUTER EDGE OF HIS SHOULDER ARE ALWAYS DARKER THAN WHATEVER "
    ...
    "LISTENERS": (
        ...
        "coat, side-curls or any jewellery. THEIR NECKS AND THROATS ARE BARE "
        "ABOVE THE TUNIC, STATED POSITIVELY BECAUSE THIS IS WHERE PALE CLOTH "
        "KEEPS ARRIVING: on every one of these men the plain slit neck of the "
        "wool tunic sits straight against bare brown skin and collarbone, and "
        "THERE IS NO SCARF, NECK WRAP, KERCHIEF, STOLE, MUFFLER, SHAWL, "
        "TOWEL, SASH OR CLOTH OF ANY COLOUR WOUND ROUND ANYBODY'S NECK OR "
        "HANGING AROUND ANYBODY'S THROAT — and in particular nothing cream, "
        "off-white, ivory, buff, beige, taupe, sand or pale grey anywhere at "
        "any neck, shoulder, sleeve, hem or edge, in focus or blurred. THE "
        "GROUP IS CAPPED AT EXACTLY FOUR MEN and there is no fifth man, no "
        "extra shoulder, arm, sleeve, head or back at any edge of the frame. THEY STAND — nobody sits, nobody "
