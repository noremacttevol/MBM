...
PLACE_REFS = {
    "COUNCIL-CHAMBER": "PLACE-REF/council-chamber.jpeg",  # promoted from s01 (clean establishing wide)
    "OUTSIDE-WALLS": "PLACE-REF/outside-walls.jpeg",      # wall/gate/ground plate (location only)
}
# === end PLACE-PLATES ===
