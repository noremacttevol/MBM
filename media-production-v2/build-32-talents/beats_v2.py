...
BEATS = [
    ...
    },
    {
        ...
        "scene": (
            ...
            "drawstring PULLED TIGHT AND KNOTTED SHUT at the neck — one, two, three, "
            "four, five. FIVE IS THE TOTAL NUMBER OF BAGS, POUCHES, PURSES OR SACKS "
            "VISIBLE ANYWHERE IN THIS PICTURE: there is no sixth bag, no open bag, no "
            "flattened or empty bag, no spare bag lying on its side, none in the "
            "foreground, none at any edge and none out of focus, and there are NO LOOSE "
            "COINS anywhere on the table — every coin in the scene is inside one of the "
            "five closed bags. At the near right edge, cropped at the "
    ...
    },
    {
        ...
        "must_show": "the master already OUT on the road beyond the gateway with his laden donkeys, all of them seen from directly BEHIND and walking AWAY from the camera into the hills, and the three servants standing in the courtyard watching him go, also seen from behind.",
        "must_not_show": _NO_JESUS + _NO_NIGHT + _NO_HALO + "NOBODY IN THIS PICTURE IS FACING THE CAMERA OR MOVING TOWARD IT — no rider approaching, no animal walking toward the viewer, no face and no chest turned this way, and nobody arriving; no asphalt, kerb, painted line, tyre rut, pole, wire, fence or signpost along the road; no farewell embrace and no crowd; " + _NO_CREAM + _GAZE,
        "scene": (
            ...
            "watching down the road away from the camera. THE THIRD SERVANT'S HEAD IS "
            "NOT BARE OR SHAVEN: he has a thick mop of unkempt dark brown hair grown a "
            "little too long, curling untidily onto the back of his collar. EVERY LIVING "
            "THING IN THIS "
            "PICTURE IS TRAVELLING DIRECTLY AWAY FROM THE CAMERA, INTO THE DEPTH OF THE "
            "FRAME. Framed small and sharp in the gateway opening beyond the servants "
            "and ALREADY WELL OUT ON THE ROAD, the master is seen FROM DIRECTLY BEHIND, "
            "riding away from us: his DEEP FOREST-GREEN back, his OXBLOOD-RED sash and "
            "the back of his greying head are turned to the camera, the donkey's "
            "hindquarters and tail face us, and the two laden pack animals walk behind "
            "him on twisted fibre leads with their rumps toward the camera too. A low "
            "plume of road dust hangs in the air BETWEEN the camera and the animals, "
            "kicked up by hooves that have already passed. The bare packed-earth road "
            "runs off between loose stones into the tan hills with NOTHING LINING IT "
            "ANYWHERE, and the whole train is shrinking into that distance. THE NEAR "
            "FOREGROUND IS THE THREE DARK BACKS THEMSELVES AND THE SUNLIT LIMESTONE "
            "PAVING BETWEEN THEM."
        ),
    },
    # =========================== n3 — the five ==============================
    ...
    },
    {
        ...
        "scene": (
            ...
            "opening with the fingers spread. HIS HEAD IS SEEN FROM BEHIND AND IT IS NOT "
            "A BARE OR SHAVEN HEAD: he has a THICK MOP OF UNKEMPT DARK BROWN HAIR grown "
            "a little too long, falling over his ears and curling untidily onto the back "
            "of his collar, several strands sticking out sideways and lifting in the "
            "air, so his neck and the top of his collar are half hidden under it. His "
            "skin is a light olive Levantine tone and he is slight and narrow through "
            "the shoulders. Beyond the plain rectangular doorway and "
    ...
    },
    {
        ...
        "scene": (
            ...
            "gateway, his DARK SLATE-GREY back a solid dark shape, his "
            "arms empty at his sides and his shoulders rounded. HIS HEAD IS SEEN FROM "
            "BEHIND AND IT IS NOT A BARE OR SHAVEN HEAD: he has a THICK MOP OF UNKEMPT "
            "DARK BROWN HAIR grown a little too long, falling over his ears and curling "
            "untidily onto the back of his collar, so the shape of his head against the "
            "night reads as ragged and hairy, never smooth or bald. He is slight and "
            "narrow through the shoulders. Beyond the gateway there "
