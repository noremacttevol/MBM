...
LOCKS = {
    "KING": (
        ...
        "thick silver-grey hair worn LONG ENOUGH TO COVER HIS EARS AND REACH HIS COLLAR — never cropped, never shaved at the sides, never a short modern haircut. He wears a floor-length robe of DEEP "
    ...
    "HALL": (
        ...
        "lie over the steps. THAT SEAT IS A PLAIN HEAVY CHAIR OF SQUARED CEDAR "
        "with simple incised geometric banding and plain blocky posts — it has no "
        "Gothic tracery, no pointed arch, no quatrefoil, trefoil or foliate church "
        "carving, and no turned spindles. EVERY WALL IS SMOOTH LIME PLASTER OVER "
        "DRESSED STONE: there is NO exposed timber framing anywhere, no "
        "half-timbered or studded wall, no diagonal timber brace, and nothing that "
        "reads as medieval European or Tudor building. "
        "To one side stand low wooden scribes' tables stacked "
...
REFS = {
    # "KING" temporarily withheld while its own anchor is regenerated clean
...
BEATS = [
    # ================================ FRAME STORY — the Capernaum doorstep ====
    {
        ...
        "scene": (
            ...
            "who has just crossed the street and stopped a pace short of the step. "
            "PETER IS SEEN FROM BEHIND AND SLIGHTLY TO HIS LEFT, in three-quarter "
            "from behind: the camera is over his shoulder, most of his back and the "
            "back of his head are toward the lens, and only the edge of his cheek and "
            "beard shows as he looks DOWN AND ACROSS at Jesus on the step in front of "
            "him. His gaze has a named target inside this frame, Jesus's face, and "
            "his pupils are nowhere near the camera. One hand is half-raised, "
            "mid-question, and Jesus looks back up at him so their two eyelines meet "
            "inside the picture. The low sun comes from the left along "
    ...
    },
    {
        ...
        "scene": (
            ...
            "FACE TURNED TOWARD IT. PETER STANDS AT THE CENTRE SEEN FROM BEHIND AND "
            "TO ONE SIDE: his back and the back of his head fill the middle of the "
            "frame and his face is turned away from the camera toward the doorstep at "
            "the RIGHT edge of the picture, so no part of his gaze comes near the "
            "lens. His hands have dropped to his sides. Two disciples on the bench "
            "have stopped mid-movement, one with a piece of bread halfway to his "
            "mouth, both seen in profile looking past Peter toward that same "
            "doorstep. EVERY EYELINE IN THE PICTURE CONVERGES ON THE DOORSTEP AT THE "
            "RIGHT EDGE OF THE FRAME. Low gold light rakes along the row of them and "
            "their "
    ...
    # ============================= THE PARABLE — the audience hall, midday ====
    {
        ...
        "scene": (
            ...
            "him is ONE PLAIN UNBROKEN WALL OF SMOOTH LIME PLASTER OVER DRESSED STONE, "
            "falling away into a soft dim wash — no timber beam, brace, post or "
            "framing of any kind crosses that wall, and the chair behind his "
            "shoulder is plain squared cedar with only simple straight incised "
            "banding."
        ),
    },
    {
    ...
    },
    {
        ...
        "scene": (
            ...
            "toward the far side of the yard, so NO FACE IS TURNED TOWARD THE LENS. "
            "THE NEAR MAN IS THE SAME FORGIVEN SERVANT FROM THE HALL AND CARRIES HIS "
            "LOCKED IDENTITY EXACTLY: a wiry hollow-cheeked Middle Eastern man of "
            "about forty with WEATHERED OLIVE-BROWN SKIN, CROPPED BLACK HAIR RECEDING "
            "AT THE TEMPLES and a THIN BLACK BEARD, in his dark olive-grey tunic "
            "under the frayed deep rust-brown mantle. He is never fair-skinned, never "
            "brown-haired, never clean-shaven, and never a different man from the one "
            "who lay on the hall floor. He has stopped mid-stride, one foot still "
            "lifted, his whole head swung right. Across the hot flagstones, small and "
            "sharp in the middle distance, "
    ...
    },
    {
        ...
        "scene": (
            ...
            "is a plain rectangle of deep shadow. THE ONLY LIGHT IN THIS PICTURE "
            "COMES FROM THE HIGH CLERESTORY SLOTS CUT IN THE STONE WALL: nothing is "
            "mounted on any wall, nothing hangs from the ceiling, no bar, panel, "
            "strip, lamp, sconce, bracket or fixture of any kind appears on the walls "
            "or above the doorway; the daylight falling on the stone is the entire "
            "lighting of this frame, and nothing else emits light. Their three long shadows stretch back toward the camera across "
            "the worn stone. The last low bar of daylight from "
