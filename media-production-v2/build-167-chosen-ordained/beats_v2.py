...
PLACE_REFS = {
    "HARVEST-FIELD": "PLACE-REF/harvest-field.jpeg",  # build-167-chosen-ordained s12-the-measure-is-fruit (manual)
    "LAKESHORE": "PLACE-REF/lakeshore.jpeg",  # build-167-chosen-ordained s01-ordinary-work-by-the-water (manual)
    "TEACHING-HILL": "PLACE-REF/teaching-hill.jpeg",  # build-167-chosen-ordained s09-never-just-a-title (manual)
    "VILLAGE-ROAD": "PLACE-REF/village-road.jpeg",  # build-167-chosen-ordained s11-out-to-the-villages (manual)
}
# === end PLACE-PLATES ===
