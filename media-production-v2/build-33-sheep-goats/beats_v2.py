...
BEATS = [
    ...
    # ================= n4 — the narrator retells the list ===================
    {
        ...
        "scene": (
            ...
            "AT HAND HEIGHT AND SIDE-ON, framing ONLY the hands: no head, face or full "
            "figure is in the picture at all. Filling the frame from the right is ONE "
            "ADULT MALE HAND of an older man — gaunt, sun-darkened olive-brown, "
            "thin-skinned over the tendons, the knuckles enlarged, the nails short and "
            "split, road dust in the creases — closing its fingers round a broken half "
            "of a round flat barley loaf, the crumb open and coarse. From the upper "
            "left, ONE ADULT FEMALE HAND — smaller, olive-brown, work-roughened but "
            "smooth-knuckled, no ring and no jewellery of any kind, the cuff of a DEEP "
            "INDIGO woven wool sleeve at the wrist — is drawing back and away, its "
            "fingers already open and clear of the bread. Only bare packed earth and "
            "pale dust behind them. Mid-action, at the instant of release."
        ),
    },
    {
        ...
        "scene": (
            ...
            "olive-brown, work-roughened, no ring and no jewellery, a DEEP INDIGO "
            "woven wool sleeve at its wrist. A little dry straw lies on the stone "
    ...
    # ================= n9 — the closing application =========================
    {
        ...
        "scene": (
            ...
            "CAMERA IS SET LOW AND OFF TO THE SIDE OF THE GROUP AND SHOOTS ALONG THE "
            "STAIR PAST THE MEN'S BACKS: the two nearest disciples are seen from "
            "BEHIND AND FROM THE SIDE as solid dark masses at the near edge, and NOT "
            "ONE FACE IS TURNED TOWARD THE LENS. Jesus sits among them on his step, "
            "small in the middle distance, seen in three-quarter view with his "
            "shoulders relaxed and one hand resting on his own knee; HIS GAZE GOES "
            "ACROSS THE GROUP toward a man on the far side and exits the picture "
            "through the RIGHT EDGE. He is at the same level as the men, no higher, "
            "and nothing in the composition centres or elevates him. THIS IS A WIDE "
    ...
    },
    {
        ...
        "scene": (
            ...
            "close round its body — short fingers, soft skin, grubby nails, the cuff "
            "of a DARK OLIVE woven wool sleeve at one wrist. TWO ADULT FEMALE HANDS "
            "come down from the upper edge and are just releasing it — olive-brown, "
            "work-roughened but smooth-knuckled, no ring and no jewellery of any kind, "
            "the cuffs of a DEEP INDIGO woven wool sleeve at both wrists — the fingers "
            "already lifting clear. There is no wound, scar or mark on any hand. "
