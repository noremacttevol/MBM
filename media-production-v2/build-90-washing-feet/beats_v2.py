...
BEATS = [
    {
        ...
        "scene": (
            "The lamplit supper murmurs on, the camera at the "
            "wall behind the near couches' shoulders, "
    ...
    },
    {
        ...
        "window": "13.18-16.66", "wide": False, "jesus": True, "ref": REF,
        "locks": ["ROOM", "BASIN"],
    ...
    },
    {
        ...
        "window": "17.32-22.09", "wide": False, "jesus": True, "ref": REF,
    ...
    },
    {
        ...
        "window": "39.32-42.85", "wide": False, "jesus": True, "ref": REF,
        "locks": ["ROOM", "BASIN", "PETER"],
    ...
    },
    {
        ...
        "scene": (
            "The circuit done, the camera down the table's length "
            "with the near backs in three-quarter, the room "
    ...
    },
    {
        ...
        "window": "51.88-58.01", "wide": False, "jesus": True, "ref": REF,
        "locks": ["ROOM", "PETER", "JOHN"],
        "narration": (
    ...
    },
    {
        ...
        "window": "63.92-69.21", "wide": False, "jesus": True, "ref": REF,
        "locks": ["ROOM", "BASIN"],
        "narration": (
