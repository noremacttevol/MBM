...
BEATS = [
    ...
    # ------------------------------------------------------ n4b — the walk ----
    {
        ...
        "scene": (
            ...
            "Jesus's face. Jesus stands facing Peter with his whole body turned "
            "toward him, MANY PACES of open black water still between them, HIS EYES "
            "ON PETER — never on the camera — and both hands open low at his sides "
            "in welcome, his face glad and steady. Far behind Peter on the left the "
            "fishing boat rides the swell, small with distance but clearly showing "
            "its mast and the men crowded at the gunwale watching. "
            "BOTH MEN'S FEET ARE FULLY VISIBLE, resting ON TOP of a briefly smooth "
            "patch of sea as if it were wet glass — wavelets break AROUND their feet "
            "but never over them, both robe hems hang clear ABOVE the surface, and "
            "not even their toes go under. "
            "Neither man is submerged to any depth at all. A REAL PHOTOGRAPH taken "
            "on location with a real camera — real churning water, real spray, real "
            "weathered skin and coarse wet wool, absolutely not an illustration, not "
            "a painting, not a render. Every figure has two arms, "
            "two hands and one head."
        ),
    },
    {
