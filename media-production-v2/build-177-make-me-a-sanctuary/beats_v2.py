...
PLACE_REFS = {
    "TABERNACLE-HOLY": "PLACE-REF/tabernacle-holy.jpeg",  # build-177-make-me-a-sanctuary s07-the-ark-the-table-the-lampstand (manual)
    "WILDERNESS-CAMP": "PLACE-REF/wilderness-camp.jpeg",  # build-177-make-me-a-sanctuary s01-the-camp-in-the-wilderness (manual)
}
# === end PLACE-PLATES ===

# MOSES appears across b02/b04/b07 (>=3 legible-face beats) — a text-only face
# WILL flip (RUNNER-LESSONS rows 52/55), and QC.md requires a MOSES face-board.
# Runner wired the v2_story_cast MOSES portrait (aged grey prophet, period wool)
# so his face/beard hold across all three beats. TABERNACLE-HOLY stays a PLACE
# (promoted from b07), NOT a character. NO Jesus in this row.
REFS = {
