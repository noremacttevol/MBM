...
# NOT-AUDIO-WIRED fix (AUTHOR/AUDIO lane, 2026-08-11, Machine A `Dev`, $0): the V1
# dir has no final mp4 and no segment mp3s, so neither v2_assemble audio path could
# run. The 11 fresh narration mp3s (n0-n6, j1-j3, card) were copied from this build's
