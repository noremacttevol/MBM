...
BEATS = [
    ...
    },
    {
        ...
        "scene": (
            ...
            "low-light noise. THE CAMERA IS DOWN AT GROUND LEVEL AND WELL TO HIS "
            "RIGHT, SHOOTING HIS FACE IN THREE-QUARTER PROFILE FROM THE SIDE. HIS "
            "GAZE HAS A NAMED TARGET INSIDE THE PICTURE: he is watching THE SCATTER OF "
            "SEED FALLING FROM HIS OWN RIGHT HAND at the lower left of the frame, so "
            "his head is turned down and to his left and his eyeline runs steeply "
            "downward and across, leaving the picture through the bottom left corner, "
            "far below and to the side of the lens. His pupils are never centred on "
            "the camera and his face is never squared up to it. The near foreground "
            "between the camera and him is nothing but bare broken red-brown soil, "
            "with nobody standing, crouching or passing between the camera and him. He "
            "is framed "
    ...
    # ========================================== THE SERVANTS ASK — verse 27 ====
    {
        ...
        "scene": (
            ...
            "SITS SLIGHTLY BELOW HIS EYE LEVEL AND WELL TO HIS LEFT, SHOOTING HIS FACE "
            "IN THREE-QUARTER PROFILE FROM THE SIDE. HIS GAZE HAS A NAMED TARGET "
            "INSIDE THE PICTURE: he is staring at THE TORN-OFF DARNEL SPIKE HELD UP IN "
            "HIS OWN RIGHT HAND, so his head is turned down and to his right and his "
            "eyeline runs downward and across the frame to that spike, well below and "
            "to the side of the lens; his pupils are never centred on the camera. THE "
            "NEAR FOREGROUND BETWEEN THE CAMERA AND HIM IS NOTHING BUT THE STANDING "
            "GREEN-GOLD CROP AND THE TOP OF THE LOW DRY-LAID LIMESTONE WALL, with no "
            "person, shoulder, arm, back or head of any kind between the camera and "
            "him, in focus or out of focus, and no pale or light-coloured cloth "
            "anywhere in the frame. He is framed from "
