...
## RUNNER PARK — 2026-08-06 (A-auto Machine A) — BILLING STILL DEPLETED (25th resume attempt, headless)
...
are depleted`. **$0 spent.** Twenty-fifth consecutive resume blocked by the identical
...
left State RUNNING / Claim A-auto. (Note updated in place across the 21st→25th probe to avoid
unbounded QC growth — full park history preserved below.)

**⚠️ 25 headless sessions have now burned on this one unfixable state. The resume loop cannot
