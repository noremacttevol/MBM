...
SEGMENTS = [
    ...
    ("n5", NARRATOR, 'The Spirit of God came down through the opened heavens like a dove, gentle as falling light, and rested on him. And then, from above — not John, not anyone on the riverbank — the Father himself spoke.'),
