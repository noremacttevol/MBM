...
# The delivered V1 mp4 is a stale/out-of-date assembly (73.212s) that does not match
# this V2 beat map's narration timeline. All 9 segment mp3s are the correct new-voice
# ElevenLabs narration (44100/128k) and the --check windows resolve to 58.240s against
# them, so rebuild the audio track from those segments (sanctioned mechanism, rows
# 69/77/177/185/188/191). No re-voice; narration is byte-identical to the segment mp3s.
...
PLACE_REFS = {
    "DAWN-ROAD": "PLACE-REF/dawn-road.jpeg",  # build-186-joint-heirs s10-the-honest-terms (manual)
    "INHERITANCE-HOME": "PLACE-REF/inheritance-home.jpeg",  # build-186-joint-heirs s02-spirit-beareth-witness (manual)
