...
TEMPLE_COURT_LOCK = (
    ...
    "its inside runs a covered walk whose flat roof is carried on SQUARE STONE PIERS "
    "THAT ARE SIMPLY RECTANGULAR BLOCKS STACKED INTO A POST — four flat faces, sharp "
    "square corners, the same width top and bottom, running straight from the "
    "pavement to a plain flat stone slab at the top, with NO round shaft, NO taper, "
    "NO fluting, NO base, NO plinth, NO moulding and NO capital of any kind — "
    "carrying a FLAT roof of rough hewn timber beams and packed plaster. THERE IS NO "
    "CLASSICAL BUILDING ANYWHERE IN THIS PICTURE: no colonnade, peristyle, portico, "
    "porch, stoa or temple front of round columns; no row of cylindrical shafts; no "
    "Doric, Ionic, Corinthian or Tuscan order; no entablature, architrave, frieze, "
    "cornice, triangular pediment, gable end or stepped stylobate; and no Greek, "
    "Roman, neoclassical or civic-monument facade standing against the sky at the top "
    "of any stair or across any court. THE "
