...
TEMPLE_COURT_LOCK = (
    ...
    "at the other side are small. THIS TEMPLE IS NEWLY BUILT AND STANDING WHOLE, "
    "NOT A RUIN AND NOT A MODERN HOLY SITE: every block is freshly dressed with "
    "sharp square arrises and a clean tooled face, the courses are perfectly level "
    "and the joints tight and regular. NOTHING GROWS OUT OF THE STONE — no plant, "
    "weed, tuft, grass, moss, caper bush or greenery in any joint or crevice "
    "anywhere — and no block is cracked, eroded, hollowed, pitted, patched, "
    "mismatched in size, robbed out or replaced with smaller later stonework. THIS "
    "IS NOT THE WESTERN WALL, THE WAILING WALL, THE KOTEL OR ANY SURVIVING "
    "RETAINING WALL OF A DESTROYED TEMPLE, and it is not a modern plaza, prayer "
    "site, archaeological excavation or tourist place: there is no barrier, rail, "
    "screen, partition, plastic chair, folding table, lectern, paper note pushed "
    "into a crack, sign, lamp post, scaffold or excavation trench anywhere. THE ENCLOSURE is a high wall of very large "
    "square-cut pale limestone blocks laid in level courses without mortar, and that "
    "wall is BLANK AND UNBROKEN — the court is bounded by NOTHING BUT THAT PLAIN WALL "
    "AND OPEN SKY ABOVE IT. STATED AS A DELETION BECAUSE A CLASSICAL COLONNADE HAS "
    "ARRIVED REPEATEDLY AND A PROHIBITION DID NOT HOLD IT: THERE IS NO COVERED WALK, "
    "ROOFED AISLE, CLOISTER, ARCADE, COLONNADE, PERISTYLE, PORTICO, PORCH OR STOA "
    "ANYWHERE IN OR AROUND THIS COURT, AND NO ROW OF COLUMNS, PILLARS, PIERS, POSTS "
    "OR SHAFTS OF ANY KIND ALONG ANY SIDE OF IT, near or far, sharp or blurred; no "
    "round or cylindrical shaft, no fluting, no base, no plinth, no moulding, no "
    "capital; no entablature, architrave, frieze, cornice, triangular pediment, gable "
    "end or stepped stylobate; and no Greek, Roman, Egyptian, neoclassical or "
    "civic-monument facade anywhere against the sky at the top of any stair or across "
    "any court. THE ONLY BUILT THINGS IN THE WHOLE PICTURE ARE THE PAVEMENT, THE "
    "PLAIN BOUNDING WALL, THE ALTAR AND THE SANCTUARY BLOCK. THE "
    ...
    "sheet, pierced by ONE tall SQUARE-TOPPED doorway with NO column, pillar, "
    "half-column, pilaster or porch of any kind in front of it, closed by ONE heavy "
    "hanging "
...
TOLL_STATION_LOCK = (
    ...
    "coin correctly bearing a ruler's head in profile and a worn rim legend; ONE wide "
    "shallow FIRED-CLAY BOWL, thrown by hand and slightly uneven, holding more of "
    "them — THERE IS NO WOODEN BOX, CHEST, TRAY, TILL, CASKET OR CONTAINER OF PLANKS "
    "ANYWHERE ON THE TABLE OR NEAR IT, and therefore no lid, hinge, hasp, staple, "
    "clasp, catch, band, corner bracket, nail head or fitting of metal of any kind; "
    "ONE hand-woven reed basket of loose rolled "
