...
BEATS = [
    ...
    },
    {
        ...
        "scene": (
            "One photograph, 85mm prime wide open, extremely shallow depth of field, "
            "grain. AN OVER-THE-SHOULDER TWO-SHOT: PETER'S DARK BLUE-GREY SHOULDER AND "
            "THE BACK OF HIS WET CURLY HEAD FILL THE NEAR RIGHT THIRD OF THE FRAME, "
            "large, dark and out of focus, seen entirely from behind. The camera looks "
            "past that shoulder at Jesus, who stands a pace beyond at the waterline in "
            "three-quarter view, caught mid-question: his head inclined toward Peter, "
            "his lips parted on the words, his brows raised in a real question and not "
            "a judgement, his eyes steady and warm and utterly attentive. HIS EYES ARE "
            "FIXED ON PETER'S FACE AT THE RIGHT EDGE OF THE FRAME, NOT ON THE CAMERA: "
            "his gaze crosses the picture diagonally to that out-of-focus shoulder, his "
            "pupils sit clearly to one side of his eyes, he is never looking out of the "
            "picture at the viewer, and he never turns back over his shoulder toward "
            "the lens. Low level gold morning light from the east across his cheek and "
