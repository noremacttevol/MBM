...
BEATS = [
    ...
    # ============ n2 — ANCHOR: he ran out of room (face-showing) ==============
    {
        ...
        "scene": (
            ...
            "ground; from the nearest door a slope of barley has spilled out onto the "
    ...
    # ============ n8 — the morning after. Still no death painted. ============
    {
        ...
        "scene": (
            ...
            "mud-brick grain store: its low square drawing door STANDS OPEN, the "
            "adzed timber plank that closes it leaning aside against the wall, and "
