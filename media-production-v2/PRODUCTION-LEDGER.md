...
## Row 33 — The Sheep and the Goats (Matthew 25:31-46) — Claude worker 27, Machine A `Dev`, 2026-08-02

🟡 **CLAIMED 2026-08-02** before any spend. Full realistic V2 rebuild in progress:
audio LOCKED and never re-voiced, windows recomputed from `extract_beats` and measured
word timings, anchor-first casting, staged so it repeats no setting already used in the
wave. CONTENT-CARE WATCH ON THIS ROW: Matthew 25 is the wave's most direct
judgement passage — no angels, no heaven, no hell and no punishment is painted beyond
what the narration itself states; the mercy images (hungry fed, stranger welcomed,
naked clothed, sick tended, prisoner visited) carry the meaning concretely.
Meter at claim: $154.90.
...
## Row 34 — The Rich Fool (Luke 12:13-21) — Claude worker 28, Machine A `Dev`, 2026-08-02

🟡 **CLAIMED 2026-08-02** before any spend. Full realistic V2 rebuild in progress:
audio LOCKED and never re-voiced, windows recomputed from `extract_beats` and measured
word timings, anchor-first casting, staged so it repeats no setting already used in the
wave. NEW SETTING FOR THIS ROW: BARNS AND GRANARIES — expect modern silos, corrugated
metal, sawn planking and machine-milled timber; locked positively before the first paid
image and promoted into `SHARED_SETTING_LOCKS`. CONTENT-CARE WATCH: "this night thy soul
shall be required of thee" is the wave's most direct death line — NO death, corpse, soul
leaving a body, angel, light, tunnel or afterlife image is painted anywhere. What is
painted is what the parable itself states: the full barns, the barns torn down, the man
alone with his goods, and the morning that comes without him.
Meter at claim: $162.14.
...
## Row 35 — The Great Banquet (Luke 14:15-24) — Claude worker 29, Machine A `Dev`, 2026-08-02

🟡 **CLAIMED 2026-08-02** before any spend. Full realistic V2 rebuild in progress:
audio LOCKED and never re-voiced, windows recomputed from `extract_beats` and measured
word timings, anchor-first casting, staged so it repeats no setting already used in the
wave. V1 has SEVEN stills for the whole parable. NEW SETTING FOR THIS ROW: a great
HOUSEHOLD BANQUET HALL and its furnishings — expect modern dining tables, chairs,
tablecloths, glassware, cutlery and chandeliers; and the three excuses bring a FIELD
BOUGHT, FIVE YOKE OF OXEN and a WEDDING, each of which drags its own anachronism.
Locked positively before the first paid image and promoted into `SHARED_SETTING_LOCKS`.
CONTENT-CARE WATCH: the parable is introduced with "eat bread in the kingdom of God" —
NO heaven, throne, gate, cloud, crown or divine figure is painted; the supper is a real
supper in a real house, and the meaning lands on its own.
Meter at claim: $166.964.
...
## Session — 2026-08-02 · Row 37 (The Rich Man and Lazarus, Luke 16:19-31) · Claude worker 32

- **Machine:** Machine A — hostname `Dev`
- **Claim:** commit `8b7c7fbc1`, pushed before any spend.
- **Meter at claim:** $180.364 → **$187.470 at ship** (≈$7.10, 53 images).
- **Reroll rate:** 4 of 53 = **7.5%**.
- **Cut:** `media-production-v2/build-37-rich-man-lazarus/luke-16_rich-man-lazarus.mp4`
  — 165.372 s, 22,153,426 bytes, 1080×1920 H.264 30 fps.
- **Commits:** `8b7c7fbc1` claim · `779a60219` beat map + shared locks ·
  `8d1144dc4` anchors + anchor cures · `4160943ae` all 49 pictures + recount cure ·
  `e94b14ab5` shipped cut.
...
MP4's. 44 windows of true silence below −60 dB confirm no music bed.

**V1 was EIGHT stills for 165 s, and it reused one.** `s5` held 33.0 s across the death,
the burial, the waking and the whole of Luke 16:24; `s6` held 32.0 s **and was shown
again** for the ending, so Abraham's final answer — the line the parable exists to
deliver — had no picture of its own. The inherited scaffold was discarded: 27 pictures at
5.25 s, **22 dead intervals**, covering only 141.750 s of the needed 156.525 s.

**A LIVE SOURCING TRAP.** `make_narration.py` post-dates its own audio by a day and that
commit says "narration re-recorded"; it rewrote n13. Transcription of all twenty segments
proved the audio carries the **short** n13, i.e. the live script matches the shipped
audio. Three apparent differences were whisper's — n7 "Across" was settled from the word
timings (one 380 ms word split at the leading schwa), not by opinion. No TEXT_OVERRIDES.

**Content care.** The one story in the 200 whose narration goes past death, so the rule
became *stage only what the text says*, in Latter-day Saint terms. No devils, horns,
pitchforks, chains, cauldrons, lake of fire, damned crowds, hellmouth or skulls — and **no
fire anywhere in the cut**; "this flame" is heat, glare and parched air. Torment is total
isolation on bare cracked ground. Abraham's bosom is shade, still water and a hand on a
shoulder. The gulf is literal geology. The angels are two ordinary men, the wing/halo risk
killed by camera geometry. God is never depicted; Jesus never appears inside the parable —
all five red-letter lines are the rich man and Abraham speaking within it.
