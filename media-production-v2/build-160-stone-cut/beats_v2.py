...
PLACE_REFS = {
    "COURT": "PLACE-REF/court.jpeg",  # build-160-stone-cut s01-the-king-of-babylon-had (manual)
    "DREAM-PLAIN": "PLACE-REF/dream-plain.jpeg",  # build-160-stone-cut s05-and-then-in-the-dream (manual)
    "STATUE": "PLACE-REF/statue.jpeg",  # build-160-stone-cut s03-in-the-dream-the-king (manual)
    "STONE": "PLACE-REF/stone.jpeg",  # build-160-stone-cut s06-a-single-stone-cut-out (manual)
}
# === end PLACE-PLATES ===
...
REFS = {
    "DANIEL": "CAST-REF-V2/daniel.jpeg",
    "KING": "CAST-REF-V2/king.jpeg",
}
