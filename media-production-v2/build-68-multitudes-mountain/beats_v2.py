...
PLACE_REFS = {
    "MOUNTAIN": "PLACE-REF/mountain.jpeg",  # build-68-multitudes-mountain s03-and-the-whole-region-emptied (manual)
}
# === end PLACE-PLATES ===
...
REFS = {
    "PLANKMAN": "CAST-REF-V2/plankman.jpeg",
    "MUTEWOMAN": "CAST-REF-V2/mutewoman.jpeg",
}
