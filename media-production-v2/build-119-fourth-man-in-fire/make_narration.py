...
SEGMENTS = [
    ...
    ("n10", NARRATOR, "That is the same man who asked, an hour earlier, who is that God that shall deliver you out of my hands. He got his answer, and he said it himself."),
...
# DISABLED 2026-08-11 (Opus runner, Machine A `Dev`) — the 'boughs' respell REGRESSED it.
# ElevenLabs Brian (the shipping voice) reads "boughs" as /oʊ~uː/ (BEAU/booze), WORSE than
# plain "bows" which he already renders correct /baʊz/ (BOUGH). Formant-proven; Cameron
# re-complained "still mispronounced". Ship the plain-"bows" take. Do NOT re-enable this.
# SPOKEN.update({'bows': 'boughs'})  # 2026-07-21 Cameron complaint #119 'bow' misread — RETIRED, see above  # 2026-07-21: the GLOBAL 'SHAD-rak' entry is a hyphen split (Trap 2) — Steffan's recorded s326 take said "Red Rack". 'shadrack' round-trips "Shadrach" clean in Steffan; single word, no hyphen. Build override beats the global map.
