...
PLACE_REFS = {
    "FURNACE": "PLACE-REF/furnace.jpeg",  # build-119-fourth-man-in-fire s06-but-if-ye-worship-not (manual)
    "PLAIN": "PLACE-REF/plain.jpeg",  # build-119-fourth-man-in-fire s01-a-king-built-a-golden (manual)
}
# === end PLACE-PLATES ===
