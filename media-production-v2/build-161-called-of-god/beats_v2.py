...
PLACE_REFS = {
    "QUIET-HILL": "PLACE-REF/quiet-hill.jpeg",  # build-161-called-of-god s18-so-also-christ-glorified-not (manual)
    "TABERNACLE": "PLACE-REF/tabernacle.jpeg",  # build-161-called-of-god s01-in-ancient-israel-one-man (manual)
}
# === end PLACE-PLATES ===
...
REFS = {
    "AARON": "CAST-REF-V2/aaron.jpeg",
    "MOSES": "CAST-REF-V2/moses.jpeg",
    "PRIEST": "CAST-REF-V2/priest.jpeg",
}
