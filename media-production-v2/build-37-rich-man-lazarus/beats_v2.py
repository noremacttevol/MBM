...
LOCKS = {
    ...
    "RICH-HOUSE": (
        "RICH-HOUSE LOCK: EVERY OPENING IN THIS HOUSE IS STATED FIRST, BECAUSE THE ANCHOR FRAME GREW A GLAZED WINDOW WITH A TIMBER SASH UPRIGHT IN IT AND HAD TO BE RESHOT: an opening in these walls is a PLAIN RECTANGULAR HOLE spanned by ONE flat stone lintel with ABSOLUTELY NOTHING STANDING IN IT — either a completely empty dark gap, or covered by ONE loose panel of dark woven goat-hair cloth hung from wooden pegs. THERE IS NO GLASS, GLAZING, PANE, SASH, CASEMENT, MULLION, TRANSOM, GLAZING BAR, WINDOW FRAME, SURROUND, ARCHITRAVE, REVEAL LINING, SILL BOARD, SHUTTER, LOUVRE, LATTICE, GRILLE, BAR OR TIMBER UPRIGHT OF ANY KIND IN ANY OPENING, near or far, sharp or blurred, and no door on hinges anywhere. "
        "The rich man's house is a substantial first-century "
...
BEATS = [
    ...
    # ===== n1 — the rich man. ANCHOR b03. ====================================
    {
        ...
        "scene": (
            ...
            "FROM COMPLETELY OUTSIDE THE PICTURE, modelling "
            ...
            "depth of field with the wall softly out of focus. THE WALL BEHIND HIM IS ONE UNBROKEN EXPANSE OF MUD PLASTER AND DRESSED STONE AND CONTAINS NO OPENING, WINDOW, DOORWAY, NICHE, RECESS, FRAME, SHUTTER, PANE, GLAZING BAR OR TIMBER UPRIGHT OF ANY KIND ANYWHERE IN THE PICTURE. HE IS ALONE IN "
...
BEATS += [
    ...
    },
    {
        ...
        "must_not_show": _NO_CREAM + _NO_HALO + _NO_MOCK + _NO_MODERN_LAMP + _NO_KITSCH + _GAZE,
        "scene": (
            "COUNT AS GEOMETRY, STATED FIRST BECAUSE IT GOVERNS THIS FRAME AND BECAUSE THIS PICTURE CAME BACK WITH EIGHT MEN IN IT AND HAD TO BE RESHOT: THERE ARE EXACTLY FIVE MEN IN THIS PICTURE AND NO SIXTH PERSON OF ANY KIND. THE NEAR SIDE OF THE TABLE IS COMPLETELY EMPTY OF PEOPLE — nobody sits, reclines, kneels or stands between the camera and the table, and NO back, shoulder, head, arm, elbow or hair of any person appears in the near foreground or in either lower corner of the frame, in focus or out of focus. The fourth side of the table is left open and unoccupied for serving, exactly as the custom requires. ALL FIVE MEN ARE RANGED ALONG THE FAR SIDE AND THE TWO SHORT ENDS OF THE TABLE, each one separated from the next by a clear visible gap, so the viewer counts one, two, three, four, five without effort and finds no sixth. THE CAMERA IS LOW AND SET BEHIND THE EMPTY NEAR EDGE OF THE TABLE ITSELF, so the near foreground is filled edge to edge by the bare timber tabletop and its clay dishes rather than by any person. EVERY MAN'S HEAD IS TURNED TOWARD ANOTHER MAN AT THE TABLE, their eyelines running laterally across the table between them and exiting through the LEFT or RIGHT edge of the frame; NOT ONE OF THEM LOOKS TOWARD THE CAMERA and no man's pupils are centred on the lens. One photograph, 28mm wide lens, warm low late-afternoon daylight falling through a plain rectangular wall opening on the LEFT across the low table, the rest of the room in warm shadow, the light source out of frame and never behind any head, fine film grain, deep focus throughout. They are prosperous Judean men between about twenty-five and forty-five, each with warm olive-brown Middle Eastern skin, dark hair and a dark beard, and no two sharing a face. EACH IS DRESSED HEAD TO FOOT IN ONE SOLID DARK SATURATED COLOUR — dark umber, charcoal, deep rust, dark olive and deep indigo, ONE MAN EACH — and NOT ONE WEARS CREAM, OFF-WHITE, IVORY, BUFF, BEIGE, SAND, WHITE OR ANY PALE CLOTH, AND NOT ONE WEARS SAFFRON-GOLD OR TYRIAN PURPLE. Nobody is drunk, sprawling, leering, gorging or drawn as a caricature of greed. They recline propped on their LEFT elbows on folded wool bolsters and floor mats, feet away behind them, eating with the right hand only. The low knee-high adzed-timber table carries flat rounds of barley bread laid straight on the bare wood, shallow fired-clay bowls of olives, figs, dates and lentils, and plain fired-clay jars and unstemmed clay cups. THIS IS A WIDE FULL-LENGTH SCENE: the camera is far enough back that all five men and the whole low table are in frame together, under rough hewn ceiling beams. "
        ),
    },
    {
    ...
    },
    {
        ...
        "must_not_show": _NO_CREAM + _NO_HALO + _NO_MOCK + _NO_MODERN_LAMP + _NO_KITSCH + _GAZE,
        "scene": (
            "COUNT AS GEOMETRY, STATED FIRST BECAUSE IT GOVERNS THIS FRAME AND BECAUSE THIS PICTURE CAME BACK WITH EIGHT MEN IN IT AND HAD TO BE RESHOT: THERE ARE EXACTLY FIVE MEN IN THIS PICTURE AND NO SIXTH PERSON OF ANY KIND. THE NEAR SIDE OF THE TABLE IS COMPLETELY EMPTY OF PEOPLE — nobody sits, reclines, kneels or stands between the camera and the table, and NO back, shoulder, head, arm, elbow or hair of any person appears in the near foreground or in either lower corner of the frame, in focus or out of focus. The fourth side of the table is left open and unoccupied for serving, exactly as the custom requires. ALL FIVE MEN ARE RANGED ALONG THE FAR SIDE AND THE TWO SHORT ENDS OF THE TABLE, each one separated from the next by a clear visible gap, so the viewer counts one, two, three, four, five without effort and finds no sixth. THE CAMERA IS LOW AND SET BEHIND THE EMPTY NEAR EDGE OF THE TABLE ITSELF, so the near foreground is filled edge to edge by the bare timber tabletop and its clay dishes rather than by any person. EVERY MAN'S HEAD IS TURNED TOWARD ANOTHER MAN AT THE TABLE, their eyelines running laterally across the table between them and exiting through the LEFT or RIGHT edge of the frame; NOT ONE OF THEM LOOKS TOWARD THE CAMERA and no man's pupils are centred on the lens. One photograph, 28mm wide lens, warm low late-afternoon daylight falling through a plain rectangular wall opening on the LEFT, the room beyond in warm shadow, the light source out of frame and never behind any head, fine film grain, deep focus throughout. NOTHING IN THE ROOM HAS CHANGED AND NOTHING TROUBLES THEM: they are mid-meal and easy, one with his head back mid-laugh and his hand lifted, another reaching for bread; nobody has stopped eating, nobody looks up, nobody has heard anything, there is no messenger, no visitor, no empty place laid and no figure standing in any opening. They are prosperous Judean men between about twenty-five and forty-five, each with warm olive-brown Middle Eastern skin, dark hair and a dark beard, and no two sharing a face. EACH IS DRESSED HEAD TO FOOT IN ONE SOLID DARK SATURATED COLOUR — dark umber, charcoal, deep rust, dark olive and deep indigo, ONE MAN EACH — and NOT ONE WEARS CREAM, OFF-WHITE, IVORY, BUFF, BEIGE, SAND, WHITE OR ANY PALE CLOTH, AND NOT ONE WEARS SAFFRON-GOLD OR TYRIAN PURPLE. Nobody is drunk, sprawling, leering, gorging or drawn as a caricature of greed. They recline propped on their LEFT elbows on folded wool bolsters and floor mats, feet away behind them, eating with the right hand only. The low knee-high adzed-timber table carries flat rounds of barley bread laid straight on the bare wood, shallow fired-clay bowls of olives, figs, dates and lentils, and plain fired-clay jars and unstemmed clay cups. THIS IS A WIDE FULL-LENGTH SCENE: the camera is far enough back that all five men and the whole low table are in frame together, under rough hewn ceiling beams. "
        ),
    },
    # ===== n11 — ANCHOR b43 ==================================================
    {
        ...
        "scene": (
            ...
            "field. THE GROUND AND BACKGROUND ARE THE PLACE OF REST AND ARE STATED POSITIVELY, BECAUSE THIS FRAME FIRST CAME BACK AS BARE ARID STONY HILLSIDE AND HAD TO BE RESHOT: he sits on a low natural rock in the DEEP COOL SHADE OF BROAD REAL GREEN-LEAVED TREES, and everything behind him is SOFT GREEN — green grass and low green growing plants running away under the trees, with the bright surface of STILL OPEN WATER catching the light in the far soft background. THERE IS NO BARE DUST, CRACKED CLAY, STONY SCREE, THORN SCRUB, DEAD BLEACHED GRASS, LIMESTONE HILLSIDE OR BURNING WHITE SKY ANYWHERE IN THIS PICTURE. HE IS ALONE IN THE "
