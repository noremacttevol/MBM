...
BEATS = [
    ...
    },
    {
        ...
        "scene": (
            "A CLOSE LOW shot from beside the path's worn steps: the humble "
            "worshipper's dusty feet and travel-stained hem fill the near "
            "foreground as he pauses mid-climb, and past him, tilted up from "
            "the low camera, the white temple crowns the hill's top far above "
            "against the morning sky — the height of the ascent felt in one "
            "frame. His staff rests by his sandal. NOT the empty-path wide "
            "used earlier — low, near, and looking up."
        ),
    },
    {
...
PLACE_REFS = {
    "ANCIENT-GATES": "PLACE-REF/ancient-gates.jpeg",  # build-176-who-shall-ascend s04-stand-in-his-holy-place (manual)
    "HILL-OF-THE-LORD": "PLACE-REF/hill-of-the-lord.jpeg",  # build-176-who-shall-ascend s01-the-hill-at-dawn (manual)
    "TEMPLE-COURT": "PLACE-REF/temple-court.jpeg",  # build-176-who-shall-ascend s14-receive-the-blessing (manual)
}
# === end PLACE-PLATES ===
...
REFS = {
    "WORSHIPPER": "CAST-REF-V2/worshipper.jpeg",
}
