...
# TEXT_OVERRIDES (2026-08-12, RUNNER caption-fix, Machine A Dev): row-84/131 class.
# The V1-dir make_narration SEGMENTS n4b still carries THREE sentences (opening with
# "Not a hired man who runs off …"), but the re-voiced audio (audio/n4b.timing.json,
# byte-identical V1==V2) speaks only the LAST TWO sentences. extract_beats reads the
# stale 3-sentence SEGMENTS for the caption, so the burned caption printed
# "Not a hired man …" while the voice said "That is what he was willing to spend …"
# (verified in the rendered mp4 @69s). Override the n4b CAPTION to the timing.json
# spoken text so caption==audio. V1 make_narration is NEVER edited (hard rail);
# the audio track is untouched (AUDIO REBUILD SHA256 stays 083e2e62…, byte-identical).
TEXT_OVERRIDES = {
    "n4b": "That is what he was willing to spend to keep them. That is what he was willing to spend to keep you.",
}
BEATS = [
    {
