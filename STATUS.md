...
| 25 | Wheat and Tares (Matthew 13) | matthew-13_wheat-and-tares | **CLAIMED — building** 🔨 — Machine A (Dev), Cameron's direct order 2026-07-12. Stills-only parable, Jesus fully off-screen (voice + KJV only). Heart line Matthew 13:29-30 "Let both grow together until the harvest" — patience is mercy. |
