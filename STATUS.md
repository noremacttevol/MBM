...
| Worker | On | State |
|---|---|---|
| Codex (VS Code, Machine A) | Story 02 (Prodigal Son) face-consistency repair | in progress — claimed after Cameron's new reviewer complaint, “All Faces changes too much”; preserving the shipped scenes and audio while identity-editing drifted faces against one anchor per recurring person |
...
| 02 | The Prodigal Son (Luke 15) | **DENIED — face-consistency repair claimed by Codex 2026-08-01** 🔴 — Cameron's exact complaint on the new realistic cut: “All Faces changes too much.” Keep its scene composition and audio; audit every father, younger son, elder son, and Jesus appearance side-by-side, identity-edit drift against one canonical anchor per person, then rebuild and return the replacement to Unwatched with this complaint retained. | [▶ complained-about Prodigal V2](media-production-v2/build-02-prodigal/luke-15_prodigal-son-realistic-v2.mp4) |
