...
| Worker | On | State |
|---|---|---|
| Codex (VS Code, Machine A) | Story 01 (Woman Who Touched His Cloak) realistic replacement | ✅ realistic V3 built and QC-passed: 20 checked frames, hash-backed Jesus/woman boards, full 1:48.833 story, and only the two confirmed Alexander windows selectively denoised. Publishing the new hash to reviewer Unwatched with the old complaint retained; app remains untouched. |
