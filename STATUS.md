...
| 24 | The Sower (Matthew 13) | matthew-13_sower | **CLAIMED — building** 🔨 — Machine C. Stills-only parable, Jesus only bookend storyteller from behind. |
...
| 25 | Wheat and Tares (Matthew 13) | matthew-13_wheat-and-tares | **BUILT — awaiting Cameron** 🟡 — Machine A (Dev). Stills-only parable, Jesus fully off-screen (voice + KJV only; face-gate PASS). 8 fresh painted stills, verbatim captions, KJV j1 (13:29-30 "Let both grow together until the harvest") + j2 (13:43 "the righteous shine forth as the sun") cream-italic. Milk framing (patience is mercy; furnace kept gentle). Ear-check 17/17; hush on the heart line, no other dead air. matthew-13_wheat-and-tares.mp4 (20.7MB, 3:16). |
| 28 | Hidden Treasure (Matthew 13) | matthew-13_hidden-treasure | **CLAIMED — building** 🔨 — Elli's Windows laptop, Cameron's direct order 2026-07-12 ("start #28"). Stills-only parable (Matthew 13:44), no Jesus figure (face-gate PASS). KJV j1 (13:44). Claim + KJV + narration prep underway. |
