...
| Worker | On | State |
|---|---|---|
| Codex (VS Code, Machine A) | Story 03 (Zacchaeus) realistic replacement | in progress — claimed 2026-08-01 after Story 1 shipped live; auditing the existing 26-picture realistic draft against the complete approved script/audio, recurring Zacchaeus/Jesus identities, scale, anatomy, action, and encoded-video gates before changing anything |
...
| 03 | Zacchaeus (Luke 19) | **Realistic replacement claimed by Codex 2026-08-01** 🔵 — existing 26-picture draft is being audited rather than regenerated blindly. Preserve the complete approved script/audio and existing sound compositions; require stable Zacchaeus and Jesus identities, credible short-stature scale, correct tree/crowd/meal/restitution actions, V4 prompt checks, hash-backed face boards, and encoded-frame QC. App feed remains untouched. | — |
