...
| 23 | Workers in the Vineyard (Matthew 20) | matthew-20_vineyard-workers | **CLAIMED — building** 🔨 — Machine A (Dev), Cameron's direct order 2026-07-12. Stills-only parable, Jesus fully off-screen (voice + KJV only). Key line Matthew 20:15 "Is thine eye evil, because I am good?" |
