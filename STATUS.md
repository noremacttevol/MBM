...
| 30 | The Net / Dragnet (Matthew 13) | matthew-13_the-net | **CLAIMED — building** 🔨 — Machine A (Dev), Cameron's direct order 2026-07-12. Stills-only parable, Jesus fully off-screen (voice + KJV only). KJV Matthew 13:47-49; milk framing: the net gathers "of every kind" — the gathering (grace) comes first, and the sorting is God's alone, at the end, not ours. |
...
| 32 | The Talents (Matthew 25) | matthew-25_talents | **CLAIMED — building** 🔨 — Machine C (Cameron's direct order "do 32"). Stills-only parable (25:14-30), NO Jesus figure (master is a parable character). Milk framing: the buried talent came from a FALSE view of the master's heart. |
...
| 31 | The Ten Virgins (Matthew 25) | matthew-25_ten-virgins | **CLAIMED — building** 🔨 — Elli's Windows laptop, Cameron's direct order 2026-07-12 ("go to 31"). Stills-only parable (Matthew 25:1-13). Ten bridesmaids' faces shown; the bridegroom (represents Christ) shown reverently at a distance / from behind, never a face. KJV j1 (25:13 "Watch therefore"). Claim + KJV + narration prep underway. |
