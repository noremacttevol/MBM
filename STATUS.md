...
| Worker | On | State |
|---|---|---|
| Codex (VS Code, Machine A) | Story 01 (Woman Who Touched His Cloak) realistic replacement | ✅ realistic V3 shipped to reviewer: 20 checked frames, hash-backed Jesus/woman boards, full 1:48.833 story, and only the two confirmed Alexander windows selectively denoised. New hash returns it to Unwatched with the old complaint retained; app remains untouched. |
