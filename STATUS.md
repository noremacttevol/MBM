...
| 27 | The Leaven (Matthew 13) | matthew-13_leaven | **CLAIMED — building** 🔨 — Machine C (Cameron's direct order "go to 27"). Stills-only one-verse parable (13:33), NO Jesus figure (voice + KJV only). |
