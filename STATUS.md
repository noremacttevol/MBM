...
| 21 | The Lost Sheep (Luke 15) | luke-15_lost-sheep | **BUILT — awaiting Cameron** 🟡 — Machine A (Dev). Stills-only parable, Jesus kept fully off-screen (his narrating voice + KJV only; face-gate PASS). 7 painted stills (Machine C art on shared prep), verbatim captions, KJV j1–j4 (Luke 15:4/5/6/7) cream-italic. Cameron's fix applied 2026-07-12: the narrator now says "ninety-nine" cleanly (was muddying into "ninety and nine"); Jesus keeps exact KJV "the ninety and nine". Rebuilt reproducibly (ear-check 15/15, no dead air but the finding-pause + card tail). luke-15_lost-sheep.mp4 (20.2MB, 2:47). |
