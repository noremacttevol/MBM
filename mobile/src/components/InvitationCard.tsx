...
const styles = StyleSheet.create({
  ...
  acceptText: { color: colors.onAccent, fontSize: 13, fontFamily: 'MBMCross', fontWeight: '600' },
  passText: { color: colors.textMuted, fontSize: 12, fontFamily: 'MBMCross', fontStyle: 'italic', paddingVertical: 10, paddingHorizontal: 4 },
});
