...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 18, fontFamily: 'MBMCross', color: colors.textMid },
  ...
  headerBtnText: { color: colors.textDim, fontSize: 11, fontFamily: 'MBMCross' },
  ...
  historyTitle: { flex: 1, color: colors.textMid, fontSize: 13, fontFamily: 'MBMCross' },
  historyDate: { color: colors.textMuted, fontSize: 11, fontFamily: 'MBMCross', marginLeft: spacing.sm },
  historyEmpty: { color: colors.textMuted, fontSize: 12, fontFamily: 'MBMCross', fontStyle: 'italic', paddingVertical: 6 },
  ...
  copiedBannerText: { color: colors.blue, fontSize: 12, fontFamily: 'MBMCross', lineHeight: 17 },
  ...
  emptyTitle: {
    fontSize: 18, fontFamily: 'MBMCross', color: colors.textMid,
    marginBottom: spacing.md, textAlign: 'center',
  },
  emptyBody: {
    fontSize: 14, fontFamily: 'MBMCross', color: colors.textDim,
    lineHeight: 22, textAlign: 'center', marginBottom: spacing.lg,
  },
  emptySub: {
    fontSize: 12, fontFamily: 'MBMCross', fontStyle: 'italic',
  ...
  bubbleText: { fontSize: 14, fontFamily: 'MBMCross', lineHeight: 22 },
  ...
  metaText: {
    fontSize: 11, fontFamily: 'MBMCross', fontStyle: 'italic',
  ...
  factCheckText: {
    fontSize: 11, fontFamily: 'MBMCross', color: colors.blue,
  ...
  input: {
    ...
    color: colors.text, fontFamily: 'MBMCross', fontSize: 14,
  ...
  sendBtnText: { color: colors.gold, fontSize: 18, fontFamily: 'MBMCross' },
});
