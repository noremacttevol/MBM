...
const styles = StyleSheet.create({
  ...
  deleteLink: {
    fontSize: 12, fontFamily: 'MBMCross', fontStyle: 'italic', color: colors.textMuted,
  },
  editLink: {
    fontSize: 12, fontFamily: 'MBMCross', fontStyle: 'italic', color: colors.blue,
  },
  editInput: {
    backgroundColor: colors.bgInput, borderWidth: 1, borderColor: colors.border,
    borderRadius: radius.md, color: colors.text, fontSize: 14, fontFamily: 'MBMCross',
