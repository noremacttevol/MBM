...
export const QUESTION_BANK: DialogueQuestion[] = [
  ...
  // without ever disclosing anything itself (Law 8: one click is never identity).
  {
    ...
    answerType: 'CHOICE',
    answerOptions: [
      { text: "In a church family I'm an active part of.", value: 'churched', signals: ['believes_in_jesus'] },
      { text: 'In a faith I grew up in but have drifted from.', value: 'drifted', signals: ['has_history_with_faith'] },
      { text: 'Between me and God — no church right now.', value: 'unchurched', signals: ['open_to_god'] },
      { text: "Honestly — it's complicated right now.", value: 'complicated' },
    ],
    prerequisiteSignals: ['covenant_intent'],
  ...
  // someone's faith lives (Acts 17). Third question for everyone. Names no church.
  {
    ...
    answerType: 'CHOICE',
    answerOptions: [
      { text: "Yes — I'm part of a faith community now.", value: 'active', signals: ['active_faith_tradition'] },
      { text: "I grew up in one, but I've stepped away.", value: 'stepped_away', signals: ['has_history_with_faith'] },
      { text: "No — I've never really had one.", value: 'none' },
      { text: "It's complicated — bits and pieces.", value: 'complicated' },
    ],
    prerequisiteSignals: [],
  ...
  // id 61 — picture of God: what God thinks of you.
  {
    ...
    answerType: 'CHOICE',
    answerOptions: [
      { text: "That I'm a disappointment to him.", value: 'disappointment', signals: ['pictures_harsh_god'] },
      { text: "That he's not really paying attention to someone like me.", value: 'unnoticed', signals: ['pictures_distant_god'] },
      { text: "That he loves me — even the parts I hide.", value: 'loved', signals: ['believes_god_good'] },
      { text: "Honestly — I think he might be glad I'm asking.", value: 'glad', signals: ['open_to_god'] },
      { text: "I can't picture him being real enough to think anything.", value: 'unreal', signals: ['skeptical_of_god'] },
    ],
    prerequisiteSignals: [],
  ...
  // id 64 — score-keeper vs leaning-in (picture-of-God probe).
  {
    ...
    answerType: 'CHOICE',
    answerOptions: [
      { text: 'Someone keeping score.', value: 'score', signals: ['pictures_harsh_god'] },
      { text: 'Someone leaning in.', value: 'leaning', signals: ['believes_god_good'] },
      { text: 'No one. Empty air.', value: 'no_one', signals: ['skeptical_of_god'] },
      { text: 'It depends on the day, honestly.', value: 'depends' },
    ],
    prerequisiteSignals: [],
  ...
  // self-identifies (Law 3) and a Baptist gets believes_in_jesus.
  {
    ...
    answerType: 'FREE_TEXT', answerOptions: [],
    prerequisiteSignals: ['active_faith_tradition'],
  ...
  // id 71 — does everyone get a real chance (the Calvinist-revealing question).
  {
    ...
    answerType: 'CHOICE',
    answerOptions: [
      { text: 'Everyone — somehow, a good God reaches everyone.', value: 'everyone', signals: ['rejects_harsh_god'] },
      { text: "Only some — that's what I was taught, and it troubles me.", value: 'troubled', signals: ['pictures_harsh_god'] },
      { text: "Only some — and I've made peace with that.", value: 'settled', signals: ['pictures_harsh_god', 'reformed_framework'] },
      { text: "I've honestly never let myself ask.", value: 'never_asked' },
    ],
    prerequisiteSignals: [],
  ...
  // id 72 — universal chance (1 Pet 4:6-shaped; gated on pictures_harsh_god).
  {
    ...
    answerType: 'CHOICE',
    answerOptions: [
      { text: "Better news. I'd want that to be true.", value: 'better', signals: ['rejects_harsh_god', 'open_to_god'] },
      { text: 'It would contradict what God has decreed.', value: 'decreed', signals: ['reformed_framework'] },
      { text: "I don't know — I've never been allowed to ask that.", value: 'not_allowed' },
    ],
    prerequisiteSignals: ['pictures_harsh_god'],
