...
8. **The Jesus-framing laws (PRODUCTION-BIBLE §1, Corrections #1–#14) are non-negotiable and Cameron has rejected finished videos over each of them.** The ones violated most: (a) his face is hidden by ANGLE only — the default for any "people facing Jesus" scene is OVER-THE-SHOULDER: camera behind him, his hooded shoulder soft in a lower corner, the people filling the frame with every gaze locked past the camera AT him; (b) NEVER a small detached rear-view Jesus at the frame edge while the crowd's eyes wander — gazes must visibly converge on him; (c) NO rim-light, halo, or glow that outlines his face or head — a glowing silhouette highlights him, the opposite of the goal; (d) still BEFORE motion clip when a beat has both; (e) the anti-panel sentence is mandatory in every wide multi-figure still prompt; (f) **NO view of his face from ANY angle — not frontal, not side profile, not a jaw/cheek/nose in shadow. We do not know his face, and any depicted face (any ethnicity) makes part of the audience disconnect. Camera directly behind, over-the-shoulder, or true distance — nothing else. ALSO banned as face-substitutes: a hood opening facing the camera as a black featureless void, and any solid-black featureless human cutout standing in for him. Stage hooded/sleeping Jesus with the BACK of the hood toward camera (Cameron, 2026-07-10); (g) NO visible skin on the Jesus figure AT ALL — no face, hands, wrists, neck, ear, or any pale region that reads as skin at phone-scale; he is robe, hood, and posture only (Cameron, 2026-07-10, storm-11 V1 rejection: "we don't know if he was white and I'm tired of saying that or seeing it"); (h) ACTION-LOGIC LAW — every figure's action must read correctly at a glance (storm V1 rejected: fishermen appeared to pour water INTO their own boat and pull a rope leading outside the hull); bailing throws water OUT over the gunwale, ropes connect to rigging inside the boat; QC every frame by asking "what does this person appear to be doing?"** Whenever Cameron gives a new correction, write it into PRODUCTION-BIBLE §1 AND this list in the same session.
